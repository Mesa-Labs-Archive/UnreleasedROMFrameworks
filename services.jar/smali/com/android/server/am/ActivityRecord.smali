...
.field mNotificationBubbleKey:Ljava/lang/String;
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ProcessRecord;IILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/content/res/Configuration;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;IZZLcom/android/server/am/ActivityStackSupervisor;Lcom/android/server/am/ActivityStackSupervisor$ActivityContainer;Landroid/app/ActivityOptions;Lcom/android/server/am/ActivityRecord;)V
    ...
    iput-object v2, p0, Lcom/android/server/am/ActivityRecord;->mNotificationBubbleKey:Ljava/lang/String;
    ...
    invoke-virtual/range {p17 .. p17}, Landroid/app/ActivityOptions;->getNotificationBubbleKey()Ljava/lang/String;
...
.method private reportLaunchTimeLocked(J)V
    ...
    invoke-static {v3}, Lcom/android/server/am/SluggishInfo;->addEndLaunchLog(Ljava/lang/String;)V
...
.method private scheduleMultiWindowModeChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/am/MultiWindowManagerService;->isChatOverVideoModeEnabled(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/am/MultiWindowManagerService;->onFreeformStackChanged(Landroid/view/IApplicationToken;Z)V
    ...
    invoke-virtual {v1}, Lcom/android/server/am/TaskRecord;->clearNotificationBubbleKey()V
    :try_end_0
...
.method dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    :cond_22
    sget-boolean v11, Lcom/samsung/android/framework/feature/ChatOverVideoFeatures;->SAMSUNG_CHAT_OVER_VIDEO_SUPPORT:Z

    if-eqz v11, :cond_23

    invoke-virtual/range {p1 .. p2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string/jumbo v11, "mNotificationBubbleKey="
    ...
    iget-object v11, v0, Lcom/android/server/am/ActivityRecord;->mNotificationBubbleKey:Ljava/lang/String;
...
.method setTask(Lcom/android/server/am/TaskRecord;Z)V
    ...
    iget-object v1, p0, Lcom/android/server/am/ActivityRecord;->mNotificationBubbleKey:Ljava/lang/String;

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/android/server/am/ActivityRecord;->mNotificationBubbleKey:Ljava/lang/String;

    invoke-virtual {p1, v1}, Lcom/android/server/am/TaskRecord;->setNotificationBubbleKey(Ljava/lang/String;)V
