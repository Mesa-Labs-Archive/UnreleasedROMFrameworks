...
.method private getStackInfoLocked(Lcom/android/server/am/ActivityStack;)Landroid/app/ActivityManager$StackInfo;
    ...
    :goto_5
    iput v12, v3, Landroid/app/ActivityManager$StackInfo;->topRunningTaskId:I
...
.method private moveTasksToFullscreenStackInSurfaceTransaction(IZZ)V
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/server/am/ActivityStackSupervisor;->moveTasksToFullscreenStackInSurfaceTransaction(IZZLcom/android/server/am/ActivityRecord;)V
...
.method cleanUpRemovedTaskLocked(Lcom/android/server/am/TaskRecord;ZZ)V
    ...
    sget-object v19, Lcom/android/server/am/ActivityStackSupervisor;->TAG:Ljava/lang/String;

    new-instance v20, Ljava/lang/StringBuilder;

    invoke-direct/range {v20 .. v20}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v21, "No component for base intent of task: "
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/am/ActivityRecord;->getTask()Lcom/android/server/am/TaskRecord;
    ...
    sget-boolean v19, Lcom/android/server/am/MARsPolicyManager;->MARs_ENABLE:Z
    ...
    invoke-virtual/range {v19 .. v21}, Lcom/android/server/am/MARsPolicyManager;->isAutoRunBlockedApp(Ljava/lang/String;I)Z
    ...
    iget-object v0, v15, Lcom/android/server/am/ProcessRecord;->curReceivers:Landroid/util/ArraySet;
    ...
    iget v0, v15, Lcom/android/server/am/ProcessRecord;->userId:I
    ...
    :cond_d
    const-string/jumbo v19, "remove task"
    ...
    invoke-virtual {v15, v0, v1}, Lcom/android/server/am/ProcessRecord;->kill(Ljava/lang/String;Z)V
    ...
    iput-object v0, v15, Lcom/android/server/am/ProcessRecord;->waitingToKill:Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v11}, Lcom/android/server/am/MARsPolicyManager;->forceRunPolicyForRecentKill(ILjava/lang/String;)Z
    ...
    invoke-virtual {v0, v11}, Lcom/android/server/am/MARsPolicyManager;->forceStopForRecentKill(Ljava/lang/String;)V
...
.method public hideKnoxMultiwindowsLocked(I)V
    ...
    const-string/jumbo v3, "com.samsung.android.video/.player.activity.MoviePlayer"
...
.method synthetic lambda$-com_android_server_am_ActivityStackSupervisor_136372(IZ)V
    .locals 0
...
.method synthetic lambda$-com_android_server_am_ActivityStackSupervisor_136657(IZZ)V
    .locals 0
...
.method synthetic lambda$-com_android_server_am_ActivityStackSupervisor_136985(IZZLcom/android/server/am/ActivityRecord;)V
    .locals 0
...
.method synthetic lambda$-com_android_server_am_ActivityStackSupervisor_148497(I)V
    .locals 0
...
.method final realStartActivityLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ProcessRecord;ZZ)Z
    ...
    sget-boolean v7, Lcom/samsung/android/framework/feature/ChatOverVideoFeatures;->SAMSUNG_CHAT_OVER_VIDEO_SUPPORT:Z

    if-eqz v7, :cond_14

    move-object/from16 v0, p1

    iget-object v7, v0, Lcom/android/server/am/ActivityRecord;->mNotificationBubbleKey:Ljava/lang/String;
    ...
    invoke-virtual {v7, v8, v9}, Lcom/android/server/am/MultiWindowManagerService;->minimizeAllFreeformTasks(IZ)Z
    ...
    invoke-virtual {v7, v8}, Lcom/samsung/android/game/GamePkgDataHelper;->notifyAppCreate(Ljava/lang/String;)V
...
.method resizeDockedStackLocked(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZZ)V
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/am/ActivityStack;->isAttached()Z
    ...
    invoke-virtual {v14, v0, v4, v1, v6}, Lcom/android/server/am/ActivityStack;->getStackDockedModeBounds(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Z)V
    ...
    invoke-virtual {v4}, Lcom/android/server/wm/WindowManagerService;->getDockedStackSide()I
    ...
    invoke-static/range {v6 .. v13}, Lcom/android/server/pm/PersonaServiceHelper;->notifyActivityDrawn(ILandroid/content/pm/ActivityInfo;Ljava/lang/String;IZZZI)V
    :try_end_2
