...
.field static final SUGGEST_APPEAR_ON_TOP:I = 0x3
...
.field private static final TYPE_APPLICATION_OVERLAY_DENIED:Ljava/lang/String; = "permission denied for window type 2038"

.field private static final TYPE_PHONE_DENIED:Ljava/lang/String; = "permission denied for window type 2002"

.field private static final TYPE_SYSTEM_ALERT_DENIED:Ljava/lang/String; = "permission denied for window type 2003"

.field private static final TYPE_SYSTEM_ERROR_DENIED:Ljava/lang/String; = "permission denied for window type 2010"

.field private static final TYPE_SYSTEM_OVERLAY_DENIED:Ljava/lang/String; = "permission denied for window type 2006"
...
# direct methods
.method static synthetic -wrap0(Lcom/android/server/am/AppErrorSuggester;Ljava/lang/String;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/android/server/am/AppErrorSuggester;->showAppOnTopSurfaceAsUser(Ljava/lang/String;I)V
...
.method static synthetic -wrap2(Lcom/android/server/am/AppErrorSuggester;Ljava/lang/String;)V
    .locals 0
...
.method private showAppOnTopSurfaceAsUser(Ljava/lang/String;I)V
    .locals 6
    ...
    const-string/jumbo v5, "showAppOnTopSurfaceAsUser error : "
...
.method private showAppearOnTopDialog(Lcom/android/server/am/ProcessRecord;)V
    .locals 9
    ...
    :try_start_0
    iget-object v6, p0, Lcom/android/server/am/AppErrorSuggester;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v6, v3, v7, v5}, Landroid/content/pm/PackageManager;->getPackageInfoAsUser(Ljava/lang/String;II)Landroid/content/pm/PackageInfo;
    ...
    invoke-direct {v4, v6, p1}, Lcom/android/server/am/AppErrorSuggestDialog;-><init>(Landroid/content/Context;Lcom/android/server/am/ProcessRecord;)V

    const v6, 0x104073d

    invoke-virtual {v4, v6}, Lcom/android/server/am/AppErrorSuggestDialog;->setTitle(I)V
    ...
    invoke-virtual {v4, v6}, Lcom/android/server/am/AppErrorSuggestDialog;->setMessage(Ljava/lang/CharSequence;)V

    new-instance v6, Lcom/android/server/am/AppErrorSuggester$1;

    invoke-direct {v6, p0, v3, v5}, Lcom/android/server/am/AppErrorSuggester$1;-><init>(Lcom/android/server/am/AppErrorSuggester;Ljava/lang/String;I)V

    const v7, 0x1040a1b

    invoke-virtual {v4, v7, v6}, Lcom/android/server/am/AppErrorSuggestDialog;->setPositiveButton(ILandroid/content/DialogInterface$OnClickListener;)V

    const v6, 0x1040a1a

    const/4 v7, 0x0

    invoke-virtual {v4, v6, v7}, Lcom/android/server/am/AppErrorSuggestDialog;->setNegativeButton(ILandroid/content/DialogInterface$OnClickListener;)V
    ...
    const-string/jumbo v6, "AppErrorSuggester"

    const-string/jumbo v7, "Couldn\'t find package"
...
.method private showPermissionErrorDialog(Ljava/lang/String;Lcom/android/server/am/ProcessRecord;)V
    ...
    new-instance v9, Lcom/android/server/am/AppErrorSuggester$2;

    invoke-direct {v9, p0, v3}, Lcom/android/server/am/AppErrorSuggester$2;-><init>(Lcom/android/server/am/AppErrorSuggester;Ljava/lang/String;)V
...
.method private showWebView32bitErrorDialog(Lcom/android/server/am/ProcessRecord;)V
    ...
    new-instance v5, Lcom/android/server/am/AppErrorSuggester$3;

    invoke-direct {v5, p0}, Lcom/android/server/am/AppErrorSuggester$3;-><init>(Lcom/android/server/am/AppErrorSuggester;)V
...
.method public canSuggest(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_2
    const-string/jumbo v1, "permission denied for window type 2003"
    ...
    const-string/jumbo v1, "permission denied for window type 2010"
    ...
    const-string/jumbo v1, "permission denied for window type 2006"
    ...
    const-string/jumbo v1, "permission denied for window type 2002"
    ...
    const-string/jumbo v1, "permission denied for window type 2038"
...
.method public runSuggest(ILcom/android/server/am/ProcessRecord;)V
    ...
    :pswitch_2
    invoke-direct {p0, p2}, Lcom/android/server/am/AppErrorSuggester;->showAppearOnTopDialog(Lcom/android/server/am/ProcessRecord;)V
