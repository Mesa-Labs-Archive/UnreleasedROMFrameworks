...
.field private final mCOVCallbacks:Landroid/os/RemoteCallbackList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/os/RemoteCallbackList",
            "<",
            "Lcom/samsung/android/chatovervideo/IChatOverVideoCallback;",
            ">;"
        }
    .end annotation
.end field
...
.field private mChatOverVideoManager:Lcom/android/server/am/ChatOverVideoManagerService;
...
.method static synthetic -get2(Lcom/android/server/am/MultiWindowManagerService;)Landroid/os/RemoteCallbackList;
    ...
    iget-object v0, p0, Lcom/android/server/am/MultiWindowManagerService;->mCOVCallbacks:Landroid/os/RemoteCallbackList;

    return-object v0
.end method

.method static synthetic -get3(Lcom/android/server/am/MultiWindowManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/am/MultiWindowManagerService;)Lcom/android/server/am/FreeformStackController;
    .locals 1
...
.method static synthetic -get5(Lcom/android/server/am/MultiWindowManagerService;)Landroid/os/RemoteCallbackList;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/am/MultiWindowManagerService;)Lcom/android/server/am/ScreenFreezeAnimationManager;
    .locals 1
...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/am/MultiWindowManagerService;->mCOVCallbacks:Landroid/os/RemoteCallbackList;
    ...
    sget-boolean v0, Lcom/samsung/android/framework/feature/ChatOverVideoFeatures;->SAMSUNG_CHAT_OVER_VIDEO_SUPPORT:Z

    if-eqz v0, :cond_1

    new-instance v0, Lcom/android/server/am/ChatOverVideoManagerService;
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lcom/android/server/am/ChatOverVideoManagerService;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/am/ActivityManagerService;Lcom/android/server/wm/WindowManagerService;)V

    iput-object v0, p0, Lcom/android/server/am/MultiWindowManagerService;->mChatOverVideoManager:Lcom/android/server/am/ChatOverVideoManagerService;
...
.method private moveActivityTaskToBackLocked(IZ)Z
    ...
    invoke-virtual {v1}, Lcom/android/server/am/TaskRecord;->getNotificationBubbleKey()Ljava/lang/String;

    move-result-object v2

    if-eqz v2, :cond_2

    const-string/jumbo v2, "CVAC"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "BubbleMinimize | "
...
.method checkRunningFreeformWithLoggingLocked(Lcom/android/server/am/TaskRecord;)V
    ...
    invoke-virtual/range {v23 .. v24}, Lcom/android/server/am/ActivityStackSupervisor;->getStack(I)Lcom/android/server/am/ActivityStack;
    ...
    invoke-virtual {v9, v0}, Lcom/android/server/am/ActivityStack;->shouldBeVisible(Lcom/android/server/am/ActivityRecord;)I
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/am/ActivityStackSupervisor;->getStacksOnDefaultDisplay()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v0}, Lcom/android/server/am/ActivityStack;->shouldBeVisible(Lcom/android/server/am/ActivityRecord;)I
    ...
    iget-object v0, v4, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;
    ...
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->getNotificationBubbleKey()Ljava/lang/String;
    ...
    :cond_d
    invoke-virtual/range {v21 .. v21}, Lcom/android/server/am/TaskRecord;->topRunningActivityLocked()Lcom/android/server/am/ActivityRecord;
    ...
    const-string/jumbo v23, "DFCO"

    const/16 v24, 0x0

    aput-object v23, v7, v24

    const-string/jumbo v23, "DFPA"

    const/16 v24, 0x1

    aput-object v23, v7, v24

    const-string/jumbo v23, "com.samsung.android.desktopmode"

    move-object/from16 v0, p0

    move-object/from16 v1, v23

    invoke-virtual {v0, v1, v7, v6}, Lcom/android/server/am/MultiWindowManagerService;->logMultiWindowBehavior(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string/jumbo v23, "CVAC"

    const/16 v24, 0x0

    aput-object v23, v7, v24

    const-string/jumbo v23, "CVAP"

    const/16 v24, 0x1

    aput-object v23, v7, v24

    const-string/jumbo v23, "BubbleOpen"
    ...
    const-string/jumbo v23, "com.samsung.android.multiwindow"
    ...
    :cond_11
    const-string/jumbo v23, "FFCO"

    const/16 v24, 0x0

    aput-object v23, v7, v24

    const-string/jumbo v23, "FFPA"
...
.method public clearVideoPlayingSurface()V
    ...
    iget-object v0, p0, Lcom/android/server/am/MultiWindowManagerService;->mChatOverVideoManager:Lcom/android/server/am/ChatOverVideoManagerService;

    invoke-virtual {v0}, Lcom/android/server/am/ChatOverVideoManagerService;->clearVideoPlayingSurface()V
...
.method dumpLocked(Ljava/io/PrintWriter;Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ChatOverVideoManagerService;->dump(Ljava/io/PrintWriter;)V
...
.method public isChatOverVideoModeEnabled(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ChatOverVideoManagerService;->isChatOverVideoModeEnabled(Ljava/lang/String;)Z
...
.method public isVisibleVideoPlayingSurface()Z
    ...
    invoke-virtual {v0}, Lcom/android/server/am/ChatOverVideoManagerService;->isVisibleVideoPlayingSurface()Z
...
.method synthetic lambda$-com_android_server_am_MultiWindowManagerService_11894()V
    .locals 0
...
.method public notifyFreeformMinimizeStateChanged(Landroid/graphics/Rect;ILandroid/content/ComponentName;IILandroid/os/Bundle;)V
    .locals 4
...
.method public notifyOnAppsRemoved(ZLjava/lang/String;)V
    .locals 4
...
.method public onFreeformStackChanged(Landroid/view/IApplicationToken;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/am/ChatOverVideoManagerService;->onFreeformStackChanged(Landroid/view/IApplicationToken;Z)V
...
.method public registerChatOverVideoServiceCallback(Lcom/samsung/android/chatovervideo/IChatOverVideoCallback;)V
    .locals 2

    iget-object v1, p0, Lcom/android/server/am/MultiWindowManagerService;->mCOVCallbacks:Landroid/os/RemoteCallbackList;
...
.method public reportVideoPlayingSurface(Landroid/os/IBinder;Z)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/am/ChatOverVideoManagerService;->reportVideoPlayingSurface(Landroid/os/IBinder;Z)V
...
.method public shouldReportVideoPlayingSurface(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/am/ChatOverVideoManagerService;->shouldReportVideoPlayingSurface(Ljava/lang/String;)Z
...
.method public unregisterChatOverVideoServiceCallback(Lcom/samsung/android/chatovervideo/IChatOverVideoCallback;)V
    .locals 2
