...
.field private mIsSupportedLockScreenSpeedUpFeature:Z
...
.method public constructor <init>(Landroid/content/Context;JLandroid/os/IBinder;Landroid/hardware/fingerprint/IFingerprintServiceReceiver;IIJZLjava/lang/String;)V
    ...
    const-string/jumbo v3, "SEC_FLOATING_FEATURE_LOCKSCREEN_SUPPORT_FINGERPRINT_SPEED_UP"

    invoke-virtual {v2, v3}, Lcom/samsung/android/feature/SemFloatingFeature;->getBoolean(Ljava/lang/String;)Z

    move-result v2

    iput-boolean v2, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mIsSupportedLockScreenSpeedUpFeature:Z
    ...
    iget-boolean v2, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mIsSupportedLockScreenSpeedUpFeature:Z
    ...
    iput-object v2, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mPowerManager:Landroid/os/PowerManager;

    iget-object v2, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mPowerManager:Landroid/os/PowerManager;
...
.method synthetic lambda$-com_android_server_fingerprint_AuthenticationClient_10548()V
    .locals 0
...
.method public onAcquired(II)Z
    ...
    iget-wide v2, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mCaptureStartTime:J

    invoke-static {v2, v3}, Lcom/android/server/fingerprint/BioLoggingManager;->setStartTime(J)V

    invoke-direct {p0}, Lcom/android/server/fingerprint/AuthenticationClient;->semStopTimeout()V

    iget-boolean v1, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mIsSupportedLockScreenSpeedUpFeature:Z

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mPowerManager:Landroid/os/PowerManager;

    invoke-virtual {v1, v4}, Landroid/os/PowerManager;->setFingerMatchState(I)V
    ...
    invoke-virtual {v1, v2}, Landroid/os/PowerManager;->setFingerMatchState(I)V
...
.method public onAuthenticated(II)Z
    ...
    invoke-static {v3}, Lcom/android/server/fingerprint/BioLoggingManager;->setResult(Ljava/lang/String;)V

    move-object/from16 v0, p0

    iget-boolean v3, v0, Lcom/android/server/fingerprint/AuthenticationClient;->mIsSupportedLockScreenSpeedUpFeature:Z

    if-eqz v3, :cond_3

    move-object/from16 v0, p0

    iget-object v3, v0, Lcom/android/server/fingerprint/AuthenticationClient;->mPowerManager:Landroid/os/PowerManager;

    const/4 v4, 0x3

    invoke-virtual {v3, v4}, Landroid/os/PowerManager;->setFingerMatchState(I)V
    :try_end_0
...
.method public onError(II)Z
    ...
    :cond_0
    :goto_0
    iget-boolean v0, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mIsSupportedLockScreenSpeedUpFeature:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/android/server/fingerprint/AuthenticationClient;->mPowerManager:Landroid/os/PowerManager;

    const/4 v1, 0x3

    invoke-virtual {v0, v1}, Landroid/os/PowerManager;->setFingerMatchState(I)V
