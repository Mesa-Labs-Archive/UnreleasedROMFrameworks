...
.method static synthetic -get21()Landroid/os/SemHqmManager;
    .locals 1
...
.method static synthetic -get22(Lcom/android/server/fingerprint/FingerprintService;)Z
    .locals 1
...
.method static synthetic -get23(Lcom/android/server/fingerprint/FingerprintService;)I
    .locals 1
...
.method static synthetic -get24(Lcom/android/server/fingerprint/FingerprintService;)Ljava/lang/Object;
    .locals 1
...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lcom/android/server/fingerprint/FingerprintService;->mSemHqmManager:Landroid/os/SemHqmManager;

    sput-object v2, Lcom/android/server/fingerprint/FingerprintService;->mSemFingerprintDQAManager:Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsGestureWork:Z
...
.method private dumpInternal(Ljava/io/PrintWriter;)V
    ...
    const-string/jumbo v20, "Fingerprint Manager"
    ...
    iget-object v0, v0, Lcom/android/server/fingerprint/FingerprintService;->mFingerprintUtils:Lcom/android/server/fingerprint/FingerprintUtils;
    ...
    iget-object v0, v0, Lcom/android/server/fingerprint/FingerprintService;->mPerformanceMap:Ljava/util/HashMap;
    ...
    check-cast v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;
    ...
    check-cast v4, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;
    ...
    iget v0, v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->accept:I
    ...
    iget v0, v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->reject:I
    ...
    const-string/jumbo v20, "acquire"

    if-eqz v15, :cond_5

    iget v0, v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->acquire:I
    ...
    const-string/jumbo v20, "lockout"

    if-eqz v15, :cond_6

    iget v0, v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->lockout:I
    ...
    const-string/jumbo v20, "permanentLockout"

    if-eqz v15, :cond_7

    iget v0, v15, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->permanentLockout:I
    ...
    const-string/jumbo v20, "acceptCrypto"

    if-eqz v4, :cond_8

    iget v0, v4, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->accept:I
    ...
    const-string/jumbo v20, "rejectCrypto"

    if-eqz v4, :cond_9

    iget v0, v4, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->reject:I
    ...
    const-string/jumbo v20, "acquireCrypto"

    if-eqz v4, :cond_a

    iget v0, v4, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->acquire:I
    ...
    const-string/jumbo v20, "lockoutCrypto"

    if-eqz v4, :cond_b

    iget v0, v4, Lcom/android/server/fingerprint/FingerprintService$PerformanceStats;->lockout:I
    ...
    const-string/jumbo v19, "FingerprintService"

    const-string/jumbo v20, "dump formatting failure"
    ...
    const-string/jumbo v20, " latest sensor status : "
    ...
    const-string/jumbo v20, " current User : "
    ...
    const-string/jumbo v20, " Max Template : "

    invoke-virtual/range {v19 .. v20}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v19

    sget v20, Lcom/android/server/fingerprint/FingerprintService;->mMaxTemplatesNumber:I
    ...
    iget-boolean v0, v0, Lcom/android/server/fingerprint/FingerprintService;->mIsSupportedGestureMode:Z
    ...
    const-string/jumbo v20, " daemon version : "
    ...
    const-string/jumbo v20, " sensor info : "
...
.method private semGetSensorStatus(Lvendor/samsung/hardware/biometrics/fingerprint/V2_1/ISecBiometricsFingerprint;)I
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, v9}, Lcom/android/server/fingerprint/FingerprintService;->semLoggingSensorStatus(I)V
...
.method private semInitSensorInfo(Lvendor/samsung/hardware/biometrics/fingerprint/V2_1/ISecBiometricsFingerprint;)V
    ...
    const-string/jumbo v3, "semInitSensorInfo: HAL is null"
    ...
    new-instance v7, Lcom/android/server/fingerprint/-$Lambda$NsdFXKe2P39OH-qCAY_zqOMIIsg$8;

    move-object/from16 v0, p0

    invoke-direct {v7, v0}, Lcom/android/server/fingerprint/-$Lambda$NsdFXKe2P39OH-qCAY_zqOMIIsg$8;-><init>(Ljava/lang/Object;)V
    ...
    iget v4, v0, Lcom/android/server/fingerprint/FingerprintService;->mRequestResult:I
    ...
    iget v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mRequestResult:I
    ...
    iput-object v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpDaemonVersion:[B
    ...
    iget-object v3, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpDaemonVersion:[B

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mRequestOutBuf:Ljava/util/ArrayList;
    ...
    invoke-static {v2, v3, v4, v0, v1}, Lcom/android/server/fingerprint/FingerprintService;->semInsertSurveyLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    new-instance v7, Lcom/android/server/fingerprint/-$Lambda$NsdFXKe2P39OH-qCAY_zqOMIIsg$9;

    move-object/from16 v0, p0

    invoke-direct {v7, v0}, Lcom/android/server/fingerprint/-$Lambda$NsdFXKe2P39OH-qCAY_zqOMIIsg$9;-><init>(Ljava/lang/Object;)V
    ...
    const-string/jumbo v4, "semInitSensorInfo(getSensorInfo) FP_FINISH ("
    ...
    iput-object v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpSensorInfo:[B
    ...
    iget-object v3, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpSensorInfo:[B
    ...
    iget-object v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpSensorInfo:[B
    ...
    const-string/jumbo v3, "FPDS"

    const-wide/16 v4, -0x1

    invoke-static {v2, v3, v14, v4, v5}, Lcom/android/server/fingerprint/FingerprintService;->semInsertSurveyLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    iget-object v2, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpDaemonVersion:[B
    ...
    iget-object v5, v0, Lcom/android/server/fingerprint/FingerprintService;->mFpSensorInfo:[B
    ...
    const-string/jumbo v3, "semInitSensorInfo "
...
.method static semInsertSurveyLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    sget-object v0, Lcom/android/server/fingerprint/FingerprintService;->mSemFingerprintDQAManager:Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;

    if-nez v0, :cond_1

    new-instance v0, Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;

    invoke-direct {v0, p0}, Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;->preprocessBigdata(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V

    const-string/jumbo v0, "FPST"
    ...
    :cond_3
    sget-boolean v0, Lcom/android/server/fingerprint/FingerprintService;->mIsEnableSurveyMode:Z
...
.method private semLoggingSensorStatus(I)V
    ...
    const-string/jumbo v2, "FPST"

    const-wide/16 v4, -0x1

    invoke-static {v1, v2, v0, v4, v5}, Lcom/android/server/fingerprint/FingerprintService;->semInsertSurveyLog(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;J)V

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsSensorError:Z
    ...
    const-string/jumbo v3, "semLoggingSensorStatus: FPST ="
    ...
    :cond_0
    :goto_0
    iput-boolean v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsFirstSensorCheck:Z

    return-void

    :cond_1
    iput-boolean v6, p0, Lcom/android/server/fingerprint/FingerprintService;->mIsSensorError:Z
...
.method private startEnrollment(Landroid/os/IBinder;[BILandroid/hardware/fingerprint/IFingerprintServiceReceiver;IZLjava/lang/String;)V
    ...
    iget-boolean v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mSemIsSupportedSwipeEnroll:Z
    ...
    invoke-direct/range {v5 .. v12}, Lcom/android/server/fingerprint/FingerprintService;->semStartRequest(Landroid/os/IBinder;I[B[BIILandroid/hardware/fingerprint/IFingerprintServiceReceiver;)I
...
.method protected handleAuthenticated(JIILjava/util/ArrayList;)V
    ...
    :goto_1
    iput v7, p0, Lcom/android/server/fingerprint/FingerprintService;->mPreviousAuthStatus:I
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_111026(Lcom/android/server/fingerprint/ClientMonitor;)V
    .locals 3
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_113471(ILjava/util/ArrayList;)V
    .locals 1
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_114308(ILjava/util/ArrayList;)V
    .locals 1
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_120637(ILjava/util/ArrayList;)V
    .locals 1
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_123968(ILjava/util/ArrayList;)V
    .locals 0
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_125048(II)V
    .locals 6
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_125291(I)V
    .locals 6
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_15144()V
    .locals 3
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_24507(I)V
    .locals 1
...
.method synthetic lambda$-com_android_server_fingerprint_FingerprintService_98117()V
    .locals 3
...
.method public onStart()V
    ...
    :cond_2
    sget-object v1, Lcom/android/server/fingerprint/FingerprintService;->mSemFingerprintDQAManager:Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;

    if-nez v1, :cond_3

    new-instance v1, Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;

    iget-object v2, p0, Lcom/android/server/fingerprint/FingerprintService;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/android/server/fingerprint/FingerprintService;->mSemFingerprintDQAManager:Lcom/android/server/fingerprint/FingerprintService$SemFingerprintDQAManager;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
