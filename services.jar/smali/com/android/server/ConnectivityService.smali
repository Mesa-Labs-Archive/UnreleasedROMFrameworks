...
.method private setLockdownTracker(Lcom/android/server/net/LockdownVpnTracker;)V
    ...
    iput-object v3, p0, Lcom/android/server/ConnectivityService;->mLockdownTracker:Lcom/android/server/net/LockdownVpnTracker;

    if-eqz v2, :cond_0

    invoke-virtual {v2}, Lcom/android/server/net/LockdownVpnTracker;->shutdown()V
    ...
    invoke-virtual {v3}, Lcom/android/server/net/LockdownVpnTracker;->init()V
...
.method public isTetheringSupported()Z
    ...
    const-string/jumbo v8, "CscFeature_Common_UseChameleon"
    ...
    const-string/jumbo v7, "persist.sys.tether_data_bt"
    ...
    const-string/jumbo v7, "persist.sys.tether_data_wifi"
    ...
    const-string/jumbo v7, "persist.sys.tether_data"
    ...
    const-string/jumbo v8, "all_tether_disable"
    ...
    :cond_0
    iget-object v7, p0, Lcom/android/server/ConnectivityService;->mSystemProperties:Lcom/android/server/connectivity/MockableSystemProperties;

    const-string/jumbo v8, "ro.tether.denied"

    invoke-virtual {v7, v8}, Lcom/android/server/connectivity/MockableSystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v8, "tether_supported"
    ...
    const-string/jumbo v7, "wifi-only"
...
.method synthetic lambda$-com_android_server_ConnectivityService_142976(Landroid/net/Network;)V
    .locals 3
...
.method synthetic lambda$-com_android_server_ConnectivityService_44418()V
    .locals 0
