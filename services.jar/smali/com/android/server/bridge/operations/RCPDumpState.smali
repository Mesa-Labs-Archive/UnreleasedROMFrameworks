...
.method private get_exCalendarId(I)Ljava/lang/String;
    ...
    :goto_0
    :try_start_0
    const-string/jumbo v3, "name IS NULL OR name NOT IN(select name from Calendars where account_type is \'LOCAL\' AND account_name is \'local.samsungholiday\')"
    ...
    iget-object v1, p0, Lcom/android/server/bridge/operations/RCPDumpState;->mQueryUri:Landroid/net/Uri;
    ...
    const-string/jumbo v6, "AND calendar_id IN ("
...
.method public dumpStateContainerSyncHistory(Ljava/io/PrintWriter;I)V
    ...
    :goto_0
    const-string/jumbo v1, "Contact import history:"

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string/jumbo v1, "/container_contact_sync_history/"
    ...
    const-string/jumbo v1, "Contact export history:"

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string/jumbo v1, "/owner_contact_sync_history/"

    invoke-direct {p0, p1, v0, v1, p2}, Lcom/android/server/bridge/operations/RCPDumpState;->printSyncHistory(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;I)V

    const-string/jumbo v1, "Calendar import history:"

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string/jumbo v1, "/container_calendar_sync_history/"

    invoke-direct {p0, p1, v0, v1, p2}, Lcom/android/server/bridge/operations/RCPDumpState;->printSyncHistory(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;I)V

    const-string/jumbo v1, "Calendar export history:"

    invoke-virtual {p1, v1}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string/jumbo v1, "/owner_calendar_sync_history/"
