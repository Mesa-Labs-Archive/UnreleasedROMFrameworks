...
.method private launchGestureWakeup()V
    ...
    const-string/jumbo v5, "launchGestureWakeup() :: No action in Desktop mode+"
    ...
    :cond_2
    sget-object v4, Lcom/android/server/accessibility/GestureWakeup;->mCoverManager:Lcom/samsung/android/cover/CoverManager;
    ...
    const-string/jumbo v5, "..Cover is closed .."
