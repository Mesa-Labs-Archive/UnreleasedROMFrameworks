...
.method static constructor <clinit>()V
    ...
    sput v1, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_X:F

    sput v1, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_Y:F
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/accessibility/AccessibilityManagerService;)V
    ...
    iput v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->ADD_BORDER_BOUNDAY_SIZE:I

    const/16 v4, 0xa

    iput v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->ADD_BORDER_BOUNDAY_MOVE_SIZE:I

    const/16 v4, 0x32

    iput v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->HORIZONTAL_FOCUS_LOCK_DEGREE:I

    iput v7, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mIsHorizontalFocusLock:I

    iput v5, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->originalOffsetX:F

    iput v5, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->originalOffsetY:F
    ...
    invoke-direct {v4, p0, v5}, Lcom/android/server/accessibility/SamsungMagnifierWindow$1;-><init>(Lcom/android/server/accessibility/SamsungMagnifierWindow;Landroid/os/Handler;)V

    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mMagnificationSettingsObserver:Landroid/database/ContentObserver;

    new-instance v4, Lcom/android/server/accessibility/SamsungMagnifierWindow$2;

    invoke-direct {v4, p0}, Lcom/android/server/accessibility/SamsungMagnifierWindow$2;-><init>(Lcom/android/server/accessibility/SamsungMagnifierWindow;)V

    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mConfigurationChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mDisplayManager:Landroid/hardware/display/IDisplayManager;
    ...
    :try_start_0
    iget-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mDisplayManager:Landroid/hardware/display/IDisplayManager;
    ...
    :cond_0
    invoke-direct {p0, v8}, Lcom/android/server/accessibility/SamsungMagnifierWindow;->setMagnificationSettings(Z)V
    ...
    iput v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mIsHorizontalFocusLock:I
    ...
    new-instance v4, Lcom/android/server/accessibility/SamsungMagnifierWindow$DetectingStateHandler;

    invoke-direct {v4, p0, p1}, Lcom/android/server/accessibility/SamsungMagnifierWindow$DetectingStateHandler;-><init>(Lcom/android/server/accessibility/SamsungMagnifierWindow;Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mDetectingStateHandler:Lcom/android/server/accessibility/SamsungMagnifierWindow$MotionEventHandler;

    new-instance v4, Lcom/android/server/accessibility/SamsungMagnifierWindow$StateViewportDraggingHandler;

    const/4 v5, 0x0

    invoke-direct {v4, p0, v5}, Lcom/android/server/accessibility/SamsungMagnifierWindow$StateViewportDraggingHandler;-><init>(Lcom/android/server/accessibility/SamsungMagnifierWindow;Lcom/android/server/accessibility/SamsungMagnifierWindow$StateViewportDraggingHandler;)V

    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mStateViewportDraggingHandler:Lcom/android/server/accessibility/SamsungMagnifierWindow$MotionEventHandler;

    new-instance v4, Lcom/android/server/accessibility/SamsungMagnifierWindow$MagnifiedContentInteractionStateHandler;

    invoke-direct {v4, p0, p1}, Lcom/android/server/accessibility/SamsungMagnifierWindow$MagnifiedContentInteractionStateHandler;-><init>(Lcom/android/server/accessibility/SamsungMagnifierWindow;Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/server/accessibility/SamsungMagnifierWindow;->mMagnifiedContentInteractionStateHandler:Lcom/android/server/accessibility/SamsungMagnifierWindow$MotionEventHandler;

    const/4 v4, 0x2

    invoke-direct {p0, v4}, Lcom/android/server/accessibility/SamsungMagnifierWindow;->transitionToState(I)V
...
.method private handleMotionEventOnMagnifierWindow(Landroid/view/MotionEvent;Landroid/view/MotionEvent;I)V
    ...
    sput v2, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_X:F
    ...
    sput v2, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_Y:F
...
.method private setMagnificationSettings(Z)V
    ...
    :cond_1
    sget v6, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_X:F

    sget v7, Lcom/android/server/accessibility/SamsungMagnifierWindow;->magnifier_offset_Y:F
