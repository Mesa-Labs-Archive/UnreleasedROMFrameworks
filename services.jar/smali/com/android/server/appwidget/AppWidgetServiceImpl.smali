...
.method private readProfileStateFromFileLocked(Ljava/io/FileInputStream;ILjava/util/List;)I
    ...
    sget-boolean v37, Lcom/android/server/appwidget/AppWidgetServiceImpl;->EMERGENCY_MODE_SUPPORTED:Z
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/emergencymode/SemEmergencyManager;->isEmergencyMode(Landroid/content/Context;)Z
    ...
    const-string/jumbo v37, "AppWidgetServiceImpl"
    ...
    sget-boolean v37, Lcom/android/server/appwidget/AppWidgetServiceImpl;->DEBUG_NO_SHIP:Z
    ...
    invoke-direct {v10, v0}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;)V
    ...
    invoke-static/range {v37 .. v37}, Lcom/samsung/android/emergencymode/SemEmergencyManager;->getInstance(Landroid/content/Context;)Lcom/samsung/android/emergencymode/SemEmergencyManager;

    move-result-object v37

    invoke-virtual/range {v37 .. v37}, Lcom/samsung/android/emergencymode/SemEmergencyManager;->isModifying()Z
    ...
    iput-boolean v0, v10, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->zombie:Z

    :cond_9
    :goto_4
    iget-boolean v0, v10, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->zombie:Z
    ...
    :goto_5
    iput v12, v10, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->tag:I
    ...
    invoke-direct {v0, v1, v11, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$HostId;-><init>(IILjava/lang/String;)V

    move-object/from16 v0, v37

    iput-object v0, v10, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->id:Lcom/android/server/appwidget/AppWidgetServiceImpl$HostId;
    ...
    invoke-direct/range {v36 .. v37}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;)V
    ...
    const-string/jumbo v37, "appWidgetMinWidth"
    ...
    const-string/jumbo v37, "appWidgetMinHeight"
    ...
    const-string/jumbo v37, "appWidgetMaxWidth"
    ...
    const-string/jumbo v37, "appWidgetMaxHeight"
    ...
    const-string/jumbo v37, "appWidgetCategory"
    ...
    invoke-direct {v15, v0, v1, v12, v2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$LoadedWidgetState;-><init>(Lcom/android/server/appwidget/AppWidgetServiceImpl;Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;II)V
...
.method private static serializeAppWidget(Lorg/xmlpull/v1/XmlSerializer;Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;)V
    ...
    invoke-interface {p0, v7, v5}, Lorg/xmlpull/v1/XmlSerializer;->startTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
    ...
    invoke-interface {p0, v7, v5, v6}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v5, "rid"

    iget v6, p1, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;->restoredId:I
    ...
    iget-object v6, p1, Lcom/android/server/appwidget/AppWidgetServiceImpl$Widget;->host:Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;

    iget v6, v6, Lcom/android/server/appwidget/AppWidgetServiceImpl$Host;->tag:I
    ...
    iget v6, v6, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->tag:I
    ...
    const-string/jumbo v4, "host_category"
    ...
    invoke-interface {p0, v7, v4, v5}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    :cond_1
    const-string/jumbo v4, "g"

    invoke-interface {p0, v7, v4}, Lorg/xmlpull/v1/XmlSerializer;->endTag(Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;
...
.method public getInstalledProvidersForProfile(IILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    const-string/jumbo v11, "getInstalledProvidersForProfiles() "
    ...
    invoke-virtual {v9, p2}, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->isEnabledGroupProfile(I)Z
    ...
    iget-object v2, v4, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->info:Landroid/appwidget/AppWidgetProviderInfo;
    ...
    :goto_1
    iget-boolean v9, v4, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->zombie:Z
    ...
    iget-object v11, v4, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->id:Lcom/android/server/appwidget/AppWidgetServiceImpl$ProviderId;
    ...
    invoke-virtual {v9, v11, v6}, Lcom/android/server/appwidget/AppWidgetServiceImpl$SecurityPolicy;->isProviderInCallerOrInProfileAndWhitelListed(Ljava/lang/String;I)Z

    move-result v9

    if-eqz v9, :cond_2

    sget-boolean v9, Lcom/android/server/appwidget/AppWidgetServiceImpl;->sSProtectPolicy:Z

    if-eqz v9, :cond_5

    invoke-virtual {v4, v3, v6}, Lcom/android/server/appwidget/AppWidgetServiceImpl$Provider;->semIsHidden(Landroid/content/pm/PackageManager;I)Z
    ...
    invoke-direct {v9, v7}, Landroid/content/pm/ParceledListSlice;-><init>(Ljava/util/List;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
