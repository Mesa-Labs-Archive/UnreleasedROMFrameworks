...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mTotalSpeedList:Ljava/util/List;

    new-instance v2, Ljava/util/HashMap;

    invoke-direct {v2}, Ljava/util/HashMap;-><init>()V

    iput-object v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->providerDownload:Ljava/util/Map;
    ...
    const-string/jumbo v2, "com.android.providers.downloads.start"

    invoke-virtual {v1, v2}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    const-string/jumbo v2, "com.android.providers.downloads.complete"
...
.method private getPackageNameFromUid(I)Ljava/lang/String;
    ...
    const-string/jumbo v6, "getPackageNameFromUid uid = "
...
.method private updateAVGPhySpeed(Z)V
    ...
    iget-object v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mJP:Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy$JitterProtect;

    const-string/jumbo v3, "AvgPhySpeedHigh"

    invoke-virtual {v2, v3}, Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy$JitterProtect;->prepare(Ljava/lang/String;)V

    iget-object v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mJP:Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy$JitterProtect;

    const-string/jumbo v3, "AvgPhySpeedLow"
    ...
    iget v3, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mAvgPhySpeed:I
    ...
    const-string/jumbo v3, "total speed is down"
    ...
    invoke-virtual {v2, v3, v5}, Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy$JitterProtect;->trigger(Ljava/lang/String;I)Z
    ...
    iput v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mAvgPhySpeed:I
    ...
    invoke-virtual {v2, v3, v4}, Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy$JitterProtect;->trigger(Ljava/lang/String;I)Z
    ...
    iget-object v2, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mTotalSpeedList:Ljava/util/List;

    iget v3, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mTotalSpeed:I
...
.method public checkFGBGAppChange()I
    ...
    invoke-static {v7, v8}, Lcom/android/server/NetSpeedAllocation/NetSpeedPolicy;->logOnEng(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dump(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v4, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mLockFgAct:Ljava/lang/Object;
    ...
    const-string/jumbo v5, "mFgProcessList:"

    invoke-virtual {v3, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v5, p0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->mFgProcessList:Ljava/util/Map;
