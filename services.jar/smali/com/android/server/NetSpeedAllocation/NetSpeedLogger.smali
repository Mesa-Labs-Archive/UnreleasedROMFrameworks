...
.method public static declared-synchronized getInstance()Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;
    ...
    const-class v1, Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;->sInstance:Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;

    if-nez v0, :cond_0

    new-instance v0, Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;

    invoke-direct {v0}, Lcom/android/server/NetSpeedAllocation/NetSpeedLogger;-><init>()V
...
.method public dumpNetSpeedLogger(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "NetSpeedLogger history Log:"

    invoke-virtual {p2, v0}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    const-string/jumbo v0, "APP name/Start Time/End time/Limited Netspeed/Dropped Package/Dropped Bytes/Command/Limited Reason/Released Reason"
