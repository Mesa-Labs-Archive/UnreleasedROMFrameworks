...
.method private handleOtherStateChange()V
    ...
    const-string/jumbo v5, "Other state changed from "
    ...
    const-string/jumbo v4, "Device not provisioned, skipping dock broadcast"
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Lcom/android/server/DockObserver;->mLogRecent:Lcom/android/server/DockObserver$logRecent;
    ...
    invoke-virtual {v2, v6, v4, v5}, Lcom/android/server/DockObserver$logRecent;->log(IILjava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
