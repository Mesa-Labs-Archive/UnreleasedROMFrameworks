...
.method private checkLongLifeBattery()V
    ...
    const-string/jumbo v2, "/efs/FactoryApp/batt_after_manufactured"

    invoke-direct {p0, v2}, Lcom/android/server/BatteryService;->readFromFile(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "!@ Write weeklyDiff EFS ->  Sys : "
    ...
    const-string/jumbo v2, "/sys/class/power_supply/battery/batt_after_manufactured"
    ...
    invoke-direct {v3, p0}, Lcom/android/server/BatteryService$12;-><init>(Lcom/android/server/BatteryService;)V
    ...
    const-string/jumbo v4, "!@ can not change. value: "
...
.method private sendIntentLocked()V
    ...
    iget v9, v9, Landroid/os/BatteryProperties;->batterySecCurrentEvent:I
