...
.field private final mAutomataLocaleList:Ljava/util/ArrayList;
...
.field private mCurrentInputMethodLocale:Ljava/lang/String;
...
.field private mFakeLayoutDescriptor:Ljava/lang/String;
...
.field private mUsingAutomataInputMethod:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->mAutomataLocaleList:Ljava/util/ArrayList;

    iput-boolean v1, p0, Lcom/android/server/input/InputManagerService;->mUsingAutomataInputMethod:Z

    const-string/jumbo v0, ""

    iput-object v0, p0, Lcom/android/server/input/InputManagerService;->mCurrentInputMethodLocale:Ljava/lang/String;

    iput-object v4, p0, Lcom/android/server/input/InputManagerService;->mFakeLayoutDescriptor:Ljava/lang/String;
...
.method private deliverInputDevicesChanged([Landroid/view/InputDevice;)V
    ...
    check-cast v30, Lcom/android/server/input/InputManagerService$InputDevicesChangedListenerRecord;
    ...
    :try_start_3
    invoke-direct/range {p0 .. p0}, Lcom/android/server/input/InputManagerService;->usingAutomataInputMethod()Z
    ...
    iget-object v0, v0, Lcom/android/server/input/InputManagerService;->mCurrentImeHandle:Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;
    ...
    invoke-direct {v0, v1}, Lcom/android/server/input/InputManagerService;->getLayoutDescriptor(Landroid/hardware/input/InputDeviceIdentifier;)Ljava/lang/String;
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/input/InputManagerService;->getFakeAutomataLayout()Ljava/lang/String;
    ...
    invoke-direct {v0, v9, v1, v2}, Lcom/android/server/input/InputManagerService;->setFakeKeyboardLayoutIfNeededLocked(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v9, v1}, Lcom/android/server/input/PersistentDataStore;->switchKeyboardLayout(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;)Z
    ...
    iget-object v0, v0, Lcom/android/server/input/InputManagerService;->mHandler:Lcom/android/server/input/InputManagerService$InputManagerHandler;
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/input/PersistentDataStore;->saveIfNeeded()V
    :try_end_3
    ...
    invoke-virtual {v12}, Landroid/view/InputDevice;->isGamePad()Z
    ...
    :cond_8
    :try_start_8
    const-string/jumbo v30, "Tab S3 Book Cover Keyboard"
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/input/InputManagerService$InputDevicesChangedListenerRecord;->notifyInputDevicesChanged([I)V
    ...
    invoke-direct {v0, v12}, Lcom/android/server/input/InputManagerService;->getDefaultKeyboardLayout(Landroid/view/InputDevice;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/server/input/InputManagerService;->setCurrentKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    const-string/jumbo v30, "InputManager"

    const-string/jumbo v31, "Added Pogo keyboard and wakeup"
    ...
    const-string/jumbo v7, "com.samsung.android.input.POGO_KEYBOARD_CHANGED"

    new-instance v14, Landroid/content/Intent;

    const-string/jumbo v30, "com.samsung.android.input.POGO_KEYBOARD_CHANGED"
    ...
    check-cast v30, Landroid/view/InputDevice;
...
.method private getFakeAutomataLayout()Ljava/lang/String;
    .locals 3
    ...
    :try_start_0
    iget-object v0, p0, Lcom/android/server/input/InputManagerService;->mFakeLayoutDescriptor:Ljava/lang/String;
...
.method private handleSwitchInputMethodSubtype(ILandroid/view/inputmethod/InputMethodInfo;Landroid/view/inputmethod/InputMethodSubtype;)V
    ...
    invoke-virtual {p3}, Landroid/view/inputmethod/InputMethodSubtype;->getLocale()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/android/server/input/InputManagerService;->setCurrentLocale(Ljava/lang/String;)V
...
.method private handleSwitchKeyboardLayout(Landroid/hardware/input/InputDeviceIdentifier;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;)V
    ...
    invoke-direct {p0}, Lcom/android/server/input/InputManagerService;->usingAutomataInputMethod()Z

    move-result v8

    if-eqz v8, :cond_3

    invoke-direct {p0}, Lcom/android/server/input/InputManagerService;->getFakeAutomataLayout()Ljava/lang/String;

    move-result-object v8

    invoke-direct {p0, v2, p2, v8}, Lcom/android/server/input/InputManagerService;->setFakeKeyboardLayoutIfNeededLocked(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;Ljava/lang/String;)Z
...
.method private isAutomataLocale(Ljava/lang/String;)Z
    .locals 5
    ...
    :try_start_0
    iget-object v2, p0, Lcom/android/server/input/InputManagerService;->mAutomataLocaleList:Ljava/util/ArrayList;
...
.method private loadAutomataLocaleList()V
    .locals 15
    ...
    :try_start_1
    iget-object v0, p0, Lcom/android/server/input/InputManagerService;->mAutomataLocaleList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v1, "Failed to get automata locale list"
    ...
    :cond_4
    :try_start_3
    iget-object v0, p0, Lcom/android/server/input/InputManagerService;->mCurrentInputMethodLocale:Ljava/lang/String;

    invoke-direct {p0, v0}, Lcom/android/server/input/InputManagerService;->isAutomataLocale(Ljava/lang/String;)Z
    ...
    iput-boolean v0, p0, Lcom/android/server/input/InputManagerService;->mUsingAutomataInputMethod:Z
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
...
.method private setCurrentLocale(Ljava/lang/String;)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/server/input/InputManagerService;->mCurrentInputMethodLocale:Ljava/lang/String;

    invoke-direct {p0, p1}, Lcom/android/server/input/InputManagerService;->isAutomataLocale(Ljava/lang/String;)Z
...
.method private setDisplayDpi()V
    ...
    invoke-static {v2, v3, v1, v4}, Lcom/android/server/input/InputManagerService;->nativeSetDisplayDpi(JFF)V
...
.method private setFakeAutomataLayout(Ljava/lang/String;)V
    .locals 2
    ...
    :try_start_0
    iput-object p1, p0, Lcom/android/server/input/InputManagerService;->mFakeLayoutDescriptor:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private setFakeKeyboardLayoutIfNeededLocked(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;Ljava/lang/String;)Z
    .locals 4

    iget-object v1, p0, Lcom/android/server/input/InputManagerService;->mDataStore:Lcom/android/server/input/PersistentDataStore;

    invoke-virtual {v1, p1, p2}, Lcom/android/server/input/PersistentDataStore;->getKeyboardLayout(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/android/server/input/PersistentDataStore;->setKeyboardLayout(Ljava/lang/String;Lcom/android/internal/inputmethod/InputMethodSubtypeHandle;Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "set fake keyboard layout as "
...
.method private usingAutomataInputMethod()Z
    .locals 2
    ...
    :try_start_0
    iget-boolean v1, p0, Lcom/android/server/input/InputManagerService;->mUsingAutomataInputMethod:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v7, "  mUsingAutomataInputMethod="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v7, p0, Lcom/android/server/input/InputManagerService;->mUsingAutomataInputMethod:Z
    ...
    const-string/jumbo v7, "  mCurrentInputMethodLocale="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v7, p0, Lcom/android/server/input/InputManagerService;->mCurrentInputMethodLocale:Ljava/lang/String;
    ...
    const-string/jumbo v7, "  mAutomataLocaleList="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v7, p0, Lcom/android/server/input/InputManagerService;->mAutomataLocaleList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v7, "  mFakeLayoutDescriptor="

    invoke-virtual {v5, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v7, p0, Lcom/android/server/input/InputManagerService;->mFakeLayoutDescriptor:Ljava/lang/String;
...
.method public systemRunning()V
    ...
    iput-object v9, p0, Lcom/android/server/input/InputManagerService;->mNotificationManager:Landroid/app/NotificationManager;

    const/4 v9, 0x1

    iput-boolean v9, p0, Lcom/android/server/input/InputManagerService;->mSystemReady:Z
    ...
    new-instance v11, Lcom/android/server/input/InputManagerService$6;

    invoke-direct {v11, p0}, Lcom/android/server/input/InputManagerService$6;-><init>(Lcom/android/server/input/InputManagerService;)V

    iget-object v12, p0, Lcom/android/server/input/InputManagerService;->mHandler:Lcom/android/server/input/InputManagerService$InputManagerHandler;

    invoke-virtual {v9, v11, v5, v13, v12}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;)Landroid/content/Intent;

    new-instance v5, Landroid/content/IntentFilter;

    const-string/jumbo v9, "android.bluetooth.device.action.ALIAS_CHANGED"

    invoke-direct {v5, v9}, Landroid/content/IntentFilter;-><init>(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mContext:Landroid/content/Context;

    new-instance v11, Lcom/android/server/input/InputManagerService$7;

    invoke-direct {v11, p0}, Lcom/android/server/input/InputManagerService$7;-><init>(Lcom/android/server/input/InputManagerService;)V
    ...
    invoke-virtual {v9, v11}, Lcom/android/server/input/InputManagerService$InputManagerHandler;->sendEmptyMessage(I)Z
    ...
    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mWiredAccessoryCallbacks:Lcom/android/server/input/InputManagerService$WiredAccessoryCallbacks;

    if-eqz v9, :cond_0

    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mWiredAccessoryCallbacks:Lcom/android/server/input/InputManagerService$WiredAccessoryCallbacks;

    invoke-interface {v9}, Lcom/android/server/input/InputManagerService$WiredAccessoryCallbacks;->systemReady()V

    :cond_0
    invoke-direct {p0}, Lcom/android/server/input/InputManagerService;->loadAutomataLocaleList()V

    invoke-virtual {p0}, Lcom/android/server/input/InputManagerService;->getKeyboardLayouts()[Landroid/hardware/input/KeyboardLayout;
    ...
    const-string/jumbo v4, "com.android.inputdevices.InputDeviceReceiver/keyboard_layout_english_us"
    ...
    invoke-direct {p0, v3}, Lcom/android/server/input/InputManagerService;->setFakeAutomataLayout(Ljava/lang/String;)V

    :cond_1
    iget-boolean v9, p0, Lcom/android/server/input/InputManagerService;->mMissingKeyboardLayoutNotificationPending:Z

    if-eqz v9, :cond_2

    const-string/jumbo v9, "InputManager"

    const-string/jumbo v11, "Showing pending notification of missing keyboard layout"

    invoke-static {v9, v11}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mMissingKeyboardLayoutDevice:Landroid/view/InputDevice;

    invoke-direct {p0, v9}, Lcom/android/server/input/InputManagerService;->showMissingKeyboardLayoutNotification(Landroid/view/InputDevice;)V

    :cond_2
    iget-boolean v9, p0, Lcom/android/server/input/InputManagerService;->mAddingPogoKeyboardIntentPending:Z

    if-eqz v9, :cond_3

    iget-boolean v9, p0, Lcom/android/server/input/InputManagerService;->mPogoKeyboardConnected:Z
    ...
    invoke-virtual {v9, v6}, Landroid/content/Context;->sendStickyBroadcast(Landroid/content/Intent;)V

    const-string/jumbo v1, "com.samsung.android.input.POGO_KEYBOARD_CHANGED"

    new-instance v7, Landroid/content/Intent;

    const-string/jumbo v9, "com.samsung.android.input.POGO_KEYBOARD_CHANGED"

    invoke-direct {v7, v9}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string/jumbo v9, "status"

    iget-boolean v11, p0, Lcom/android/server/input/InputManagerService;->mPogoKeyboardConnected:Z

    invoke-virtual {v7, v9, v11}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    iget-object v9, p0, Lcom/android/server/input/InputManagerService;->mContext:Landroid/content/Context;

    invoke-virtual {v9, v7}, Landroid/content/Context;->sendStickyBroadcast(Landroid/content/Intent;)V

    iput-boolean v10, p0, Lcom/android/server/input/InputManagerService;->mAddingPogoKeyboardIntentPending:Z
