...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput v10, p0, Lcom/android/server/NetworkManagementService;->mLastPowerStateFromRadio:I

    iput v10, p0, Lcom/android/server/NetworkManagementService;->mLastPowerStateFromWifi:I
    ...
    invoke-virtual {v0, v10}, Lcom/android/server/NativeDaemonConnector;->setDebug(Z)V
    ...
    const-string/jumbo v1, "CscFeature_Common_SupportDynamicNetBandwidthAllocation"
    ...
    new-instance v0, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;

    invoke-direct {v0, p1}, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/android/server/NetworkManagementService;->mNetSpeedMonitor:Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;

    const-string/jumbo v0, "samsung"

    const-string/jumbo v1, "LimitSpeedMonitor start"
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    :goto_1
    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mNetSpeedMonitor:Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;

    if-eqz v5, :cond_2

    iget-object v5, p0, Lcom/android/server/NetworkManagementService;->mNetSpeedMonitor:Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;

    invoke-virtual {v5, p2, p3}, Lcom/android/server/NetSpeedAllocation/NetSpeedMonitor;->dump(Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public getAdaptiveSpeedLimitNetworkStats(Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string/jumbo v5, "netlimit"

    const/4 v6, 0x2

    new-array v6, v6, [Ljava/lang/Object;

    const-string/jumbo v7, "get_adaptive_limit_networkstats"
...
.method public sendMdcCmd(Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    .locals 5
    ...
    const-string/jumbo v3, "sendMdcCmd: "
...
.method public setAdaptiveSpeedLimitRule(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    iput-object v3, p0, Lcom/android/server/NetworkManagementService;->mPolicyManager:Landroid/net/NetworkPolicyManager;

    iget-object v3, p0, Lcom/android/server/NetworkManagementService;->mPolicyManager:Landroid/net/NetworkPolicyManager;

    invoke-virtual {v3, v2}, Landroid/net/NetworkPolicyManager;->getFirewallRuleWifi(I)Z
    ...
    const-string/jumbo v4, "NetworkManagement return false"
...
.method public setKnoxGuardExemptRule(ZLjava/lang/String;I)V
    ...
    const-string/jumbo v2, "setKnoxGuardExemptRule"
    ...
    const-string/jumbo v3, "knoxguard"
