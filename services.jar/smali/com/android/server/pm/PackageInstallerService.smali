...
.method private createSessionInternal(Landroid/content/pm/PackageInstaller$SessionParams;Ljava/lang/String;I)I
    ...
    const-string/jumbo v9, "createSession"
    ...
    invoke-virtual {v4, v0, v7}, Lcom/android/server/pm/PackageManagerService;->isUserRestricted(ILjava/lang/String;)Z
    ...
    const-string/jumbo v7, "User restriction prevents installing"
    ...
    invoke-virtual {v0, v5, v1}, Lcom/android/server/pm/PackageInstallerService;->isFromApprovedInstaller(II)Z
    ...
    const-string/jumbo v7, "not an approved installer"
    ...
    const-string/jumbo v8, " getting through the check "
    ...
    sget-object v4, Landroid/sec/enterprise/RestrictionPolicy;->installerExceptions:[Ljava/lang/String;
    ...
    invoke-virtual/range {v33 .. v33}, Lcom/samsung/android/knox/restriction/RestrictionPolicy;->isNonMarketAppAllowed()Z
    ...
    const-string/jumbo v7, "Admin doesn\'t allow installation from unknown sources"
    ...
    invoke-virtual {v4, v7, v8, v9}, Lcom/android/server/pm/PackageManagerService;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    iget v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->installLocation:I
    ...
    invoke-static {v4, v0}, Lcom/android/internal/content/PackageHelper;->fitsOnExternal(Landroid/content/Context;Landroid/content/pm/PackageInstaller$SessionParams;)Z
    ...
    iput v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->installLocation:I
    ...
    const-string/jumbo v8, "inside modification done package "
    ...
    iget-object v8, v0, Landroid/content/pm/PackageInstaller$SessionParams;->appPackageName:Ljava/lang/String;
    ...
    const-string/jumbo v7, "You need the android.permission.INSTALL_GRANT_RUNTIME_PERMISSIONS permission to use the PackageManager.INSTALL_GRANT_RUNTIME_PERMISSIONS flag"
    ...
    iget-object v7, v0, Landroid/content/pm/PackageInstaller$SessionParams;->appLabel:Ljava/lang/String;

    invoke-static {v4, v7}, Lcom/android/server/pm/PackageInstallerService;->buildNotification(Landroid/content/Context;Ljava/lang/String;)Landroid/app/Notification;
    ...
    const-string/jumbo v7, "New installs into ASEC containers no longer supported"
    ...
    iget-object v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->appIcon:Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/app/ActivityManager;->getLauncherLargeIconSize()I
    ...
    iput-object v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->appIcon:Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v8, "Invalid install mode: "
    ...
    iget v8, v0, Landroid/content/pm/PackageInstaller$SessionParams;->mode:I
    ...
    invoke-static {v4, v0}, Lcom/android/internal/content/PackageHelper;->fitsOnInternal(Landroid/content/Context;Landroid/content/pm/PackageInstaller$SessionParams;)Z
    ...
    const-string/jumbo v7, "No suitable internal storage available"
    ...
    const-string/jumbo v7, "No suitable external storage available"
    ...
    invoke-static {v4, v5}, Lcom/android/server/pm/PackageInstallerService;->getSessionCount(Landroid/util/SparseArray;I)I
    ...
    const-string/jumbo v9, "Too many active sessions for UID "
    ...
    invoke-static {v4, v0}, Lcom/android/internal/content/PackageHelper;->resolveInstallVolume(Landroid/content/Context;Landroid/content/pm/PackageInstaller$SessionParams;)Ljava/lang/String;

    move-result-object v4

    move-object/from16 v0, p1

    iput-object v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->volumeUuid:Ljava/lang/String;
    :try_end_1
    ...
    const-string/jumbo v9, "Too many historical sessions for UID "
    ...
    iget-object v4, v0, Landroid/content/pm/PackageInstaller$SessionParams;->volumeUuid:Ljava/lang/String;

    move-object/from16 v0, p0

    move/from16 v1, v27

    invoke-direct {v0, v4, v11, v1}, Lcom/android/server/pm/PackageInstallerService;->buildStageDir(Ljava/lang/String;IZ)Ljava/io/File;
    ...
    iget-object v7, v0, Lcom/android/server/pm/PackageInstallerService;->mInternalCallback:Lcom/android/server/pm/PackageInstallerService$InternalCallback;
    ...
    iget-object v9, v0, Lcom/android/server/pm/PackageInstallerService;->mPm:Lcom/android/server/pm/PackageManagerService;

    move-object/from16 v0, p0

    iget-object v4, v0, Lcom/android/server/pm/PackageInstallerService;->mInstallThread:Landroid/os/HandlerThread;
    ...
    invoke-direct/range {v6 .. v21}, Lcom/android/server/pm/PackageInstallerSession;-><init>(Lcom/android/server/pm/PackageInstallerService$InternalCallback;Landroid/content/Context;Lcom/android/server/pm/PackageManagerService;Landroid/os/Looper;IILjava/lang/String;ILandroid/content/pm/PackageInstaller$SessionParams;JLjava/io/File;Ljava/lang/String;ZZ)V
    ...
    iget-object v4, v0, Lcom/android/server/pm/PackageInstallerService;->mCallbacks:Lcom/android/server/pm/PackageInstallerService$Callbacks;

    iget v7, v6, Lcom/android/server/pm/PackageInstallerSession;->sessionId:I

    iget v8, v6, Lcom/android/server/pm/PackageInstallerSession;->userId:I

    invoke-static {v4, v7, v8}, Lcom/android/server/pm/PackageInstallerService$Callbacks;->-wrap2(Lcom/android/server/pm/PackageInstallerService$Callbacks;II)V
    ...
    invoke-direct {v0, v11}, Lcom/android/server/pm/PackageInstallerService;->buildExternalStageCid(I)Ljava/lang/String;
