...
.method public getOverlayPackages(I)Ljava/util/List;
    ...
    iget-object v6, v1, Landroid/content/pm/PackageParser$Package;->mOverlayTarget:Ljava/lang/String;
...
.method public getUidTargetSdkVersion(I)I
    ...
    invoke-static {v0, p1}, Lcom/android/server/pm/PackageManagerService;->-wrap26(Lcom/android/server/pm/PackageManagerService;I)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public grantEphemeralAccess(ILandroid/content/Intent;II)V
    ...
    invoke-static {v0}, Lcom/android/server/pm/PackageManagerService;->-get10(Lcom/android/server/pm/PackageManagerService;)Lcom/android/server/pm/InstantAppRegistry;
...
.method public grantRuntimePermission(Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lcom/android/server/pm/PackageManagerService;->-wrap41(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/lang/String;IZ)V
...
.method public parseOpenThemeOverlayPackages(Ljava/io/File;Ljava/util/List;Ljava/util/List;ILandroid/content/pm/PackageManagerInternal$OverlayManagerCallback;)V
    ...
    invoke-static {v6}, Lcom/android/server/pm/PackageManagerService;->-get4(Lcom/android/server/pm/PackageManagerService;)Ljava/io/File;
    ...
    invoke-static {v3, v4}, Lcom/android/server/pm/PackageManagerService;->-wrap56(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/PackageParser$Package;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public queryIntentActivities(Landroid/content/Intent;III)Ljava/util/List;
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/server/pm/PackageManagerService;->-wrap34(Lcom/android/server/pm/PackageManagerService;Landroid/content/Intent;Ljava/lang/String;IIIZ)Ljava/util/List;

    move-result-object v8

    invoke-static {}, Lcom/android/server/pm/PackageManagerService;->-get21()Ljava/lang/String;
    ...
    invoke-static {v0, v10}, Lcom/android/server/pm/PackageManagerService;->-wrap16(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)Z
...
.method public requestInstantAppResolutionPhaseTwo(Landroid/content/pm/AuxiliaryResolveInfo;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;I)V
    ...
    invoke-static/range {v0 .. v6}, Lcom/android/server/pm/PackageManagerService;->-wrap57(Lcom/android/server/pm/PackageManagerService;Landroid/content/pm/AuxiliaryResolveInfo;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;I)V
...
.method public revokeRuntimePermission(Ljava/lang/String;Ljava/lang/String;IZ)V
    ...
    invoke-static {v0, p1, p2, p3, p4}, Lcom/android/server/pm/PackageManagerService;->-wrap58(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;Ljava/lang/String;IZ)V
...
.method public setKeepUninstalledPackages(Ljava/util/List;)V
    ...
    invoke-static {v6}, Lcom/android/server/pm/PackageManagerService;->-get12(Lcom/android/server/pm/PackageManagerService;)Ljava/util/List;
    ...
    invoke-static {v6, v8}, Lcom/android/server/pm/PackageManagerService;->-set4(Lcom/android/server/pm/PackageManagerService;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v8, v6}, Lcom/android/server/pm/PackageManagerService;->-wrap40(Lcom/android/server/pm/PackageManagerService;Ljava/lang/String;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
