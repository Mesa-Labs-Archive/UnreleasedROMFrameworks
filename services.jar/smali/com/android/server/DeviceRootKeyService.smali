...
.field private static final VERSION:Ljava/lang/String; = "1.1.10"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "saktest"

    const/16 v2, 0x83

    invoke-virtual {v0, v1, v4, v2}, Lcom/android/server/DeviceRootKeyService$AllowList;->add(Ljava/lang/String;II)V
...
.method private sendBigData(ILjava/lang/String;)I
    ...
    const-string/jumbo v3, "sendBigData() start, type : "
...
.method public createServiceKeySession(Ljava/lang/String;ILcom/samsung/android/service/DeviceRootKeyService/Tlv;)[B
    ...
    invoke-direct {v0, v14, v15, v1, v2}, Lcom/android/server/DeviceRootKeyService;->hasAccessPermission(IIZI)Z
    ...
    :pswitch_0
    const-string/jumbo v14, "DRKService"
    ...
    const-string/jumbo v16, " is invalid."
    ...
    invoke-direct {v0, v14, v15}, Lcom/android/server/DeviceRootKeyService;->SLOGE(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/server/DeviceRootKeyService;->tlvInit()I
    ...
    const-string/jumbo v16, "Failed to init Tlv. Ret : "
    ...
    :cond_2
    invoke-virtual/range {p3 .. p3}, Lcom/samsung/android/service/DeviceRootKeyService/Tlv;->getValidKeyList()Ljava/util/Set;
    ...
    invoke-virtual {v0, v12}, Lcom/samsung/android/service/DeviceRootKeyService/Tlv;->getTlvValue(I)[B

    move-result-object v14

    move-object/from16 v0, p0

    invoke-direct {v0, v12, v14}, Lcom/android/server/DeviceRootKeyService;->tlvAdd(I[B)I
    ...
    const-string/jumbo v16, "Failed to add Tlv. Ret : "
    ...
    :cond_4
    :try_start_0
    sget-object v15, Lcom/android/server/DeviceRootKeyService;->mLock:Ljava/lang/Object;
    ...
    invoke-direct {v0, v14}, Lcom/android/server/DeviceRootKeyService;->readDrkUID(I)Ljava/lang/String;
    ...
    invoke-direct {v0, v1, v2, v7}, Lcom/android/server/DeviceRootKeyService;->generateServiceKey(Ljava/lang/String;IZ)[B
    :try_end_1
    ...
    iget-boolean v14, v0, Lcom/android/server/DeviceRootKeyService;->isSocketThreadRequest:Z

    if-eqz v14, :cond_7

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/DeviceRootKeyService;->mNativeRequestedProcess:Ljava/lang/String;
    ...
    invoke-direct {v0, v8}, Lcom/android/server/DeviceRootKeyService;->updateCertificateIssuedList(Ljava/lang/String;)Z
    ...
    const-string/jumbo v15, "Failed to update list."
    ...
    invoke-direct {v0, v14, v4}, Lcom/android/server/DeviceRootKeyService;->sendBigData(ILjava/lang/String;)I
    ...
    const-string/jumbo v16, "Failed to sendBigData(), retVal : "
    ...
    iput-object v14, v0, Lcom/android/server/DeviceRootKeyService;->mRequestedProcess:Ljava/lang/String;

    const/4 v14, 0x0

    move-object/from16 v0, p0

    iput-object v14, v0, Lcom/android/server/DeviceRootKeyService;->mNativeRequestedProcess:Ljava/lang/String;
    ...
    const-string/jumbo v16, "Failed to generate. Name : "
    ...
    const-string/jumbo v16, ", keyType : "
    ...
    iget-object v14, v0, Lcom/android/server/DeviceRootKeyService;->mRequestedProcess:Ljava/lang/String;
...
.method public getDeviceInfo()[B
    ...
    const-string/jumbo v3, "Failed to get device information. Ret : "
