...
.field private static final QUICK_COLOR_FADE_ON_ANIMATION_DURATION_MILLIS:I
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "ro.pms.quick_colorfade"
    ...
    sput v0, Lcom/android/server/display/DisplayPowerController;->QUICK_COLOR_FADE_ON_ANIMATION_DURATION_MILLIS:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/hardware/display/DisplayManagerInternal$DisplayPowerCallbacks;Landroid/os/Handler;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayBlanker;)V
    ...
    iput v5, v0, Lcom/android/server/display/DisplayPowerController;->mFingerMatchState:I
...
.method private animateScreenStateChange(IZ)V
    ...
    sget v4, Lcom/android/server/display/DisplayPowerController;->QUICK_COLOR_FADE_ON_ANIMATION_DURATION_MILLIS:I
...
.method private setScreenState(I)Z
    ...
    iget-boolean v5, p0, Lcom/android/server/display/DisplayPowerController;->mSeamlessAodReady:Z
    ...
    const-string/jumbo v6, "setScreenState(): mSeamlessAodReady : false AOD"

    invoke-static {v5, v6}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-boolean v5, p0, Lcom/android/server/display/DisplayPowerController;->mPendingScreenOnByAodReady:Z

    if-nez v5, :cond_0

    iget-object v5, p0, Lcom/android/server/display/DisplayPowerController;->mAodManagerInternal:Lcom/samsung/android/aod/AODManagerInternal;

    iget-object v6, p0, Lcom/android/server/display/DisplayPowerController;->mSeamlessAodReadyListener:Lcom/android/server/display/DisplayPowerController$SeamlessAodReadyListener;

    invoke-virtual {v5, v6}, Lcom/samsung/android/aod/AODManagerInternal;->screenTurningOn(Lcom/samsung/android/aod/AODManager$AODChangeListener;)V
    ...
    :cond_4
    iput-boolean v7, p0, Lcom/android/server/display/DisplayPowerController;->mSeamlessAodReady:Z
    ...
    const-string/jumbo v6, "[M OS] REPORTED_TO_POLICY_SCREEN_* -> REPORTED_TO_POLICY_SCREEN_OFF."

    invoke-static {v5, v6}, Lcom/android/server/power/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v5, p0, Lcom/android/server/display/DisplayPowerController;->mScreenBrightnessRampAnimator:Lcom/android/server/display/RampAnimator;
    ...
    const-string/jumbo v6, "mWindowManagerPolicy.screenTurnedOff"
    ...
    const-string/jumbo v6, "[M OS] REPORTED_TO_POLICY_SCREEN_OFF -> REPORTED_TO_POLICY_SCREEN_TURNING_ON."
    ...
    const-string/jumbo v6, "mWindowManagerPolicy.screenTurningOn(mPendingScreenOnUnblocker)"
    ...
    iget v5, p0, Lcom/android/server/display/DisplayPowerController;->mFingerMatchState:I
    ...
    const-string/jumbo v6, "mWindowManagerPolicy.screenTurnedOff(REPORTED_TO_POLICY_SCREEN_TURNING_OFF)"
...
.method private updatePowerState()V
    ...
    iput-boolean v4, v0, Lcom/android/server/display/DisplayPowerController;->mPendingForceSlowChangeLocked:Z
    ...
    iget-boolean v6, v0, Lcom/android/server/display/DisplayPowerController;->mPendingForceSlowChangeLocked:Z
    ...
    iget v4, v4, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I

    move-object/from16 v0, p0

    iput v4, v0, Lcom/android/server/display/DisplayPowerController;->mFingerMatchState:I
    :try_end_2
    ...
    const/high16 v38, 0x3f200000    # 0.625f
...
.method public requestPowerState(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;Z)Z
    ...
    iput-boolean v1, p0, Lcom/android/server/display/DisplayPowerController;->mPendingForceSlowChangeLocked:Z
