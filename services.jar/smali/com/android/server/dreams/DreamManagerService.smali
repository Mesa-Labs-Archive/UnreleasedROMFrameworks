...
.method private getDozeComponent(I)Landroid/content/ComponentName;
    ...
    const-string/jumbo v9, "SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_AOD_DOZE_SERVICE_VERSION"

    invoke-virtual {v6, v9, v8}, Lcom/samsung/android/feature/SemFloatingFeature;->getInt(Ljava/lang/String;I)I
    ...
    iget-object v6, p0, Lcom/android/server/dreams/DreamManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-static {v6, v9, v7, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string/jumbo v10, "edge_lighting"
    ...
    :goto_2
    invoke-static {v9, v10, v6, p1}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    :cond_0
    const-string/jumbo v5, "com.samsung.android.app.aodservice/.DozeService"
...
# virtual methods
.method synthetic lambda$-com_android_server_dreams_DreamManagerService_17120(Landroid/os/Binder;Landroid/content/ComponentName;ZZILandroid/os/PowerManager$WakeLock;)V
    .locals 7
