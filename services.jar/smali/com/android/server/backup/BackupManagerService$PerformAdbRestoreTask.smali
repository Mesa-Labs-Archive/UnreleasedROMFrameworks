...
.method restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    iget-object v8, v0, Lcom/android/server/backup/BackupManagerService$FileMetadata;->packageName:Ljava/lang/String;

    invoke-virtual {v4, v8}, Lcom/android/server/backup/BackupManagerYuva;->sendStartRestoreCallback(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lcom/android/server/backup/BackupManagerService;->-get8(Lcom/android/server/backup/BackupManagerService;)I
    ...
    invoke-static {v4}, Lcom/android/server/backup/BackupManagerService;->-get10(Lcom/android/server/backup/BackupManagerService;)Landroid/content/pm/PackageManager;
...
.method public run()V
    ...
    const-string/jumbo v23, "--- Performing full-dataset restore ---"
    ...
    const-string/jumbo v23, "com.android.sharedstoragebackup"
    ...
    invoke-static/range {v22 .. v22}, Lcom/android/server/backup/BackupManagerService;->-get3(Lcom/android/server/backup/BackupManagerService;)Z
    ...
    invoke-static/range {v22 .. v23}, Lcom/android/server/backup/BackupManagerService;->-wrap8(Lcom/android/server/backup/BackupManagerService;Ljava/lang/String;)Z
    ...
    const-string/jumbo v23, "Backup password mismatch; aborting"
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/backup/BackupManagerYuva;->setMemorySaverRestoreFail()V

    invoke-static {}, Lcom/android/server/backup/BackupManagerService;->-get6()Lcom/android/server/backup/BackupManagerYuva;

    move-result-object v22

    invoke-virtual/range {v22 .. v22}, Lcom/android/server/backup/BackupManagerYuva;->sendEndRestoreCallback()V
    :try_end_0
    ...
    invoke-virtual/range {v22 .. v22}, Ljava/util/concurrent/atomic/AtomicBoolean;->notifyAll()V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-static/range {v22 .. v23}, Lcom/android/server/backup/BackupManagerService;->-set3(Lcom/android/server/backup/BackupManagerService;Z)Z
    ...
    const-string/jumbo v22, "ANDROID BACKUP\n"
    ...
    const-string/jumbo v23, "Invalid restore data; aborting."
    ...
    invoke-static/range {v22 .. v23}, Lcom/android/server/backup/BackupManagerService;->-set1(Lcom/android/server/backup/BackupManagerService;Z)Z
    :try_end_5
    ...
    invoke-virtual {v0, v1, v14, v2}, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->decodeAesHeaderAndInitialize(Ljava/lang/String;ZLjava/io/InputStream;)Ljava/io/InputStream;
    ...
    const-string/jumbo v23, "Archive is encrypted but no password given"
    ...
    const-string/jumbo v23, "Unable to read restore input"
    ...
    const-string/jumbo v23, "Setting EdmRestoreFail"
    ...
    const-string/jumbo v24, "Wrong header version: "
    ...
    const-string/jumbo v23, "Didn\'t read the right header magic"
    ...
    invoke-virtual/range {v24 .. v24}, Ljava/util/concurrent/atomic/AtomicBoolean;->notifyAll()V
    :try_end_12
    ...
    invoke-virtual/range {v23 .. v23}, Lcom/android/server/backup/BackupManagerYuva;->sendEndRestoreCallback()V

    :cond_1f
    const-string/jumbo v23, "BackupManagerService"

    const-string/jumbo v24, "Full restore pass complete."
    ...
    invoke-static/range {v23 .. v24}, Lcom/android/server/backup/BackupManagerService;->-set3(Lcom/android/server/backup/BackupManagerService;Z)Z
    ...
    invoke-direct {v11, v15}, Ljava/util/zip/InflaterInputStream;-><init>(Ljava/io/InputStream;)V

    :cond_22
    :goto_c
    move-object/from16 v0, p0

    invoke-virtual {v0, v11, v5}, Lcom/android/server/backup/BackupManagerService$PerformAdbRestoreTask;->restoreOneFile(Ljava/io/InputStream;[B)Z
    ...
    const-string/jumbo v24, "Done consuming input tarfile, total bytes="
    ...
    const-string/jumbo v24, "Close of restore data pipe threw"
