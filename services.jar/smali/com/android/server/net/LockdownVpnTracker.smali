...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Lcom/android/server/ConnectivityService;Lcom/android/server/connectivity/Vpn;Lcom/android/internal/net/VpnProfile;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/net/LockdownVpnTracker;->mIsInitLocked:Z
...
.method private initLocked()V
    ...
    iget-boolean v5, p0, Lcom/android/server/net/LockdownVpnTracker;->mIsInitLocked:Z

    if-eqz v5, :cond_0

    const-string/jumbo v5, "LockdownVpnTracker"

    const-string/jumbo v6, "Already initLocked"
    ...
    iput-boolean v9, p0, Lcom/android/server/net/LockdownVpnTracker;->mIsInitLocked:Z
...
.method private shutdownLocked()V
    ...
    const-string/jumbo v6, "LockdownVpnTracker"

    const-string/jumbo v7, "shutdownLocked()"

    invoke-static {v6, v7}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-boolean v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mIsInitLocked:Z

    if-nez v6, :cond_0

    const-string/jumbo v6, "LockdownVpnTracker"

    const-string/jumbo v7, "Already shutdownlocked"
    ...
    :cond_0
    :try_start_0
    iget-object v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mChkThread:Ljava/lang/Thread;
    ...
    const-string/jumbo v7, "Thread must be exit in shutdownLocked()."
    ...
    invoke-virtual {v6}, Lcom/android/server/connectivity/Vpn;->stopLegacyVpnPrivileged()V

    :try_start_1
    iget-object v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mNetService:Landroid/os/INetworkManagementService;

    iget-object v7, p0, Lcom/android/server/net/LockdownVpnTracker;->mProfile:Lcom/android/internal/net/VpnProfile;
    ...
    invoke-interface {v6, v7, v8, v9}, Landroid/os/INetworkManagementService;->setFirewallEgressDestRule(Ljava/lang/String;IZ)V
    ...
    invoke-interface {v6, v4, v7, v8}, Landroid/os/INetworkManagementService;->setFirewallEgressDestRule(Ljava/lang/String;IZ)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/server/net/LockdownVpnTracker;->clatIpv4to6(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v6, v0, v7, v8}, Landroid/os/INetworkManagementService;->setFirewallEgressDestRule(Ljava/lang/String;IZ)V
    ...
    invoke-interface {v6, v7, v8}, Landroid/os/INetworkManagementService;->setFirewallEgressSourceRule(Ljava/lang/String;Z)V

    iget-object v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mNetService:Landroid/os/INetworkManagementService;

    const-string/jumbo v7, "2000::/4"
    ...
    invoke-virtual {v6}, Lcom/android/server/connectivity/Vpn;->hideNotificationForLockdown()V

    :try_start_2
    iget-object v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mContext:Landroid/content/Context;

    iget-object v7, p0, Lcom/android/server/net/LockdownVpnTracker;->mResetReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-virtual {v6, v11}, Lcom/android/server/connectivity/Vpn;->setEnableTeardown(Z)V

    iget-object v6, p0, Lcom/android/server/net/LockdownVpnTracker;->mVpn:Lcom/android/server/connectivity/Vpn;

    invoke-virtual {v6, v10}, Lcom/android/server/connectivity/Vpn;->setEnableLockdownVpn(Z)V

    iput-boolean v10, p0, Lcom/android/server/net/LockdownVpnTracker;->mIsInitLocked:Z
    ...
    const-string/jumbo v7, "Problem stopping mChkThread"
    ...
    const-string/jumbo v7, "Problem setting firewall rules"
...
.method public onNetworkInfoChanged()V
    ...
    iget-object v3, p0, Lcom/android/server/net/LockdownVpnTracker;->mConnService:Lcom/android/server/ConnectivityService;

    invoke-virtual {v3}, Lcom/android/server/ConnectivityService;->getActiveNetworkInfoUnfiltered()Landroid/net/NetworkInfo;
    ...
    const-string/jumbo v5, "onNetworkInfoChanged() - egressDisconnected : "
