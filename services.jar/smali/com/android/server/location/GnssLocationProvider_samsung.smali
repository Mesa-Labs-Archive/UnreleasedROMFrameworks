...
.method private getCscFeatureString()V
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigAgpsSetting"
    ...
    const-string/jumbo v11, "CscFeature_GPS_SupportPrivacyLock"
    ...
    const-string/jumbo v11, "CscFeature_GPS_SupportGTP"
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigSuplHost"
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigSuplVersion"

    invoke-virtual {v10, v11}, Lcom/samsung/android/feature/SemCscFeature;->getInteger(Ljava/lang/String;)I
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigAgpsMode"
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigLppProfile"
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigAgnssProtocol"
    ...
    const-string/jumbo v11, "CscFeature_GPS_ConfigOperationMode"
    ...
    const-string/jumbo v11, "CSC config is saved"
...
.method private getLppBitmask()I
    ...
    const-string/jumbo v6, "US market operator: LPP enable(ECID +OTDOA)"
    ...
    const-string/jumbo v6, "US market operator: LPP enable(ECID Only)"
...
.method private static isCaMarket()Z
    ...
    const-string/jumbo v4, "isCaMarket : code/countryCode = "
    ...
    const-string/jumbo v4, "isCaMarket : "
...
.method protected extension_dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "============ GPS CSC Feature State ============"
...
.method extension_printSvStatus([I[FI)V
    ...
    iget-object v6, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->mConstellationString:[Ljava/lang/String;
    ...
    const-string/jumbo v6, "SV Count : "
    ...
    const-string/jumbo v6, "      (PRN, Constellation, SNR, Used)"
...
.method extension_reloadMakeAutoSuplUrl(Z)V
    ...
    sget-object v7, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->PER_PNT:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
    ...
    sget-object v7, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->PER_PET:Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;
...
.method public extension_reportCiqData(BBBBDDDDDDDDDD)Z
    ...
    invoke-virtual {v0, p2}, Lcom/att/iqi/lib/metrics/lc/LC18;->setResult(B)Lcom/att/iqi/lib/metrics/lc/LC18;
...
.method extension_set_supl_server()V
    ...
    invoke-virtual {v7}, Lcom/android/server/location/GnssLocationProvider_samsung$Vendor;->ordinal()I
    ...
    iget v10, p0, Lcom/android/server/location/GnssLocationProvider_samsung;->mSuplPort:I
    ...
    const-string/jumbo v7, "Set supl server for JPN_DCM, iot value:"
    ...
    const-string/jumbo v8, "dcm-supl.com"
    ...
    invoke-direct/range {v6 .. v12}, Lcom/android/server/location/GnssLocationProvider_samsung;->configurationUpdate_suplServer(ILjava/lang/String;IIII)V
...
.method public provideSuplFqdn(Ljava/lang/String;)V
    ...
    const-string/jumbo v16, "GnssLocationProvider_ex"
    ...
    invoke-virtual/range {v16 .. v17}, Landroid/net/ConnectivityManager;->getNetworkInfo(Landroid/net/Network;)Landroid/net/NetworkInfo;
    ...
    const-string/jumbo v18, ", Capability : "
    ...
    invoke-virtual {v11, v0}, Landroid/net/NetworkCapabilities;->hasCapability(I)Z
    ...
    const-string/jumbo v17, "No default network is currently active."
    ...
    invoke-virtual {v15, v0}, Landroid/net/Network;->getAllByName(Ljava/lang/String;)[Ljava/net/InetAddress;
    ...
    const-string/jumbo v18, "Got IPv6 InetAddress : "
    ...
    const-string/jumbo v18, "Got IPv4 InetAddress : "
    ...
    const-string/jumbo v17, "UnknownHostException occured"
    ...
    const-string/jumbo v18, "DNS resolve result : "
    ...
    invoke-virtual {v0, v1, v12}, Landroid/net/ConnectivityManager;->requestRouteToHostAddress(ILjava/net/InetAddress;)Z
    ...
    const-string/jumbo v18, "Error requesting route to host: "
    ...
    invoke-direct {v0, v1}, Lcom/android/server/location/GnssLocationProvider_samsung;->native_agps_set_supl_host_ip(Ljava/lang/String;)V
    ...
    const-string/jumbo v17, "DNS resolve failed"
    ...
    const-string/jumbo v18, "Successfully requested route to host: "
