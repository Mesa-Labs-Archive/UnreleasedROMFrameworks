...
.method private executeCommand([BII)[B
    ...
    new-instance v7, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;

    invoke-direct {v7, p0}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;-><init>(Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;)V

    new-instance v8, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;

    invoke-direct {v8, p0}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;-><init>(Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;)V

    move-object/from16 v0, p1

    invoke-virtual {v7, v0}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->ParserData([B)Z

    move-result v11

    if-nez v11, :cond_0

    iget-object v11, p0, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;->this$0:Lcom/android/server/DeviceRootKeyService;

    const-string/jumbo v12, "DRKServSocket"

    const-string/jumbo v13, "Parsing is failed."
    ...
    invoke-virtual {v8, v11}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setVersion(B)V

    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getCommandId()S

    move-result v11

    invoke-virtual {v8, v11}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setCommandID(S)V

    const/4 v11, 0x1

    invoke-virtual {v8, v11}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setErrorCode(S)V

    invoke-virtual {v8}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->getOutputStreamData()[B
    ...
    :cond_0
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getVersion()B
    ...
    const-string/jumbo v14, "Version is not matched. Caller version : "
    ...
    invoke-direct {p0, v12}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;->getSocketPermissionInfo(I)I
    ...
    invoke-static {v11, v0, v1, v13, v12}, Lcom/android/server/DeviceRootKeyService;->-wrap0(Lcom/android/server/DeviceRootKeyService;IIZI)Z
    ...
    const-string/jumbo v13, "Permission denied."
    ...
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getKeyType()I

    move-result v12

    invoke-virtual {v11, v12}, Lcom/android/server/DeviceRootKeyService;->isExistDeviceRootKey(I)Z
    ...
    invoke-virtual {v11, v12}, Lcom/android/server/DeviceRootKeyService;->getDeviceRootKeyUID(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v6}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData(Ljava/lang/String;)V
    ...
    invoke-static {v11, v12}, Lcom/android/server/DeviceRootKeyService;->-set0(Lcom/android/server/DeviceRootKeyService;Z)Z

    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getEnableTlv()Z
    ...
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getServiceName()Ljava/lang/String;
    ...
    iget-object v14, p0, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;->mTlv:Lcom/samsung/android/service/DeviceRootKeyService/Tlv;

    invoke-virtual {v11, v12, v13, v14}, Lcom/android/server/DeviceRootKeyService;->createServiceKeySession(Ljava/lang/String;ILcom/samsung/android/service/DeviceRootKeyService/Tlv;)[B
    ...
    invoke-virtual {v8, v10}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData([B)V
    ...
    invoke-virtual {v11}, Lcom/android/server/DeviceRootKeyService;->releaseServiceKeySession()I
    ...
    :pswitch_5
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getTlvTag()I

    move-result v11

    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getTlvValue()[B

    move-result-object v12

    invoke-direct {p0, v11, v12}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread;->addTlv(I[B)Z
    ...
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getRawData()[B

    move-result-object v13

    invoke-direct {v12, v13}, Ljava/lang/String;-><init>([B)V

    invoke-static {v11, v12}, Lcom/android/server/DeviceRootKeyService;->-wrap3(Lcom/android/server/DeviceRootKeyService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11, v2}, Lcom/android/server/DeviceRootKeyService;->-wrap2(Lcom/android/server/DeviceRootKeyService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v8, v3}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData(Ljava/lang/String;)V
    ...
    const-string/jumbo v14, "Respone :"
    ...
    invoke-static {v11, v12, v13}, Lcom/android/server/DeviceRootKeyService;->-wrap5(Lcom/android/server/DeviceRootKeyService;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v11, v12}, Lcom/android/server/DeviceRootKeyService;->getDeviceRootKeyCertificate(I)[B
    ...
    invoke-virtual {v8, v5}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData([B)V
    ...
    invoke-virtual {v11, v12, v13, v14}, Lcom/android/server/DeviceRootKeyService;->doSelfTestProvServiceBlob(Ljava/lang/String;ILcom/samsung/android/service/DeviceRootKeyService/Tlv;)[B
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData([B)V
    ...
    invoke-virtual {v11}, Lcom/android/server/DeviceRootKeyService;->isServiceReady()Z
    ...
    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getBigDataType()I

    move-result v12

    invoke-virtual {v7}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$InputDataParser;->getBigData()Ljava/lang/String;

    move-result-object v13

    invoke-static {v11, v12, v13}, Lcom/android/server/DeviceRootKeyService;->-wrap1(Lcom/android/server/DeviceRootKeyService;ILjava/lang/String;)I
    ...
    invoke-virtual {v11}, Lcom/android/server/DeviceRootKeyService;->getDeviceInfo()[B
    ...
    invoke-virtual {v8, v4}, Lcom/android/server/DeviceRootKeyService$DRKSeviceSocketThread$OutputDataGenerator;->setRawData([B)V
