...
.method public addVpnProfileToApp(ILjava/lang/String;Ljava/lang/String;)Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;
    ...
    const-string/jumbo v33, "Admin doesn\'t own container "
    ...
    const-string/jumbo v33, " Admin.uid "
    ...
    :cond_0
    new-instance v23, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;

    invoke-direct/range {v23 .. v23}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;-><init>()V
    ...
    const-string/jumbo v31, "com.mocana.vpn.android"
    ...
    sget-object v31, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->TAG:Ljava/lang/String;

    const-string/jumbo v32, "addVpnProfileToApp API : Mocana Service is not started"
    ...
    :cond_4
    const-string/jumbo v31, "ADD_ALL_PACKAGES"
    ...
    :cond_8
    sget-boolean v31, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->DBG:Z
    ...
    const-string/jumbo v33, "add package in profile : The profile name is "
    ...
    const-string/jumbo v33, "add package to profile : Exception :"
    ...
    const-string/jumbo v33, "The Package added by the admin is "
    ...
    const-string/jumbo v33, " whose container id is "
    ...
    const-string/jumbo v33, " and whose uid is "
    ...
    const-string/jumbo v31, "adminUid"
    ...
    const-string/jumbo v31, "applicationInfo"
    ...
    const-string/jumbo v31, "UID_APP"
    ...
    const-string/jumbo v31, "containerState"
    ...
    const-string/jumbo v32, "EnterpriseVpn"
    ...
    const-string/jumbo v32, "add package to profile : put data by field is success"
    ...
    const-string/jumbo v33, "add package to profile : Uid "
    ...
    :cond_e
    new-instance v24, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2$VpnState;
    ...
    invoke-static/range {v31 .. v31}, Lcom/android/server/enterprise/billing/EnterpriseBillingEngine;->getInstance(Landroid/content/Context;)Lcom/android/server/enterprise/billing/EnterpriseBillingEngine;
    ...
    const-string/jumbo v32, "add package to profile : Network is connected via check network connection method"
    ...
    const-string/jumbo v31, "key_vpn"
    ...
    const-string/jumbo v33, "add package to profile : addVpnProfileToApp - value ="
    ...
    const-string/jumbo v33, "add package to profile : Callback state: "
    ...
    const-string/jumbo v31, "CONNECTED"
    ...
    const-string/jumbo v33, "The package name added is not found by the admin and so an invalid uid is added in the db "
    ...
    const-string/jumbo v32, "add package to profile : ProfileNameVpnEntry returned null value"
    ...
    const-string/jumbo v33, "add package to profile : Exception at mocana:"
    ...
    const-string/jumbo v33, "add package to profile : Exception occured for adding vpn, package map."
    ...
    new-instance v32, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2$EnterpriseVpnCallback;
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;->getFailureState()I

    move-result v31

    if-nez v31, :cond_17

    invoke-virtual/range {v22 .. v22}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;->getData()Ljava/lang/Object;
    ...
    const-string/jumbo v33, "add package to profile : Cannot start vpn, mocana returned error : "
    ...
    const-string/jumbo v32, "add package to profile : Cannot start vpn, mocana returned error : Failure"
    ...
    const-string/jumbo v33, "add package to profile : Cannot start vpn, profile has some problem:"
    ...
    const-string/jumbo v32, "add package to profile : Network is not connected via check network connection method"
    ...
    const-string/jumbo v32, "add package to profile : put data by field is failure"
...
.method public getAllPackagesForProfile(ILjava/lang/String;)Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;
    ...
    iget-object v13, v0, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->mEDMStorageProvider:Lcom/android/server/enterprise/storage/EdmStorageProvider;
    ...
    const-string/jumbo v15, "Admin doesn\'t own container "
    ...
    const-string/jumbo v15, " Admin.uid "
    ...
    new-instance v11, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;

    invoke-direct {v11}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;-><init>()V

    invoke-virtual {v11, v12}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;->setData(Ljava/lang/Object;)V
    ...
    const-string/jumbo v14, "getAllPackagesForProfile API : Mocana Service is not started"
    ...
    invoke-virtual {v11, v13, v14}, Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;->setStatus(II)V
    ...
    const-string/jumbo v14, "EnterpriseVpn"
    ...
    const-string/jumbo v18, "applicationInfo"
    ...
    const-string/jumbo v13, "applicationInfo"
    ...
    invoke-virtual {v13, v4}, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnHelper;->getRegularPackageName(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v14, "get all added package : DB read for packages returned NULL"
    ...
    const-string/jumbo v15, "get all added package : Exceptionin notify: "
...
.method public removeVpnForApplication(ILjava/lang/String;)Lcom/samsung/android/knox/net/vpn/EnterpriseResponseData;
    ...
    const-string/jumbo v9, "removeVpnForApplication API is called with package name and container id"
    ...
    invoke-virtual {v7, p1}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getMUMContainerOwnerUid(I)I
    ...
    const-string/jumbo v9, "Admin doesn\'t own container "
    ...
    const-string/jumbo v9, " Admin.uid "
    ...
    const-string/jumbo v8, "remove to package : Error occured for removing vpn, package map."
    ...
    const-string/jumbo v8, "removeVpnForApplication API : Mocana Service is not started"
    ...
    const-string/jumbo v8, "EnterpriseVpn"

    const/4 v9, 0x2

    new-array v9, v9, [Ljava/lang/String;

    const-string/jumbo v10, "applicationInfo"
    ...
    invoke-virtual {v7, v8, v9, v10}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->deleteDataByFields(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    const-string/jumbo v9, "remove to package : DB delete: "
    ...
    iget-object v7, p0, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->packageNameVpnMap:Ljava/util/HashMap;

    iget-object v8, p0, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->mKnoxVpnHelper:Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnHelper;

    invoke-virtual {v8, p1, p2}, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnHelper;->getPersonifiedName(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v9, "removeVpnForApplication: the object value is "
    ...
    invoke-direct {p0, v7}, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->refreshDomainInHashMap(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v7, p1, v8}, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->updateNotification(Ljava/lang/String;IZ)V
    ...
    invoke-direct {p0, v7}, Lcom/android/server/enterprise/vpn/knoxvpn/EnterprisePremiumVpnPolicyServiceV2;->removeFromHashMapByPackageName(Ljava/lang/String;)V
    ...
    const-string/jumbo v9, "remove to package : Exception occured for removing vpn, package map:"
...
.method public setVpnFrameworkSystemProperty(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0, v2}, Lcom/android/server/enterprise/vpn/knoxvpn/KnoxVpnHelper;->checkIfAdminHasVpnPermission(ILjava/util/List;)V
