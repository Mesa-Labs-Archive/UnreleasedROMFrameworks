...
.method static synthetic -get1(Lcom/android/server/enterprise/wifi/WifiPolicy;)Lcom/android/server/enterprise/wifi/WifiPolicy$WifiStateHandler;
    .locals 1
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mDexPolicy:Lcom/android/server/enterprise/dex/DexPolicy;
    ...
    iput-boolean v3, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mIsCurrentlyInContainerLauncher:Z

    iput-boolean v3, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mIsShouldBlockWifiSSID:Z
    ...
    const-string/jumbo v2, "WifiPolicyHandlerThread"

    invoke-direct {v1, v2}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    invoke-virtual {v1}, Landroid/os/HandlerThread;->start()V

    new-instance v2, Lcom/android/server/enterprise/wifi/WifiPolicy$WifiStateHandler;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v3

    invoke-direct {v2, p0, v3}, Lcom/android/server/enterprise/wifi/WifiPolicy$WifiStateHandler;-><init>(Lcom/android/server/enterprise/wifi/WifiPolicy;Landroid/os/Looper;)V

    iput-object v2, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mWifiStateHandler:Lcom/android/server/enterprise/wifi/WifiPolicy$WifiStateHandler;
...
.method private createNetworkSSID(ILjava/lang/String;ZLjava/lang/String;)Landroid/net/wifi/WifiConfiguration;
    ...
    const-string/jumbo v3, "SSID is empty"
    ...
    const-string/jumbo v3, "SSID is invalid or excedes maximum length 32"
    ...
    const-string/jumbo v3, "CCM configuration"
    ...
    const-string/jumbo v3, "UCM configuration"
...
.method public setNetworkSSID(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Z)Z
    ...
    invoke-direct {p0, v0}, Lcom/android/server/enterprise/wifi/WifiPolicy;->isDPMNetworkSSID(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v10}, Lcom/android/server/enterprise/wifi/WifiPolicy;->createEntepriseProfile(Landroid/net/wifi/WifiConfiguration;)I
    ...
    const-string/jumbo v3, " has set Enterprise Network SSID to "
    ...
    const-string/jumbo v2, " with CCM."
...
.method public setWifiApSetting(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v12, "WifiPolicyService"

    const-string/jumbo v13, "SSID is empty"
    ...
    const-string/jumbo v14, ") has more than 32 characters"
    ...
    const-string/jumbo v12, "WPA_PSK"
    ...
    const-string/jumbo v14, "Security Type ("
    ...
    const-string/jumbo v14, ") is null or empty or less than 8 characters for WPA PSK security type"
    ...
    iput-object v12, v2, Landroid/net/wifi/WifiConfiguration;->preSharedKey:Ljava/lang/String;

    iget-object v12, v2, Landroid/net/wifi/WifiConfiguration;->allowedGroupCiphers:Ljava/util/BitSet;

    iget-object v13, v2, Landroid/net/wifi/WifiConfiguration;->allowedGroupCiphers:Ljava/util/BitSet;

    invoke-virtual {v12, v13}, Ljava/util/BitSet;->andNot(Ljava/util/BitSet;)V

    iget-object v12, v2, Landroid/net/wifi/WifiConfiguration;->wepKeys:[Ljava/lang/String;

    iget v13, v2, Landroid/net/wifi/WifiConfiguration;->wepTxKeyIndex:I
    ...
    iget-object v12, v2, Landroid/net/wifi/WifiConfiguration;->allowedAuthAlgorithms:Ljava/util/BitSet;
    ...
    const-string/jumbo v13, "MHS enabled, so setting new config & calling RESET_AP"

    invoke-static {v12, v13}, Lcom/android/server/enterprise/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v12, p0, Lcom/android/server/enterprise/wifi/WifiPolicy;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {v12, v2}, Landroid/net/wifi/WifiManager;->setWifiApConfiguration(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-virtual {v12, v6}, Landroid/net/wifi/WifiManager;->callSECApi(Landroid/os/Message;)I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-boolean v13, Lcom/android/server/enterprise/wifi/WifiPolicy;->isAPSettingFromAdmin:Z
    ...
    invoke-virtual {v12, v2}, Lcom/android/server/enterprise/adapterlayer/WifiManagerAdapter;->setWifiApConfiguration(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-virtual {v12, v13, v14}, Lcom/android/server/enterprise/application/ApplicationPolicy;->stopApp(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-direct {v4, v12}, Lcom/samsung/android/sagearpolicymanager/SAGearPolicyManager;-><init>(Landroid/content/Context;)V
    ...
    const-string/jumbo v13, "setWifiApSetting"

    invoke-virtual {v4, v12, v13, v5}, Lcom/samsung/android/sagearpolicymanager/SAGearPolicyManager;->SetStringListTypePolicy(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)I

    const-string/jumbo v12, "WifiPolicyService"

    const-string/jumbo v13, "setWifiApSetting calling gearPolicyManager  "
