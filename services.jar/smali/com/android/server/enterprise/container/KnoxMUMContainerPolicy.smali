...
.field private static final tileListForKiosk:Ljava/lang/String; = "Wifi;MultiWindow;Location;SilentMode;AutoRotate;Bluetooth;NetworkBooster;MobileData;AirplaneMode;Nfc;SmartStay;PowerSaving;TorchLight;WiFiHotspot;Hotspot;"
...
.method private addShortcutToPersonal(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-class v29, Landroid/content/pm/ShortcutManager;

    invoke-virtual/range {v28 .. v29}, Landroid/content/Context;->getSystemService(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v17

    check-cast v17, Landroid/content/pm/ShortcutManager;
    ...
    const-string/jumbo v30, " addShortcutToPersonal:"
    ...
    invoke-virtual/range {v28 .. v29}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getPackageNameForUid(I)Ljava/lang/String;
    ...
    const-string/jumbo v28, "shortcut"

    invoke-static/range {v28 .. v28}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v28

    invoke-static/range {v28 .. v28}, Landroid/content/pm/IShortcutService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/content/pm/IShortcutService;
    ...
    const-string/jumbo v28, "rcp"

    invoke-static/range {v28 .. v28}, Landroid/os/ServiceManager;->getService(Ljava/lang/String;)Landroid/os/IBinder;

    move-result-object v28

    invoke-static/range {v28 .. v28}, Lcom/samsung/android/knox/ISemRemoteContentManager$Stub;->asInterface(Landroid/os/IBinder;)Lcom/samsung/android/knox/ISemRemoteContentManager;
    ...
    invoke-interface/range {v28 .. v30}, Landroid/content/pm/IShortcutService;->isRequestPinItemSupported(II)Z
    ...
    invoke-virtual {v0, v15, v1, v2}, Landroid/content/pm/PackageManager;->queryIntentActivitiesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    invoke-direct {v0, v13}, Lcom/android/server/enterprise/container/KnoxMUMContainerPolicy;->drawableToBitmap(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v28

    invoke-static/range {v28 .. v28}, Landroid/graphics/drawable/Icon;->createWithBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Icon;
    ...
    const-string/jumbo v30, ",pkgName:"
    ...
    new-instance v28, Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-virtual {v0, v15}, Landroid/content/pm/ShortcutInfo$Builder;->setIntent(Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v28

    move-object/from16 v0, v28

    invoke-virtual {v0, v8}, Landroid/content/pm/ShortcutInfo$Builder;->setActivity(Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v28

    move-object/from16 v0, v28

    invoke-virtual {v0, v12}, Landroid/content/pm/ShortcutInfo$Builder;->setIcon(Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    const-string/jumbo v28, "do_not_show_popup"

    const-string/jumbo v29, "com.android.server.enterprise.application.ApplicationPolicy"
    ...
    const-string/jumbo v28, "add_to_shortcut_personal"
    ...
    invoke-virtual {v7, v0, v1}, Landroid/os/PersistableBundle;->putBoolean(Ljava/lang/String;Z)V
    ...
    invoke-virtual/range {v23 .. v23}, Landroid/content/pm/ShortcutInfo$Builder;->build()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-interface {v0, v1, v2, v3}, Landroid/content/pm/IShortcutService;->createShortcutResultIntent(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;I)Landroid/content/Intent;
    ...
    const-string/jumbo v29, "<<<--->>> before calling requestPinShortcut"
    ...
    invoke-virtual/range {v24 .. v24}, Landroid/app/PendingIntent;->getIntentSender()Landroid/content/IntentSender;
    ...
    invoke-interface {v0, v1, v2, v3, v4}, Landroid/content/pm/IShortcutService;->requestPinShortcut(Ljava/lang/String;Landroid/content/pm/ShortcutInfo;Landroid/content/IntentSender;I)Z
    ...
    invoke-interface {v0, v8, v1}, Lcom/samsung/android/knox/ISemRemoteContentManager;->addExportShortcutInfo(Landroid/content/ComponentName;I)V

    new-instance v16, Landroid/content/Intent;

    const-string/jumbo v28, "com.samsung.android.knox.container.MANAGED_PROFILE_REFRESH"
    ...
    const-string/jumbo v28, "com.samsung.sec.knox.EXTRA_PERSONA_ID"
    ...
    const-string/jumbo v28, "com.samsung.android.knox.container.block_create_shortcut"
    ...
    const-string/jumbo v28, "com.samsung.android.knox.container.name"

    const-string/jumbo v29, "Workspace"
    ...
    const-string/jumbo v28, "com.samsung.android.knox.container.userid"
    ...
    sget-object v29, Landroid/os/UserHandle;->SEM_OWNER:Landroid/os/UserHandle;
    ...
    const-string/jumbo v30, "Exception occurred while adding home shortcut "
...
.method private changeSecureFolderIcon(Ljava/lang/String;)V
    ...
    const-string/jumbo v12, "mBitMap != null"
...
.method public lockContainer(Lcom/samsung/android/knox/ContextInfo;Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, p1}, Lcom/android/server/enterprise/security/PasswordPolicy;->lock(Lcom/samsung/android/knox/ContextInfo;)Z
    ...
    const-string/jumbo v4, "KnoxMUMContainerPolicy"
    ...
    const-string/jumbo v1, " has locked Workspace."
    ...
    const-string/jumbo v2, "lockContainer result - "
    ...
    const-string/jumbo v1, "Failed at KnoxMUMContainerPolicy API lockContainer "
...
.method public removeContainer(Lcom/samsung/android/knox/ContextInfo;)I
    ...
    const-string/jumbo v1, "Container Remove Error: container creation ongoing."
    ...
    const-string/jumbo v3, "SEAMS invalidated caller. lets go for MDM check.."
    ...
    const-string/jumbo v2, "Container removal started"
    ...
    const-string/jumbo v2, " has successfully removed Workspace "
    ...
    const-string/jumbo v1, "Container removal success"
    ...
    const-string/jumbo v1, "Container removal failed"
...
.method public systemReady()V
    ...
    const-string/jumbo v5, "admin package name: "
...
.method public unlockContainer(Lcom/samsung/android/knox/ContextInfo;)Z
    ...
    invoke-virtual {v8, p1}, Lcom/android/server/enterprise/security/PasswordPolicy;->unlock(Lcom/samsung/android/knox/ContextInfo;)Z
    ...
    const-string/jumbo v1, " has unlocked Workspace."
    ...
    const-string/jumbo v2, "unlockContainer result - "
    ...
    const-string/jumbo v1, "Failed at KnoxMUMContainerPolicy API unlockContainer "
