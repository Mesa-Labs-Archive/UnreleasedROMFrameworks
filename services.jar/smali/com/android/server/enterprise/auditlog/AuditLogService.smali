...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/enterprise/auditlog/AuditLogService$2;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mSdBroadcastReceiver:Landroid/content/BroadcastReceiver;

    new-instance v1, Lcom/android/server/enterprise/auditlog/AuditLogService$2;

    invoke-direct {v1, p0}, Lcom/android/server/enterprise/auditlog/AuditLogService$2;-><init>(Lcom/android/server/enterprise/auditlog/AuditLogService;)V
    ...
    iput-object v1, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mContainerOwnerCache:Landroid/content/ContentValues;

    invoke-direct {p0}, Lcom/android/server/enterprise/auditlog/AuditLogService;->createAdmins()V

    const-string/jumbo v1, "(^Admin) ([0-9]+) (.*$)"

    invoke-static {v1}, Ljava/util/regex/Pattern;->compile(Ljava/lang/String;)Ljava/util/regex/Pattern;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mPattern:Ljava/util/regex/Pattern;
    ...
    iget-object v2, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mSdBroadcastReceiver:Landroid/content/BroadcastReceiver;
    ...
    iget-object v1, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mIptablesLogging:Lcom/android/server/enterprise/auditlog/IptablesLogging;

    invoke-virtual {v1}, Lcom/android/server/enterprise/auditlog/IptablesLogging;->turnNetworkLogOn()V
    :try_end_0
    ...
    invoke-static {v1}, Lcom/android/server/enterprise/utils/Utils;->getMessagePackageName(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, p0, Lcom/android/server/enterprise/auditlog/AuditLogService;->mMessagePackage:Ljava/lang/String;
