...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy$CheckSimLocked;,
...
.field private static mInstance:Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;

.field private static volatile mIsKeyguardAlreadyCalled:Z
...
.method static synthetic -get1()Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;
    .locals 1

    sget-object v0, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->mInstance:Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;
...
.method static synthetic -get2()Z
    ...
    sget-boolean v0, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->mIsKeyguardAlreadyCalled:Z

    return v0
.end method

.method static synthetic -get3(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)Lcom/android/server/enterprise/restriction/SimDBProxy;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)Ljava/lang/Runnable;
    .locals 1
...
.method static synthetic -get5(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)Landroid/os/Handler;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)Landroid/content/ServiceConnection;
    .locals 1
...
.method static synthetic -get7(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy$SmsMmsDeliveryHandler;
    .locals 1
...
.method static synthetic -wrap1(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->scheduleJob(Landroid/content/Context;)V

    return-void
.end method

.method static synthetic -wrap2(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;I)V
    .locals 0
...
.method static synthetic -wrap3(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;)V
    .locals 0
...
.method static synthetic -wrap4(Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;I)V
    .locals 0
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->mIsKeyguardAlreadyCalled:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sput-object p0, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->mInstance:Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;
...
.method private isOperationAllowed(II)Z
    ...
    const-string/jumbo v7, ">>> PhoneRestrictionPolicy.isOperationAllowed() was failed - SlotID is invalid "
    ...
    const-string/jumbo v7, "isOperationAllowed >>> slotNum: "
    ...
    const-string/jumbo v5, "allowData"

    aput-object v5, v0, v10

    const-string/jumbo v5, "allowIncomingCall"

    aput-object v5, v0, v11

    const-string/jumbo v5, "allowOutgoingCall"
    ...
    const-string/jumbo v5, "allowMMS"
    ...
    const-string/jumbo v6, "PHONERESTRICTION_SLOTID"

    invoke-virtual {v5, v6, v0, v2, v9}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getCursor(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string/jumbo v6, ">>> PhoneRestrictionPolicy.isOperationAllowed() Cursor is Null"
    ...
    const-string/jumbo v6, ">>> PhoneRestrictionPolicy.isOperationAllowed() - dB have some valid values"
    ...
    const-string/jumbo v7, ">>> PhoneRestrictionPolicy.isOperationAllowed() - Result is - "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string/jumbo v7, "allowData"
...
.method private static scheduleJob(Landroid/content/Context;)V
    ...
    const-class v4, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy$CheckSimLocked;
...
.method private setDynamicSimControl(Lcom/samsung/android/knox/ContextInfo;IIZ)I
    ...
    const-string/jumbo v12, "setDynamicSimControl >>> slotNum: "
    ...
    const-string/jumbo v12, " function: "
    ...
    const-string/jumbo v11, ">>> PhoneRestrictionPolicy.setDynamicSimControl() was failed - SlotID is invalid"
    ...
    const-string/jumbo v12, "Current Sim "
    ...
    const-string/jumbo v12, "is request for Data Block"
    ...
    invoke-virtual {v9, v10}, Landroid/telephony/TelephonyManager;->setDataEnabled(Z)V
    ...
    const-string/jumbo v10, "allowData"
    ...
    const-string/jumbo v10, "allowIncomingCall"
    ...
    const-string/jumbo v10, "allowOutgoingCall"
    ...
    const-string/jumbo v10, "allowIncomingSMS"
    ...
    const-string/jumbo v10, "allowMMS"
    ...
    const-string/jumbo v11, "PHONERESTRICTION_SLOTID"

    invoke-virtual {v10, v11, v2, v3}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->put(Ljava/lang/String;Landroid/content/ContentValues;Landroid/content/ContentValues;)Z
    :try_end_0
    ...
    const-string/jumbo v12, "Current Sim is "
    ...
    const-string/jumbo v12, ". Requested block Sim is not present in SlotId"
    ...
    const-string/jumbo v11, "CurrentSims list is null"
    ...
    const-string/jumbo v11, "setDynamicSimControl(): failed. unexpected exception - dB error"

    invoke-static {v10, v11, v4}, Lcom/android/server/enterprise/log/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private declared-synchronized unlockAllSimCards()V
    ...
    const-string/jumbo v11, "unlockAllSimCards, sending broadcast with action: com.samsung.android.knox.intent.action.DO_KEYGUARD_INTERNAL"

    invoke-static {v10, v11}, Lcom/android/server/enterprise/log/Log;->d(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v10, 0x1

    sput-boolean v10, Lcom/android/server/enterprise/restriction/PhoneRestrictionPolicy;->mIsKeyguardAlreadyCalled:Z
...
.method public getNetRegistRejectCause(I)I
    .locals 11
    ...
    const-string/jumbo v7, "getNetRegistRejectCause >>> slotNum: "
    ...
    const-string/jumbo v7, ">>> PhoneRestrictionPolicy.getNetRegistRejectCause() was failed - SlotID is invalid "
    ...
    const-string/jumbo v5, "setNetRejectCause"
    ...
    const-string/jumbo v6, "PHONERESTRICTION_NETREJCAUSE"

    invoke-virtual {v5, v6, v0, v2, v8}, Lcom/android/server/enterprise/storage/EdmStorageProvider;->getCursor(Ljava/lang/String;[Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    const-string/jumbo v6, ">>> PhoneRestrictionPolicy.getNetRegistRejectCause() Cursor is Null"
    ...
    const-string/jumbo v6, ">>> PhoneRestrictionPolicy.getNetRegistRejectCause() - DB have some valid values"
...
.method public setNetRegistRejectCause(II)I
    ...
    const-string/jumbo v7, "setNetRegistRejectCause >>> slotNum: "
    ...
    const-string/jumbo v5, ">>> PhoneRestrictionPolicy.setNetRegistRejectCause() was failed - SlotID is invalid"
    ...
    const-string/jumbo v5, "setNetRegistRejectCause(): failed. unexpected exception - dB error"

    invoke-static {v4, v5, v2}, Lcom/android/server/enterprise/log/Log;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
