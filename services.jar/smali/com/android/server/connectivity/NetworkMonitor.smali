...
.method private startWifiCaptivePortalLoginActivity(ZZ)V
    ...
    iget-boolean v5, p0, Lcom/android/server/connectivity/NetworkMonitor;->mIsSmartDetectionActivityCreated:Z
    ...
    iput-boolean v4, p0, Lcom/android/server/connectivity/NetworkMonitor;->mIsSmartDetectionActivityCreated:Z

    :cond_1
    :try_start_0
    iget-boolean v5, p0, Lcom/android/server/connectivity/NetworkMonitor;->mIsWifiOnly:Z

    if-nez v5, :cond_3

    const-string/jumbo v3, "com.android.captiveportallogin.WifiCaptivePortalLoginActivity"

    :goto_0
    new-instance v1, Landroid/content/Intent;

    const-string/jumbo v5, "android.net.conn.CAPTIVE_PORTAL_WIFI"
    ...
    const-string/jumbo v5, "android.net.extra.NETWORK"

    iget-object v6, p0, Lcom/android/server/connectivity/NetworkMonitor;->mNetworkAgentInfo:Lcom/android/server/connectivity/NetworkAgentInfo;

    iget-object v6, v6, Lcom/android/server/connectivity/NetworkAgentInfo;->network:Landroid/net/Network;

    invoke-virtual {v1, v5, v6}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const-string/jumbo v5, "android.net.extra.CAPTIVE_PORTAL"

    new-instance v6, Landroid/net/CaptivePortal;

    new-instance v7, Lcom/android/server/connectivity/NetworkMonitor$4;

    invoke-direct {v7, p0}, Lcom/android/server/connectivity/NetworkMonitor$4;-><init>(Lcom/android/server/connectivity/NetworkMonitor;)V

    invoke-direct {v6, v7}, Landroid/net/CaptivePortal;-><init>(Landroid/os/IBinder;)V

    invoke-virtual {v1, v5, v6}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;

    const-string/jumbo v5, "android.net.extra.CAPTIVE_PORTAL_SMART_DETECTION"

    invoke-virtual {v1, v5, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;

    const-string/jumbo v5, "android.net.extra.CAPTIVE_PORTAL_URL"

    iget-object v6, p0, Lcom/android/server/connectivity/NetworkMonitor;->mCaptivePortalDetectedUrl:Ljava/lang/String;
    ...
    iget-boolean v5, p0, Lcom/android/server/connectivity/NetworkMonitor;->mIsCaptivePortalLoginForeground:Z
    ...
    invoke-virtual {p0, v5, v4, v6, v7}, Lcom/android/server/connectivity/NetworkMonitor;->sendMessageDelayed(IIJ)V
    ...
    :cond_3
    const-string/jumbo v3, "com.android.captiveportallogin.CaptivePortalLoginActivity"
    :try_end_0
...
.method protected sendHttpProbe(Ljava/net/URL;I)Lcom/android/server/connectivity/NetworkMonitor$CaptivePortalProbeResult;
    ...
    const-string/jumbo v15, "200 response with Content-length=1 interpreted as 204 response."
