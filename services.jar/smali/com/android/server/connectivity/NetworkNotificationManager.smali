...
.method public showNotification(ILcom/android/server/connectivity/NetworkNotificationManager$NotificationType;Lcom/android/server/connectivity/NetworkAgentInfo;Lcom/android/server/connectivity/NetworkAgentInfo;Landroid/app/PendingIntent;Z)V
    ...
    const-string/jumbo v35, "ro.radio.noril"
    ...
    const-string/jumbo v37, "CscFeature_Wifi_ConfigSnsStatus"
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/net/NetworkInfo;->getExtraInfo()Ljava/lang/String;
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/net/NetworkCapabilities;->hasCapability(I)Z
    ...
    :cond_2
    sget-object v35, Lcom/android/server/connectivity/NetworkNotificationManager;->TAG:Ljava/lang/String;

    const-string/jumbo v36, "showNotification tag=%s event=%s transport=%s extraInfo=%s highPrioriy=%s"
    ...
    invoke-static/range {v33 .. v33}, Lcom/android/server/connectivity/NetworkNotificationManager;->getTransportName(I)Ljava/lang/String;
    ...
    invoke-static/range {v33 .. v33}, Lcom/android/server/connectivity/NetworkNotificationManager;->getIcon(I)I

    move-result v19

    sget-object v35, Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;->NO_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    sget-object v35, Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;->SIGN_IN:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    const-string/jumbo v37, "Captive portal Notification: "
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setAutoCancel(Z)Landroid/app/Notification$Builder;
    ...
    const-string/jumbo v35, "android.net.netmon.dismissHunNotification"

    move-object/from16 v0, v35

    invoke-direct {v13, v0}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    new-instance v35, Landroid/app/Notification$Action$Builder;
    ...
    invoke-virtual/range {v35 .. v35}, Landroid/app/Notification$Action$Builder;->build()Landroid/app/Notification$Action;

    move-result-object v4

    new-instance v26, Landroid/content/Intent;

    const-string/jumbo v35, "android.net.netmon.signinHunNotification"
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setDefaults(I)Landroid/app/Notification$Builder;
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setDeleteIntent(Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;
    ...
    :cond_8
    sget-object v35, Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;->LOST_INTERNET:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    const-string/jumbo v36, "CscFeature_Common_ConfigPco"
    ...
    const-string/jumbo v35, "persist.sys.pcovalue"
    ...
    const-string/jumbo v36, "Don\'t show Sign in notification when insrted PCO 3/5 SIM card."
    ...
    :cond_d
    sget-object v35, Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;->NETWORK_SWITCH:Lcom/android/server/connectivity/NetworkNotificationManager$NotificationType;
    ...
    invoke-static/range {v35 .. v35}, Lcom/android/server/connectivity/NetworkNotificationManager;->getTransportName(I)Ljava/lang/String;
    ...
    const-string/jumbo v37, "Unknown notification type "
    ...
    const-string/jumbo v37, " on network transport "
    ...
    invoke-static/range {v35 .. v36}, Landroid/util/Slog;->wtf(Ljava/lang/String;Ljava/lang/String;)I
    ...
    const-string/jumbo v35, "android.net.netmon.dismissHunWcmNoril"
    ...
    const-string/jumbo v35, "ACTION_SNS_NO_INTERNET_HUN_GO_SETTINGS"
    ...
    invoke-virtual/range {v36 .. v37}, Landroid/content/Context;->getColor(I)I

    move-result v36

    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setColor(I)Landroid/app/Notification$Builder;
    ...
    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setLocalOnly(Z)Landroid/app/Notification$Builder;

    move-result-object v35

    const/16 v36, 0x1

    invoke-virtual/range {v35 .. v36}, Landroid/app/Notification$Builder;->setOnlyAlertOnce(Z)Landroid/app/Notification$Builder;
    ...
    invoke-direct/range {v35 .. v35}, Landroid/app/Notification$BigTextStyle;-><init>()V
    ...
    new-instance v35, Landroid/app/Notification$TvExtender;

    invoke-direct/range {v35 .. v35}, Landroid/app/Notification$TvExtender;-><init>()V
    ...
    const-string/jumbo v36, "setNotificationVisible: visible notificationManager error"
