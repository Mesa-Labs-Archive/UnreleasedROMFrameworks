...
.method static synthetic -get11(Lcom/android/server/connectivity/Vpn;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get12(Lcom/android/server/connectivity/Vpn;)Lcom/samsung/android/knox/net/vpn/IKnoxVpnPolicy;
    .locals 1
...
.method static synthetic -get13(Lcom/android/server/connectivity/Vpn;)Lcom/android/server/connectivity/Vpn$LegacyVpnRunner;
    .locals 1
...
.method static synthetic -get14(Lcom/android/server/connectivity/Vpn;)I
    .locals 1
...
.method static synthetic -get15(Lcom/android/server/connectivity/Vpn;)I
    .locals 1
...
.method static synthetic -get16(Lcom/android/server/connectivity/Vpn;)Landroid/os/Looper;
    .locals 1
...
.method static synthetic -get17(Lcom/android/server/connectivity/Vpn;)Landroid/net/NetworkCapabilities;
    .locals 1
...
.method static synthetic -get18(Lcom/android/server/connectivity/Vpn;)Landroid/net/NetworkInfo;
    .locals 1
...
.method static synthetic -get19(Lcom/android/server/connectivity/Vpn;)Landroid/net/INetworkManagementEventObserver;
    .locals 1
...
.method static synthetic -get21(Lcom/android/server/connectivity/Vpn;)Landroid/app/PendingIntent;
    .locals 1
...
.method static synthetic -get22(Lcom/android/server/connectivity/Vpn;)I
    .locals 1
...
.method static synthetic -get23(Lcom/android/server/connectivity/Vpn;)I
    .locals 1
...
.method static synthetic -get24(Lcom/android/server/connectivity/Vpn;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get25(Lcom/android/server/connectivity/Vpn;)Lcom/android/server/connectivity/VpnRules;
    .locals 1
...
.method static synthetic -get26(Lcom/android/server/connectivity/Vpn;)Ljava/util/Set;
    .locals 1
...
.method static synthetic -get4(Lcom/android/server/connectivity/Vpn;)Lcom/android/internal/net/VpnConfig;
    .locals 1
...
.method static synthetic -get5(Lcom/android/server/connectivity/Vpn;)Lcom/android/server/connectivity/Vpn$Connection;
    .locals 1
...
.method static synthetic -get6(Lcom/android/server/connectivity/Vpn;)Landroid/content/Context;
    .locals 1
...
.method static synthetic -get7(Lcom/android/server/connectivity/Vpn;)Ljava/lang/String;
    .locals 1
...
.method static synthetic -get9(Lcom/android/server/connectivity/Vpn;)Z
    .locals 1
...
.method static synthetic -wrap9(Lcom/android/server/connectivity/Vpn;Landroid/net/NetworkInfo$DetailedState;)V
    .locals 0
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Landroid/os/INetworkManagementService;I)V
    ...
    iput-boolean v5, p0, Lcom/android/server/connectivity/Vpn;->mIsLocaleChangedReceiverRegistered:Z
...
.method private agentConnect()V
    ...
    invoke-direct/range {v0 .. v9}, Lcom/android/server/connectivity/Vpn$4;-><init>(Lcom/android/server/connectivity/Vpn;Landroid/os/Looper;Landroid/content/Context;Ljava/lang/String;Landroid/net/NetworkInfo;Landroid/net/NetworkCapabilities;Landroid/net/LinkProperties;ILandroid/net/NetworkMisc;)V
...
.method private showVpnNotification(I)V
    ...
    const-string/jumbo v12, "[Legacy VPN]"
    ...
    invoke-interface {v11, v12, v13, p1}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;II)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v5, v11, v12, v10, v4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    invoke-direct {p0, v6, v1, p1}, Lcom/android/server/connectivity/Vpn;->showNotification(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
    ...
    const-string/jumbo v12, "Invalid application"
    ...
    :cond_1
    invoke-direct {p0, v13, v13, p1}, Lcom/android/server/connectivity/Vpn;->showNotification(Ljava/lang/String;Landroid/graphics/Bitmap;I)V
...
.method private unregisterLocaleChangedReceiver()V
    ...
    iget-boolean v1, p0, Lcom/android/server/connectivity/Vpn;->mIsLocaleChangedReceiverRegistered:Z
    ...
    iget-object v2, p0, Lcom/android/server/connectivity/Vpn;->mLocaleChangedReceiver:Landroid/content/BroadcastReceiver;
    ...
    const-string/jumbo v2, "Failed to unregister LocaleChangedReceiver"
...
.method addUserToRanges(Ljava/util/Set;ILjava/util/List;Ljava/util/List;)V
    ...
    new-instance v15, Landroid/net/UidRange;

    invoke-direct {v15, v7, v8}, Landroid/net/UidRange;-><init>(II)V
    ...
    invoke-direct {v0, v15}, Lcom/android/server/connectivity/Vpn;->isSecureWifiPackage(Landroid/content/Context;)Z
    ...
    const-string/jumbo v16, "FAST uses Secure WiFi notification."
    ...
    iget v7, v14, Landroid/net/UidRange;->start:I
    ...
    invoke-direct {v15, v7, v0}, Landroid/net/UidRange;-><init>(II)V
    ...
    :cond_6
    iget v15, v14, Landroid/net/UidRange;->stop:I

    if-gt v7, v15, :cond_3

    new-instance v15, Landroid/net/UidRange;

    iget v0, v14, Landroid/net/UidRange;->stop:I
    ...
    iget v15, v4, Landroid/content/pm/UserInfo;->id:I

    invoke-static {v15}, Landroid/net/UidRange;->createForUser(I)Landroid/net/UidRange;
    ...
    const-string/jumbo v17, "Add UID with prefix "
    ...
    invoke-direct {v0, v1}, Lcom/android/server/connectivity/Vpn;->showVpnNotification(I)V
...
.method public showNotificationForLockdown(II)V
    ...
    const-string/jumbo v9, "showNotificationForLockdown :"
