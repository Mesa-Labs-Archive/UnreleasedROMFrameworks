...
.method private static incrementRescueLevel(I)V
    ...
    invoke-static {v4, v1}, Lcom/android/server/pm/PackageManagerService;->logCriticalInfo(ILjava/lang/String;)V
...
.method private static levelToString(I)Ljava/lang/String;
    ...
    :pswitch_1
    const-string/jumbo v0, "HW_RESET"
...
.method private static waitForDumpstate(I)V
    ...
    const-string/jumbo v4, "init.svc.bugreportsa"
