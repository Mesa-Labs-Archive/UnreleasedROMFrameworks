...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;
    }
.end annotation
...
.field private static final STATUS_BAR_ICON_CHANGE_MAX_NUMBER:I = 0x19
...
.field private final mStatusBarIconsHistory:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mStatusBarIconsHistory:Ljava/util/ArrayList;
...
.method static synthetic lambda$-com_android_server_statusbar_StatusBarManagerService_29827()V
    .locals 3
...
.method static synthetic lambda$-com_android_server_statusbar_StatusBarManagerService_30308(Z)V
    .locals 3
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v9, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mContext:Landroid/content/Context;
    ...
    :cond_0
    iget-object v10, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mLock:Ljava/lang/Object;
    ...
    const-string/jumbo v11, "  mDisabled1=0x"

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v11, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisabled1:I
    ...
    const-string/jumbo v11, "  mDisabled2=0x"

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v11, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisabled2:I
    ...
    iget-object v9, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisableRecords:Ljava/util/ArrayList;
    ...
    const-string/jumbo v11, "  mDisableRecords.size="
    ...
    check-cast v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;
    ...
    iget v11, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->userId:I

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v9

    const-string/jumbo v11, " what1=0x"

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v11, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->what1:I
    ...
    const-string/jumbo v11, " what2=0x"

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v11, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->what2:I
    ...
    iget-object v11, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->pkg:Ljava/lang/String;
    ...
    iget-object v11, v7, Lcom/android/server/statusbar/StatusBarManagerService$DisableRecord;->token:Landroid/os/IBinder;
    ...
    const-string/jumbo v11, "  mCurrentUserId="

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    iget v11, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mCurrentUserId:I
    ...
    const-string/jumbo v9, "  mIcons="

    invoke-virtual {p2, v9}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    iget-object v9, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mIcons:Landroid/util/ArrayMap;
    ...
    iget-object v9, v2, Lcom/android/internal/statusbar/StatusBarIcon;->contentDescription:Ljava/lang/CharSequence;
    ...
    iget-object v10, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisableHistoryList:Ljava/util/ArrayList;

    monitor-enter v10

    :try_start_1
    iget-object v9, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mDisableHistoryList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v11, "  mDisableHistoryList.size="
    ...
    iget-object v9, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mStatusBarIconsHistory:Ljava/util/ArrayList;
    ...
    const-string/jumbo v10, "  mStatusBarIconsHistory.size= "
    ...
    check-cast v6, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;
    ...
    iget-object v10, v6, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->time:Ljava/lang/String;
    ...
    iget-object v10, v6, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->slot:Ljava/lang/String;
    ...
    iget-boolean v10, v6, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->newVisibility:Z
    ...
    iget v10, v6, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->callingUid:I
...
.method public isFOTAAvailableForGlobalActions()Z
    ...
    const-string/jumbo v4, "FOTA update available when asking recovery system"
...
.method synthetic lambda$-com_android_server_statusbar_StatusBarManagerService_28191()V
    .locals 2
...
.method public setIconVisibility(Ljava/lang/String;Z)V
    ...
    const-string/jumbo v6, "setIconVisibility icon is null for slot="
    ...
    invoke-interface {v3, p1, v1}, Lcom/android/internal/statusbar/IStatusBar;->setIcon(Ljava/lang/String;Lcom/android/internal/statusbar/StatusBarIcon;)V

    new-instance v2, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;

    const/4 v3, 0x0

    invoke-direct {v2, p0, v3}, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;-><init>(Lcom/android/server/statusbar/StatusBarManagerService;Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;)V

    invoke-direct {p0}, Lcom/android/server/statusbar/StatusBarManagerService;->makeTime()Ljava/lang/String;

    move-result-object v3

    iput-object v3, v2, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->time:Ljava/lang/String;

    iput-object p1, v2, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->slot:Ljava/lang/String;

    iput-boolean p2, v2, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->newVisibility:Z

    invoke-static {}, Landroid/os/Binder;->getCallingUid()I

    move-result v3

    iput v3, v2, Lcom/android/server/statusbar/StatusBarManagerService$StatusBarIconsHistory;->callingUid:I

    iget-object v3, p0, Lcom/android/server/statusbar/StatusBarManagerService;->mStatusBarIconsHistory:Ljava/util/ArrayList;
