...
.field private static final EXCEPTION_PACKAGES:[Ljava/lang/String; = null
...
.method private sessionStarting(Lcom/samsung/android/server/virtualspace/VSSession;)V
    ...
    const-string/jumbo v1, "VS session starting"
    ...
    invoke-direct {p0, v0}, Lcom/samsung/android/server/virtualspace/VSManagerService;->startDisplayRedirect(Landroid/os/IBinder;)V

    invoke-direct {p0, v4}, Lcom/samsung/android/server/virtualspace/VSManagerService;->enableStatusBar(Z)V
    ...
    iput-object v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSavedSelectedInputMethodSubtype:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSavedSelectedInputMethod:Ljava/lang/String;
    ...
    invoke-interface {v0, v3}, Lcom/android/server/am/IActivityManagerServiceBridge;->setSupportsPictureInPicture(Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSavedPIPMode:Z

    :cond_1
    iget-object v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSWM:Lcom/android/server/wm/IWindowManagerServiceBridge;

    invoke-interface {v0, v3}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setInTouchMode(Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSavedInTouchMode:Z

    iget-object v0, p0, Lcom/samsung/android/server/virtualspace/VSManagerService;->mSWM:Lcom/android/server/wm/IWindowManagerServiceBridge;

    invoke-interface {v0, v4}, Lcom/android/server/wm/IWindowManagerServiceBridge;->setInMouseStylusMode(Z)Z
    ...
    invoke-virtual {v0, v3}, Lcom/samsung/android/media/SemSoundAssistantManager;->setVolumeKeyMode(I)V
...
.method sessionClosed()V
    ...
    invoke-interface {v0, v3, v3}, Lcom/android/server/wm/IWindowManagerServiceBridge;->overridePidDisplay(II)V

    invoke-direct {p0}, Lcom/samsung/android/server/virtualspace/VSManagerService;->endRedirect()V

    invoke-direct {p0, v5}, Lcom/samsung/android/server/virtualspace/VSManagerService;->setSession(Lcom/samsung/android/server/virtualspace/VSSession;)V
