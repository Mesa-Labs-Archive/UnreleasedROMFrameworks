...
.method private handleAuthResponse(Landroid/os/Message;)V
    ...
    invoke-virtual {v12}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getYear()I

    move-result v4

    move-object/from16 v0, p0

    invoke-direct {v0, v4}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->isVerifiedCoverYear(I)Z
    ...
    const-string/jumbo v5, "This cover is not available"
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->setReason(I)V

    invoke-virtual/range {v21 .. v21}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getReason()I
...
.method private isVerifiedCoverYear(I)Z
    ...
    const-string/jumbo v1, "Samsung Mobile"
    ...
    const-string/jumbo v4, "coverYear : "
    ...
    const-string/jumbo v4, " , phoneModel : "
...
.method private setCoverVerified(ZZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    ...
    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setAttachState(Z)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getColor()I

    move-result v5

    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setColor(I)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getModel()I

    move-result v5

    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setModel(I)V
    ...
    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setSmartCoverAppUri(Ljava/lang/String;)V

    invoke-virtual {p4}, Lcom/samsung/accessory/manager/authentication/AuthenticationResult;->getByteArrayExtraData()[B

    move-result-object v5

    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setSmartCoverCookie([B)V
    ...
    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mUriData:[B
    ...
    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setFriendsType(I)V
    ...
    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setType(I)V

    invoke-virtual {p3}, Lcom/samsung/accessory/manager/authentication/cover/CoverInfo;->getSn()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v1, v5}, Lcom/samsung/android/cover/CoverState;->setSerialNumber(Ljava/lang/String;)V
    ...
    iget v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->currentHall:I

    if-nez v5, :cond_2

    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mInputManager:Lcom/android/server/input/InputManagerService;

    invoke-virtual {v1}, Lcom/samsung/android/cover/CoverState;->getType()I

    move-result v6

    invoke-virtual {v5, v6}, Lcom/android/server/input/InputManagerService;->setCoverVerify(I)V

    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mPowerManager:Landroid/os/PowerManager;

    invoke-virtual {v1}, Lcom/samsung/android/cover/CoverState;->getType()I

    move-result v6

    invoke-virtual {v5, v6}, Landroid/os/PowerManager;->setCoverType(I)V
    ...
    :cond_2
    iget v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mAuthType:I
    ...
    const-string/jumbo v7, "coverInfo.getUrl: "
    ...
    const-string/jumbo v5, "com.sec.android.app.applinker.REQUEST_LINK"

    invoke-direct {v4, v5}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    new-instance v0, Landroid/content/Intent;

    const-string/jumbo v5, "com.samsung.android.intent.action.ACCESSORY_AUTHENTICATION_COMPLETE"
    ...
    invoke-direct {p0, v7, v5, v6}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyFriendsStateChanged(Z[B[B)Z

    :goto_2
    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v0}, Landroid/content/Context;->sendBroadcast(Landroid/content/Intent;)V

    :cond_5
    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mCoverAuthStateFile:Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;
    ...
    invoke-static {v5, v6, v7, v8}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;->-wrap0(Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator$CoverAuthStateFile;[B[B[B)V
    ...
    iput-wide v6, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastAuthenticationTime:J

    const/4 v5, 0x0

    iput v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mFailuresCount:I
    ...
    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;
    ...
    invoke-virtual {v5, v6}, Lcom/samsung/android/cover/CoverState;->setAttachState(Z)V

    :cond_10
    iget-object v5, p0, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->mLastCoverState:Lcom/samsung/android/cover/CoverState;

    invoke-virtual {p0, p1, v5}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->applyCoverVerifiedState(ZLcom/samsung/android/cover/CoverState;)Z
    ...
    invoke-direct {p0, v6, v5, v7}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyFriendsStateChanged(Z[B[B)Z
...
.method private setFriendsVerified(ZLcom/samsung/accessory/manager/authentication/cover/CoverInfo;Lcom/samsung/accessory/manager/authentication/AuthenticationResult;)V
    ...
    invoke-direct {p0, v4, v0, v3}, Lcom/samsung/accessory/manager/authentication/cover/CoverAuthenticator;->notifyFriendsStateChanged(Z[B[B)Z
