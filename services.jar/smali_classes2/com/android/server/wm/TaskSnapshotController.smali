...
.method private drawAppThemeSnapshot(Lcom/android/server/wm/Task;)Landroid/app/ActivityManager$TaskSnapshot;
    ...
    invoke-direct {v0, v6, v9, v4, v5}, Landroid/graphics/Rect;-><init>(IIII)V
    ...
    invoke-interface {v4, v0}, Lcom/samsung/android/view/IWindowStateBridge;->needReverseFrame(Landroid/graphics/Rect;)Z
    ...
    invoke-interface {v4, v0}, Lcom/samsung/android/view/IWindowStateBridge;->reverseFrame(Landroid/graphics/Rect;)V

    invoke-virtual/range {v23 .. v23}, Lcom/android/server/wm/WindowState;->getBridge()Lcom/samsung/android/view/IWindowStateBridge;

    move-result-object v4

    invoke-interface {v4, v12}, Lcom/samsung/android/view/IWindowStateBridge;->reverseFrame(Landroid/graphics/Rect;)V

    :cond_2
    if-eqz v22, :cond_3

    invoke-virtual/range {v23 .. v23}, Lcom/android/server/wm/WindowState;->getFrameLw()Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v1}, Landroid/view/DisplayListCanvas;->drawColor(I)V

    move-object/from16 v0, v17

    invoke-virtual {v3, v0, v12}, Lcom/android/server/wm/TaskSnapshotSurface$SystemBarBackgroundPainter;->setInsets(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v26 .. v26}, Lcom/android/server/wm/AppWindowToken;->getConfiguration()Landroid/content/res/Configuration;
...
.method synthetic lambda$-com_android_server_wm_TaskSnapshotController_16298(Landroid/view/WindowManagerPolicy$ScreenOffListener;)V
    .locals 4
...
.method synthetic lambda$-com_android_server_wm_TaskSnapshotController_16463(Lcom/android/server/wm/Task;)V
    .locals 1
