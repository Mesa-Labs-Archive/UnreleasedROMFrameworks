...
.method public constructor <init>(Lcom/android/server/wm/WindowManagerService;Landroid/view/IWindowSessionCallback;Lcom/android/internal/view/IInputMethodClient;Lcom/android/internal/view/IInputContext;)V
    ...
    iput-object v0, p0, Lcom/android/server/wm/Session;->mAppOverlaySurfaces:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lcom/android/server/wm/Session;->mAlertWindowSurfaces:Ljava/util/Set;
    ...
    iput v0, p0, Lcom/android/server/wm/Session;->mUid:I

    invoke-static {}, Landroid/os/Binder;->getCallingPid()I

    move-result v0

    iput v0, p0, Lcom/android/server/wm/Session;->mPid:I

    const/16 v0, 0x63

    iput v0, p0, Lcom/android/server/wm/Session;->mTheme:I

    invoke-virtual {p1}, Lcom/android/server/wm/WindowManagerService;->getCurrentAnimatorScale()F

    move-result v0

    iput v0, p0, Lcom/android/server/wm/Session;->mLastReportedAnimatorScale:F
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/server/wm/Session;->mCanAddInternalSystemWindow:Z

    iget-object v0, p1, Lcom/android/server/wm/WindowManagerService;->mContext:Landroid/content/Context;

    const-string/jumbo v1, "android.permission.HIDE_NON_SYSTEM_OVERLAY_WINDOWS"
    ...
    :goto_1
    iput-boolean v0, p0, Lcom/android/server/wm/Session;->mCanHideNonSystemOverlayWindows:Z

    iget-object v0, p0, Lcom/android/server/wm/Session;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-boolean v0, v0, Lcom/android/server/wm/WindowManagerService;->mShowAlertWindowNotifications:Z

    iput-boolean v0, p0, Lcom/android/server/wm/Session;->mShowingAlertWindowNotificationAllowed:Z
    ...
    iget v0, p0, Lcom/android/server/wm/Session;->mUid:I
    ...
    iput-object v0, p0, Lcom/android/server/wm/Session;->mStringName:Ljava/lang/String;
    ...
    iget-boolean v0, v0, Lcom/android/server/wm/WindowManagerService;->mHaveInputMethods:Z
    ...
    invoke-static {v6}, Lcom/android/internal/view/IInputMethodManager$Stub;->asInterface(Landroid/os/IBinder;)Lcom/android/internal/view/IInputMethodManager;

    move-result-object v2

    iput-object v2, v0, Lcom/android/server/wm/WindowManagerService;->mInputMethodManager:Lcom/android/internal/view/IInputMethodManager;
    :try_end_0
    ...
    iget v4, p0, Lcom/android/server/wm/Session;->mPid:I

    iget v5, p0, Lcom/android/server/wm/Session;->mTheme:I

    move-object v1, p3

    move-object/from16 v2, p4

    invoke-interface/range {v0 .. v5}, Lcom/android/internal/view/IInputMethodManager;->addClient(Lcom/android/internal/view/IInputMethodClient;Lcom/android/internal/view/IInputContext;III)V
    ...
    invoke-interface {v0, p3}, Lcom/android/internal/view/IInputMethodManager;->removeClient(Lcom/android/internal/view/IInputMethodClient;)V
    :try_end_3
