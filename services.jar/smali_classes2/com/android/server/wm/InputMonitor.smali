...
.method addInputWindowHandle(Lcom/android/server/input/InputWindowHandle;Lcom/android/server/wm/WindowState;IIZZZ)V
    ...
    iget-object v3, p1, Lcom/android/server/input/InputWindowHandle;->pointerTouchableRegion:Landroid/graphics/Region;

    invoke-virtual {p2, v2, p3, v3}, Lcom/android/server/wm/WindowState;->getTouchableRegion(Landroid/graphics/Region;ILandroid/graphics/Region;)I
    ...
    iput v2, p1, Lcom/android/server/input/InputWindowHandle;->layoutParamsSamsungFlags:I
    ...
    invoke-interface {v2, v1}, Lcom/samsung/android/view/IWindowStateBridge;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
    ...
    const-string/jumbo v4, "addInputWindowHandle: "
    ...
    :cond_4
    iget-boolean v2, p2, Lcom/android/server/wm/WindowState;->mDssEnabled:Z
