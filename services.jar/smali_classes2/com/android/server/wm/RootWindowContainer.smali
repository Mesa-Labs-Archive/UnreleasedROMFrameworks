...
.method static synthetic lambda$-com_android_server_wm_RootWindowContainer_16317(Ljava/lang/String;Ljava/util/ArrayList;ILcom/android/server/wm/WindowState;)V
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_RootWindowContainer_22040(IZLcom/android/server/wm/WindowState;)V
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_RootWindowContainer_22862(ILcom/android/server/wm/WindowState;)Z
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_RootWindowContainer_54126(Ljava/util/ArrayList;Ljava/io/PrintWriter;[IZLcom/android/server/wm/WindowState;)V
    .locals 4
...
.method handleNotObscuredLocked(Lcom/android/server/wm/WindowState;ZZ)Z
    ...
    iget-boolean v11, v5, Lcom/android/server/wm/DisplayContent;->isDefaultDisplay:Z
    ...
    iget-boolean v11, v0, Lcom/android/server/wm/WindowState;->mHasSurface:Z
    ...
    iput-object v11, v0, Lcom/android/server/wm/RootWindowContainer;->mHoldScreen:Lcom/android/server/wm/Session;

    move-object/from16 v0, p1

    move-object/from16 v1, p0

    iput-object v0, v1, Lcom/android/server/wm/RootWindowContainer;->mHoldScreenWindow:Lcom/android/server/wm/WindowState;
    ...
    iget v11, v0, Lcom/android/server/wm/RootWindowContainer;->mScreenBrightness:F
    ...
    iput v11, v0, Lcom/android/server/wm/RootWindowContainer;->mScreenBrightness:F
    ...
    iget-wide v12, v11, Landroid/view/WindowManager$LayoutParams;->screenDimDuration:J
    ...
    iget-object v11, v0, Lcom/android/server/wm/RootWindowContainer;->mService:Lcom/android/server/wm/WindowManagerService;
    ...
    invoke-virtual {v11}, Lcom/android/server/policy/PhoneWindowManager;->getSamsungPolicy()Lcom/android/server/policy/IPhoneWindowManagerBridge;
    ...
    invoke-interface {v11, v0, v1}, Lcom/android/server/policy/IPhoneWindowManagerBridge;->restoreForceUserActivityTimeout(ZLandroid/view/WindowManagerPolicy$WindowState;)V
    ...
    iget-boolean v11, v6, Lcom/android/server/wm/DisplayContent;->isDefaultDisplay:Z
    ...
    :cond_9
    sget-boolean v11, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_KEEP_SCREEN_ON:Z
    ...
    iget-object v11, v11, Lcom/android/server/wm/WindowManagerService;->mLastWakeLockHoldingWindow:Lcom/android/server/wm/WindowState;

    move-object/from16 v0, p1

    if-ne v0, v11, :cond_0

    const-string/jumbo v11, "DebugKeepScreenOn"

    new-instance v12, Ljava/lang/StringBuilder;

    invoke-direct {v12}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v13, "handleNotObscuredLocked: "
    ...
    const-string/jumbo v13, " was holding "

    invoke-virtual {v12, v13}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v12

    const-string/jumbo v13, "screen wakelock but no longer has FLAG_KEEP_SCREEN_ON!!! called by"
    ...
    iget-boolean v11, v0, Lcom/android/server/wm/RootWindowContainer;->mObscureApplicationContentOnSecondaryDisplays:Z
...
.method synthetic lambda$-com_android_server_wm_RootWindowContainer_22418(Lcom/android/server/wm/WindowState;)V
    .locals 7
...
.method synthetic lambda$-com_android_server_wm_RootWindowContainer_25525(Landroid/util/SparseIntArray;Lcom/android/server/wm/WindowState;)V
    .locals 3
