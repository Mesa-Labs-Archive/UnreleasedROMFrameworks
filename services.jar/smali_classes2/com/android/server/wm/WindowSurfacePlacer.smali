...
.method private transitionGoodToGo(I)Z
    ...
    sget-boolean v20, Lcom/android/server/wm/WindowManagerDebugConfig;->DEBUG_APP_TRANSITIONS:Z

    if-eqz v20, :cond_0

    sget-object v20, Lcom/android/server/wm/WindowSurfacePlacer;->TAG:Ljava/lang/String;

    new-instance v21, Ljava/lang/StringBuilder;

    invoke-direct/range {v21 .. v21}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v22, "Checking "
    ...
    const-string/jumbo v22, " opening apps (frozen="
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/wm/AppTransition;->isTimeout()Z
    ...
    iget-object v12, v0, Lcom/android/server/wm/WindowSurfacePlacer;->mTempTransitionReasons:Landroid/util/SparseIntArray;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/AppTransition;->isTimeout()Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/WindowManagerService;->rotationNeedsUpdateLocked()Z
    ...
    const-string/jumbo v21, "Delaying app transition for screen rotation animation to finish"
    ...
    const-string/jumbo v22, "Check opening app="
    ...
    const-string/jumbo v22, ": allDrawn="
    ...
    const-string/jumbo v22, " startingDisplayed="
    ...
    const-string/jumbo v22, " startingMoved="
    ...
    const-string/jumbo v22, " isRelaunching()="

    invoke-virtual/range {v21 .. v22}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v21

    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/AppWindowToken;->isRelaunching()Z
    ...
    iget-boolean v7, v0, Lcom/android/server/wm/AppWindowToken;->allDrawn:Z

    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/AppWindowToken;->restoreSavedSurfaceForInterestingWindows()V
    ...
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/AppWindowToken;->getTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/android/server/wm/ScreenFreezeAnimationController;->shouldKeepVisibleAnimation(Lcom/android/server/wm/AppWindowToken;ZZ)Z
    ...
    const-string/jumbo v22, " for app transition which has no main window"
    ...
    const-string/jumbo v21, "Nothing to show"
    ...
    :cond_8
    invoke-virtual/range {v19 .. v19}, Lcom/android/server/wm/AppWindowToken;->getStack()Lcom/android/server/wm/TaskStack;

    move-result-object v14

    if-eqz v14, :cond_9

    iget v15, v14, Lcom/android/server/wm/TaskStack;->mStackId:I
    ...
    invoke-virtual {v12, v15, v0}, Landroid/util/SparseIntArray;->put(II)V
    ...
    invoke-virtual {v14}, Lcom/android/server/wm/TaskStack;->isAdjustedForIme()Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/AppTransition;->isFetchingAppTransitionsSpecs()Z
    ...
    const-string/jumbo v21, "isFetchingAppTransitionSpecs=true"
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/UnknownAppVisibilityController;->allResolved()Z
    ...
    const-string/jumbo v22, "unknownApps is not empty: "
    ...
    invoke-virtual/range {v22 .. v22}, Lcom/android/server/wm/UnknownAppVisibilityController;->getDebugMessage()Ljava/lang/String;
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/WallpaperController;->isWallpaperVisible()Z
    ...
    invoke-virtual/range {v20 .. v20}, Lcom/android/server/wm/WallpaperController;->wallpaperTransitionReady()Z
    ...
    invoke-virtual {v0, v11, v1}, Lcom/android/server/wm/AppWindowToken;->dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    invoke-virtual {v10}, Lcom/android/server/wm/WindowState;->isInMultiWindowMode()Z
    ...
    const-string/jumbo v22, "Check main window ="
    ...
    const-string/jumbo v22, "Check wallpaper ready="
