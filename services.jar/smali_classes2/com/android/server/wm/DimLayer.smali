...
.method private adjustBounds()V
    ...
    invoke-virtual {v2}, Lcom/android/server/policy/PhoneWindowManager;->getSamsungPolicy()Lcom/android/server/policy/IPhoneWindowManagerBridge;
    ...
    invoke-direct {p0, v2}, Lcom/android/server/wm/DimLayer;->getBoundsForFullscreen(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v2, v3}, Lcom/android/server/wm/MultiWindowManagerInternal;->adjustBoundsToMagnificationSpec(Landroid/graphics/Rect;)V
    ...
    iget-object v4, p0, Lcom/android/server/wm/DimLayer;->mAdjToMagnificationRect:Landroid/graphics/Rect;
    ...
    const-string/jumbo v4, "adjustBounds user="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, p0, Lcom/android/server/wm/DimLayer;->mUser:Lcom/android/server/wm/DimLayer$DimLayerUser;

    invoke-interface {v4}, Lcom/android/server/wm/DimLayer$DimLayerUser;->toShortString()Ljava/lang/String;
    ...
    :cond_4
    iget-boolean v2, p0, Lcom/android/server/wm/DimLayer;->mIsFreeformDimLayer:Z
    ...
    iput-boolean v2, p0, Lcom/android/server/wm/DimLayer;->mDrawFreeformRoundDimLayerRequested:Z
