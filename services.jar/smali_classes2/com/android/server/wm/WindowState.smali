...
.field private final mGravityAdjustedBounds:Landroid/graphics/Rect;
...
.field private mMovedToTopByIme:Z
...
.method constructor <init>(Lcom/android/server/wm/WindowManagerService;Lcom/android/server/wm/Session;Landroid/view/IWindow;Lcom/android/server/wm/WindowToken;Lcom/android/server/wm/WindowState;IILandroid/view/WindowManager$LayoutParams;IIZ)V
    ...
    iput-object v4, p0, Lcom/android/server/wm/WindowState;->mGravityAdjustedBounds:Landroid/graphics/Rect;
    ...
    iput-boolean v4, p0, Lcom/android/server/wm/WindowState;->mNextForceRelayoutToClient:Z
...
.method private calculateSystemDecorRect(Landroid/graphics/Rect;)V
    ...
    invoke-interface {v9}, Lcom/samsung/android/view/IWindowStateBridge;->isCustomAspectRatioWindow()Z
...
.method private dispatchResized(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;ZLandroid/util/MergedConfiguration;ZI)V
    ...
    iget-boolean v10, p0, Lcom/android/server/wm/WindowState;->mNextForceRelayoutToClient:Z
...
.method static synthetic lambda$-com_android_server_wm_WindowState_49427(Lcom/android/server/wm/WindowState;)Z
    .locals 2
...
.method private removeIfPossible(Z)V
    ...
    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->mWindowRemovalAllowed:Z
    ...
    const-string/jumbo v11, "removeIfPossible: "
    ...
    iget-object v9, v9, Lcom/android/server/wm/WindowManagerService;->mFreeformController:Lcom/android/server/wm/FreeformStackWindowController;

    const/4 v10, 0x0

    invoke-virtual {v9, v10}, Lcom/android/server/wm/FreeformStackWindowController;->setForceHidingFloatingMultiWindow(Z)V
    ...
    iget-object v11, p0, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;
    ...
    iget-boolean v11, p0, Lcom/android/server/wm/WindowState;->mRemoveOnExit:Z
    ...
    iget-boolean v11, p0, Lcom/android/server/wm/WindowState;->mHasSurface:Z
    ...
    iget-boolean v11, p0, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z
    ...
    iget-boolean v9, p0, Lcom/android/server/wm/WindowState;->mHasSurface:Z

    if-eqz v9, :cond_19

    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mService:Lcom/android/server/wm/WindowManagerService;

    invoke-virtual {v9}, Lcom/android/server/wm/WindowManagerService;->okToDisplay()Z

    move-result v9

    if-eqz v9, :cond_19

    iget-boolean v9, p0, Lcom/android/server/wm/WindowState;->mWillReplaceWindow:Z
    ...
    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->mAnimatingExit:Z
    ...
    iget-boolean v9, v9, Lcom/android/server/wm/AppWindowToken;->allDrawnExcludingSaved:Z
    ...
    iput-boolean v9, p0, Lcom/android/server/wm/WindowState;->mAppDied:Z

    invoke-virtual {p0}, Lcom/android/server/wm/WindowState;->setDisplayLayoutNeeded()V

    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mService:Lcom/android/server/wm/WindowManagerService;

    iget-object v9, v9, Lcom/android/server/wm/WindowManagerService;->mWindowPlacerLocked:Lcom/android/server/wm/WindowSurfacePlacer;

    invoke-virtual {v9}, Lcom/android/server/wm/WindowSurfacePlacer;->performSurfacePlacement()V

    const/4 v9, 0x0

    invoke-virtual {p0, v9}, Lcom/android/server/wm/WindowState;->openInputChannel(Landroid/view/InputChannel;)V
    ...
    iget-boolean v9, v9, Lcom/android/server/wm/AppWindowToken;->hidden:Z

    if-eqz v9, :cond_15

    iget-object v9, p0, Lcom/android/server/wm/WindowState;->mWinAnimator:Lcom/android/server/wm/WindowStateAnimator;

    iget-object v9, v9, Lcom/android/server/wm/WindowStateAnimator;->mAppAnimator:Lcom/android/server/wm/AppWindowAnimator;
    ...
    iget-boolean v9, v9, Lcom/android/server/wm/AppWindowAnimator;->animating:Z
    ...
    invoke-virtual {v9, p0, v6}, Lcom/android/server/wm/AccessibilityController;->onWindowTransitionLocked(Lcom/android/server/wm/WindowState;I)V
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/WindowStateAnimator;->isDummyAnimation()Z
    ...
    invoke-virtual {v9, p0}, Lcom/android/server/wm/AppWindowToken;->isLastWindow(Lcom/android/server/wm/WindowState;)Z
    ...
    invoke-virtual {v9, v6, v10}, Lcom/android/server/wm/WindowStateAnimator;->applyAnimationLocked(IZ)Z
    ...
    invoke-virtual {v9}, Lcom/android/server/wm/DisplayContent;->getLastOrientation()I

    move-result v9

    iget-object v10, p0, Lcom/android/server/wm/WindowState;->mAttrs:Landroid/view/WindowManager$LayoutParams;

    iget v10, v10, Landroid/view/WindowManager$LayoutParams;->screenOrientation:I
    ...
    invoke-virtual {v9, v10, v0}, Lcom/android/server/wm/WindowManagerService;->updateOrientationFromAppTokensLocked(ZI)Z
    ...
    invoke-virtual {v9, v11, v10}, Lcom/android/server/wm/WindowManagerService$H;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {v9, v10, v11}, Lcom/android/server/wm/WindowManagerService;->updateFocusedWindowLocked(IZ)Z
...
.method applyGravityAndUpdateFrame(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    iget-object v7, v0, Lcom/android/server/wm/WindowState;->mGravityAdjustedBounds:Landroid/graphics/Rect;
    ...
    iget-object v4, v0, Lcom/android/server/wm/WindowState;->mGravityAdjustedBounds:Landroid/graphics/Rect;
    ...
    iput-boolean v1, v0, Lcom/android/server/wm/WindowState;->mMovedToTopByIme:Z
    ...
    iget-boolean v1, v0, Lcom/android/server/wm/WindowState;->mMovedToTopByIme:Z
...
.method public computeFrameLw(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v3, v4}, Lcom/samsung/android/view/IWindowStateBridge;->reverseFrame(Landroid/graphics/Rect;)V
...
.method dispatchViewTransparencyEnabled(ZZ)V
    .locals 2

    :try_start_0
    iget-object v1, p0, Lcom/android/server/wm/WindowState;->mClient:Landroid/view/IWindow;

    invoke-interface {v1, p1, p2}, Landroid/view/IWindow;->viewTransparencyEnabled(ZZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getChatOverVideoModeEnabled()Z
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mBridge:Lcom/samsung/android/view/IWindowStateBridge;

    invoke-interface {v0}, Lcom/samsung/android/view/IWindowStateBridge;->getChatOverVideoModeEnabled()Z
...
.method getTouchableRegion(Landroid/graphics/Region;ILandroid/graphics/Region;)I
    ...
    iget-object v7, p0, Lcom/android/server/wm/WindowState;->mBridge:Lcom/samsung/android/view/IWindowStateBridge;

    invoke-interface {v7, v1}, Lcom/samsung/android/view/IWindowStateBridge;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v7, v8}, Landroid/graphics/Region;->translate(II)V
...
.method public getViewTransparencyEnabled()Z
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mBridge:Lcom/samsung/android/view/IWindowStateBridge;

    invoke-interface {v0}, Lcom/samsung/android/view/IWindowStateBridge;->getViewTransparencyEnabled()Z
...
.method synthetic lambda$-com_android_server_wm_WindowState_250313(Lcom/android/server/wm/WindowState;)Z
    .locals 2
...
.method setChatOverVideoModeEnabled(Z)Z
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mBridge:Lcom/samsung/android/view/IWindowStateBridge;

    invoke-interface {v0, p1}, Lcom/samsung/android/view/IWindowStateBridge;->setChatOverVideoModeEnabled(Z)Z
...
.method setViewTransparencyEnabled(ZZ)Z
    .locals 1

    iget-object v0, p0, Lcom/android/server/wm/WindowState;->mBridge:Lcom/samsung/android/view/IWindowStateBridge;

    invoke-interface {v0, p1, p2}, Lcom/samsung/android/view/IWindowStateBridge;->setViewTransparencyEnabled(ZZ)Z
...
.method updateResizingWindowIfNeeded()V
    ...
    iget-boolean v4, p0, Lcom/android/server/wm/WindowState;->mNextForceRelayoutToClient:Z
    ...
    const-string/jumbo v6, " mNextForceRelayoutToClient="
