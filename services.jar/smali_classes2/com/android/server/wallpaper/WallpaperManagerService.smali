...
.method static synthetic -wrap19(Lcom/android/server/wallpaper/WallpaperManagerService;ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V
    .locals 0
...
.method private initVideoWallpaper()V
    .locals 5
    ...
    iget-boolean v2, v1, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoDefaultHasBeenUsed:Z

    if-nez v2, :cond_0

    const/4 v2, 0x1

    iput-boolean v2, v1, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoDefaultHasBeenUsed:Z
    ...
    invoke-virtual {v2, v4, v3, v0}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private parseWallpaperAttributes(Lorg/xmlpull/v1/XmlPullParser;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;Z)V
    ...
    const-string/jumbo v2, "videoColor"

    invoke-interface {p1, v4, v2}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoColor:Ljava/lang/String;

    const-string/jumbo v2, "true"

    const-string/jumbo v3, "videoDefaultHasBeenUsed"
    ...
    iput-boolean v2, p2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoDefaultHasBeenUsed:Z
...
.method private parsingColor(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "platinum"
...
.method private rebindDefaultWallpaperIfNeeded()V
    ...
    sget-object v9, Landroid/app/WallpaperManager;->WPAPER_VALUE_DEFAULT_WALLPAPER:Ljava/lang/String;
    ...
    const-string/jumbo v10, "rebind CMF ImageWallpaper color: "

    invoke-virtual {v9, v10}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v9

    sget-object v10, Lcom/android/server/wallpaper/WallpaperManagerService;->mDeviceColor:Ljava/lang/String;
    ...
    iget v0, v7, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->kwpType:I
    ...
    sget-object v6, Lcom/android/server/wallpaper/WallpaperManagerService;->mDeviceColor:Ljava/lang/String;
    ...
    invoke-virtual {v0, v5, v2, v6}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v10, "rebind CMF InfinityWallpaper color : "
    ...
    iget-object v8, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->wallpaperComponent:Landroid/content/ComponentName;
...
.method private writeWallpaperAttributes(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)V
    ...
    const-string/jumbo v0, "videoColor"

    iget-object v1, p3, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoColor:Ljava/lang/String;

    invoke-interface {p1, v2, v0, v1}, Lorg/xmlpull/v1/XmlSerializer;->attribute(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lorg/xmlpull/v1/XmlSerializer;

    const-string/jumbo v1, "videoDefaultHasBeenUsed"

    iget-boolean v0, p3, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoDefaultHasBeenUsed:Z
...
.method public backupLockWallpaper()V
    ...
    const-string/jumbo v7, "backupLockWallpaper userId="
    ...
    invoke-static {v5, v6, v8, v3}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string/jumbo v7, "kwpSettingValue = "
    ...
    iput-boolean v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsDefaultLockWallpaper:Z
    ...
    const-string/jumbo v7, ", mIsDefaultLockWallpaper = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-boolean v7, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsDefaultLockWallpaper:Z
    ...
    iget-boolean v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsDefaultLockWallpaper:Z
    ...
    const-string/jumbo v7, "Video wallpaper, not KWP_TYPE_DEFAULT"

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, v1, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->kwpType:I
    ...
    invoke-direct {p0, v3, v4}, Lcom/android/server/wallpaper/WallpaperManagerService;->getBackupKWPData(ILcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;

    move-result-object v0

    if-eqz v0, :cond_2

    iget-object v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mBackupLockWallpaperMap:Landroid/util/SparseArray;
    ...
    const-string/jumbo v6, "Failed lock wallpaper backup."
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "  videoColor="

    invoke-virtual {p2, v3}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-object v3, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoColor:Ljava/lang/String;
    ...
    iget-boolean v3, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoDefaultHasBeenUsed:Z
...
.method public getVideoColor()Ljava/lang/String;
    ...
    iget-object v0, v2, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoColor:Ljava/lang/String;
    ...
    const-string/jumbo v4, "getVideoColor userId="
    ...
    const-string/jumbo v4, " videoColor="
    ...
    const-string/jumbo v3, "Lock wallpaper data is null. So videoColor is null"
...
.method public getVideoThumbnailFileDescriptor(II)Landroid/os/ParcelFileDescriptor;
    .locals 8
...
.method notifyLockWallpaperChanged(I)V
    ...
    iget v5, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mCurrentPersonaId:I

    if-eq v4, v5, :cond_1

    const/4 v4, 0x1

    iput-boolean v4, p0, Lcom/android/server/wallpaper/WallpaperManagerService;->mIsUpdateForcedForPersona:Z
...
.method public setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-direct {p0, p5, v1}, Lcom/android/server/wallpaper/WallpaperManagerService;->getWallpaperSafeLocked(II)Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;
    ...
    iput-object p4, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->callingPackage:Ljava/lang/String;

    iput-object p3, v0, Lcom/android/server/wallpaper/WallpaperManagerService$WallpaperData;->videoColor:Ljava/lang/String;

    invoke-direct {p0, p5}, Lcom/android/server/wallpaper/WallpaperManagerService;->cleanUpKWPFiles(I)V

    invoke-direct {p0, p5}, Lcom/android/server/wallpaper/WallpaperManagerService;->saveSettingsLocked(I)V
...
.method switchUser(ILandroid/os/IRemoteCallback;)V
    ...
    invoke-direct {p0}, Lcom/android/server/wallpaper/WallpaperManagerService;->initVideoWallpaper()V
