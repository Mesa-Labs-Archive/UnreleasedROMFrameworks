...
.field private final mSimMobilityStatusListeners:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
# direct methods
.method static synthetic -get0(Lcom/sec/ims/ImsManager;)I
    .locals 1
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/sec/ims/ImsManager;->mSimMobilityStatusListeners:Ljava/util/List;
...
.method private onConnectService(Lcom/sec/ims/IImsService;)V
    ...
    :try_start_0
    invoke-interface {p1}, Lcom/sec/ims/IImsService;->getPhoneCount()I
    ...
    const-string/jumbo v4, "Invalid phoneId: "
    ...
    const-string/jumbo v4, ", phoneCount:"
    ...
    invoke-interface {v2}, Lcom/sec/ims/ImsManager$ConnectionListener;->onDisconnected()V
    ...
    invoke-direct {p0, v2}, Lcom/sec/ims/ImsManager;->registerPreviousListeners(Lcom/sec/ims/IImsService;)V
    :try_end_0
    ...
    iget-object v4, p0, Lcom/sec/ims/ImsManager;->mListener:Lcom/sec/ims/ImsManager$ConnectionListener;
...
.method private registerPreviousListeners(Lcom/sec/ims/IImsService;)V
    ...
    :try_start_0
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mRegListeners:Ljava/util/List;
    ...
    invoke-interface {p1, v3, v9}, Lcom/sec/ims/IImsService;->registerImsRegistrationListenerForSlot(Lcom/sec/ims/IImsRegistrationListener;I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_1
    :try_start_2
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mDialogListeners:Ljava/util/List;
    ...
    invoke-interface {p1, v9, v2}, Lcom/sec/ims/IImsService;->registerDialogEventListener(ILcom/sec/ims/IDialogEventListener;)V
    :try_end_2
    ...
    :cond_2
    :try_start_3
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mVideoListeners:Ljava/util/List;
    ...
    check-cast v7, Lcom/sec/ims/volte2/IImsVideoListener;

    iget v9, p0, Lcom/sec/ims/ImsManager;->mPhoneId:I

    invoke-interface {p1, v9, v7}, Lcom/sec/ims/IImsService;->registerVideoListener(ILcom/sec/ims/volte2/IImsVideoListener;)V

    goto :goto_2

    :cond_3
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mImSessionListeners:Ljava/util/List;
    ...
    check-cast v6, Lcom/sec/ims/im/IImSessionListener;

    invoke-interface {p1, v6}, Lcom/sec/ims/IImsService;->registerImSessionListener(Lcom/sec/ims/im/IImSessionListener;)V

    goto :goto_3

    :cond_4
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mOngoingFtEventListeners:Ljava/util/List;
    ...
    check-cast v5, Lcom/sec/ims/ft/IImsOngoingFtEventListener;

    invoke-interface {p1, v5}, Lcom/sec/ims/IImsService;->registerImsOngoingFtListener(Lcom/sec/ims/ft/IImsOngoingFtEventListener;)V

    goto :goto_4

    :cond_5
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mAutoConfigurationListener:Ljava/util/List;
    ...
    invoke-interface {p1, v1, v9}, Lcom/sec/ims/IImsService;->registerAutoConfigurationListener(Lcom/sec/ims/IAutoConfigurationListener;I)V

    goto :goto_5

    :cond_6
    iget-object v9, p0, Lcom/sec/ims/ImsManager;->mSimMobilityStatusListeners:Ljava/util/List;
    ...
    check-cast v4, Lcom/sec/ims/ISimMobilityStatusListener;

    iget v9, p0, Lcom/sec/ims/ImsManager;->mPhoneId:I

    invoke-interface {p1, v4, v9}, Lcom/sec/ims/IImsService;->registerSimMobilityStatusListenerByPhoneId(Lcom/sec/ims/ISimMobilityStatusListener;I)V
    :try_end_3
...
.method public connectService()V
    ...
    invoke-direct {p0, v1}, Lcom/sec/ims/ImsManager;->onConnectService(Lcom/sec/ims/IImsService;)V
...
.method public declared-synchronized registerSimMobilityStatusListener(Lcom/sec/ims/ISimMobilityStatusListener;)V
    ...
    const-string/jumbo v2, "registerSimMobilityStatusListener"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v1, p0, Lcom/sec/ims/ImsManager;->mSimMobilityStatusListeners:Ljava/util/List;
...
.method public declared-synchronized registerSimMobilityStatusListener(Lcom/sec/ims/ISimMobilityStatusListener;I)V
    ...
    iget-object v2, p0, Lcom/sec/ims/ImsManager;->mSimMobilityStatusListeners:Ljava/util/List;
    ...
    :cond_0
    :try_start_1
    invoke-interface {v1, p1, p2}, Lcom/sec/ims/IImsService;->registerSimMobilityStatusListenerByPhoneId(Lcom/sec/ims/ISimMobilityStatusListener;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized unregisterSimMobilityStatusListener(Lcom/sec/ims/ISimMobilityStatusListener;)V
    ...
    const-string/jumbo v2, "unregisterSimMobilityStatusListener"
...
.method public declared-synchronized unregisterSimMobilityStatusListener(Lcom/sec/ims/ISimMobilityStatusListener;I)V
    ...
    :cond_0
    :try_start_1
    invoke-interface {v1, p1, p2}, Lcom/sec/ims/IImsService;->unregisterSimMobilityStatusListenerByPhoneId(Lcom/sec/ims/ISimMobilityStatusListener;I)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
