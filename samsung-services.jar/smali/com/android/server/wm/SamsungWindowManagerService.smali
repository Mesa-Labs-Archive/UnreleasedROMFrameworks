...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mAspectRatioCtr:Lcom/android/server/wm/AspectRatioController;
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_58042([Lcom/android/server/wm/WindowState;Lcom/android/server/wm/WindowState;)Z
    .locals 3
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_61165(ILjava/lang/Boolean;Lcom/android/server/wm/WindowState;)V
    .locals 2
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_67100(Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/WindowState;)V
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_67376(Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/WindowState;)V
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_67587(Lcom/android/server/wm/DisplayContent;Lcom/android/server/wm/WindowState;)Z
    .locals 1
...
.method static synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_82475(ZLcom/android/server/wm/WindowState;)V
    .locals 2
...
.method private shouldBeRedirected(Landroid/view/WindowManager$LayoutParams;)Z
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/server/wm/SamsungWindowManagerService;->isVRSVCWindow(Landroid/view/WindowManager$LayoutParams;)Z
...
.method public getCustomMaxAspectRatio(Ljava/lang/String;F)F
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/AspectRatioController;->getCustomMaxAspectRatio(Ljava/lang/String;F)F
...
.method public getVSFocusedWindow()Lcom/android/server/wm/WindowState;
    ...
    invoke-virtual {p0, v3}, Lcom/android/server/wm/SamsungWindowManagerService;->isVRSVCWindow(Landroid/view/WindowManager$LayoutParams;)Z
...
.method public hideChangeRatioButton()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/AspectRatioController;->hideChangeRatioButtonWindow()V
...
.method public init(Lcom/android/server/wm/WindowManagerService;Landroid/content/Context;)V
    ...
    iget-object v1, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mAspectRatioCtr:Lcom/android/server/wm/AspectRatioController;

    invoke-virtual {v1, p0}, Lcom/android/server/wm/AspectRatioController;->init(Lcom/android/server/wm/SamsungWindowManagerService;)V
    ...
    const-string/jumbo v1, "CHNLowEnd"
...
.method public isMaxAspectComponentEx(Landroid/content/ComponentName;I)I
    ...
    iget-object v3, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mAspectRatioCtr:Lcom/android/server/wm/AspectRatioController;

    invoke-virtual {v3, v0}, Lcom/android/server/wm/AspectRatioController;->isMaxAspectComponent(Landroid/content/pm/ActivityInfo;)I
    ...
    invoke-virtual {v3, v1}, Lcom/android/server/wm/AspectRatioController;->isMaxAspectPackage(Landroid/content/pm/ApplicationInfo;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isMaxAspectPackage(Ljava/lang/String;I)Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/wm/AspectRatioController;->isMaxAspectPackage(Ljava/lang/String;I)Z
...
.method public isMaxAspectPackageEx(Ljava/lang/String;I)I
    ...
    iget-object v2, p0, Lcom/android/server/wm/SamsungWindowManagerService;->mAspectRatioCtr:Lcom/android/server/wm/AspectRatioController;

    invoke-virtual {v2, v0}, Lcom/android/server/wm/AspectRatioController;->isMaxAspectPackage(Landroid/content/pm/ApplicationInfo;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isVRSVCWindow(Landroid/view/WindowManager$LayoutParams;)Z
    .locals 2
...
.method synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_51424(Landroid/graphics/Rect;Lcom/android/server/wm/WindowState;)Z
    .locals 5
...
.method synthetic lambda$-com_android_server_wm_SamsungWindowManagerService_75067(Lcom/android/server/wm/WindowState;)V
    .locals 3
    ...
    invoke-interface {v1, v0}, Lcom/samsung/android/view/IWindowStateBridge;->getCustomAspectRatioFrame(Landroid/graphics/Rect;)V
...
.method public saveAllMaxAspectPackages()V
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/AspectRatioController;->saveAllAspectRatioPackageMaps()V
...
.method public setMaxAspectPackages(Ljava/util/List;[IZ)V
    ...
    invoke-virtual {v0, p1, p2, p3, v1}, Lcom/android/server/wm/AspectRatioController;->setMaxAspectPackages(Ljava/util/List;[IZZ)V
...
.method public showChangeRatioButton(IILjava/lang/String;I)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/server/wm/AspectRatioController;->showChangeRatioButtonWindow(IILjava/lang/String;I)V
...
.method public updateOrientation(I)V
    ...
    invoke-virtual {v0, v2, p1}, Lcom/android/server/wm/WindowManagerService;->updateOrientationFromAppTokensLocked(ZI)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
