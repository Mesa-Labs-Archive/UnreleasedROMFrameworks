...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z

    iput-boolean v0, p0, Lcom/android/server/wm/SamsungWindowState;->mViewTransparencyEnabled:Z
...
.method private handleChatOverVideoModeChnaged()V
    .locals 2

    const/4 v1, 0x1

    iget-boolean v0, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z

    if-eqz v0, :cond_2

    iget-boolean v0, p0, Lcom/android/server/wm/SamsungWindowState;->mViewTransparencyEnabled:Z

    if-eqz v0, :cond_1

    const-string/jumbo v0, "ChatOverVideo-SWS"

    const-string/jumbo v1, "handleChatOverVideoModeChnaged oops this must not happen"
    ...
    invoke-virtual {v0}, Lcom/android/server/wm/WindowState;->inFreeformWorkspace()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v1, v1}, Lcom/android/server/wm/SamsungWindowState;->setViewTransparencyEnabled(ZZ)Z
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/server/wm/SamsungWindowState;->setViewTransparencyEnabled(ZZ)Z

    goto :goto_0
.end method

.method private handleViewTransparencyChnaged(Z)V
    .locals 2

    iget-object v0, p0, Lcom/android/server/wm/SamsungWindowState;->mWin:Lcom/android/server/wm/WindowState;

    iget-boolean v1, p0, Lcom/android/server/wm/SamsungWindowState;->mViewTransparencyEnabled:Z

    invoke-virtual {v0, v1, p1}, Lcom/android/server/wm/WindowState;->dispatchViewTransparencyEnabled(ZZ)V

    return-void
.end method

.method static synthetic lambda$-com_android_server_wm_SamsungWindowState_5567(Lcom/android/server/wm/WindowState;)Z
    .locals 2
...
.method private setViewTransparencyEnabled(Z)Z
    .locals 1

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lcom/android/server/wm/SamsungWindowState;->setViewTransparencyEnabled(ZZ)Z
...
.method public dump(Ljava/lang/String;Ljava/io/PrintWriter;)V
    ...
    iget-boolean v2, p0, Lcom/android/server/wm/SamsungWindowState;->mHideBySViewCover:Z
    ...
    :cond_2
    const-string/jumbo v2, " AspectRatioFrame="
    ...
    const-string/jumbo v2, "mChatOverVideoModeEnabled="

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v2, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->println(Z)V

    invoke-virtual {p2, p1}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    const-string/jumbo v2, "mViewTransparencyEnabled="

    invoke-virtual {p2, v2}, Ljava/io/PrintWriter;->print(Ljava/lang/String;)V

    iget-boolean v2, p0, Lcom/android/server/wm/SamsungWindowState;->mViewTransparencyEnabled:Z
...
.method public setChatOverVideoModeEnabled(Z)Z
    .locals 1
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z

    invoke-direct {p0}, Lcom/android/server/wm/SamsungWindowState;->handleChatOverVideoModeChnaged()V
...
.method public setOwner(Ljava/lang/Object;)V
    ...
    const-string/jumbo v2, "SamsungWindowState already has a WindowState."
    ...
    const-string/jumbo v2, "owner is not a WindowState"
    ...
    invoke-virtual {v1, v2}, Lcom/android/server/wm/WindowManagerService;->isChatOverVideoModeEnabled(Ljava/lang/String;)Z

    move-result v1

    iput-boolean v1, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z
    ...
    iget-boolean v1, p0, Lcom/android/server/wm/SamsungWindowState;->mChatOverVideoModeEnabled:Z
    ...
    invoke-direct {p0, v1}, Lcom/android/server/wm/SamsungWindowState;->setViewTransparencyEnabled(Z)Z
...
.method public setViewTransparencyEnabled(ZZ)Z
    ...
    iput-boolean p1, p0, Lcom/android/server/wm/SamsungWindowState;->mViewTransparencyEnabled:Z

    invoke-direct {p0, p2}, Lcom/android/server/wm/SamsungWindowState;->handleViewTransparencyChnaged(Z)V
