...
.method public getDebugInfo()Landroid/hidl/base/V1_0/DebugInfo;
    ...
    :try_start_0
    iget-object v3, p0, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$Proxy;->mRemote:Landroid/os/IHwBinder;
...
.method public getHashChain()Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$Proxy;->mRemote:Landroid/os/IHwBinder;
...
.method public getInterface(Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$IfaceInfo;Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$getInterfaceCallback;)V
    ...
    const-string/jumbo v4, "android.hardware.wifi.supplicant@1.0::ISupplicant"

    invoke-virtual {v3, v4}, Landroid/os/HwParcel;->writeInterfaceToken(Ljava/lang/String;)V

    invoke-virtual {p1, v3}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$IfaceInfo;->writeToParcel(Landroid/os/HwParcel;)V
    ...
    :try_start_0
    iget-object v4, p0, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$Proxy;->mRemote:Landroid/os/IHwBinder;
    ...
    invoke-static {v4}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantIface;->asInterface(Landroid/os/IHwBinder;)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantIface;

    move-result-object v0

    invoke-interface {p2, v1, v0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$getInterfaceCallback;->onValues(Landroid/hardware/wifi/supplicant/V1_0/SupplicantStatus;Landroid/hardware/wifi/supplicant/V1_0/ISupplicantIface;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public listInterfaces(Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$listInterfacesCallback;)V
    ...
    invoke-static {v2}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$IfaceInfo;->readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;

    move-result-object v0

    invoke-interface {p1, v1, v0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicant$listInterfacesCallback;->onValues(Landroid/hardware/wifi/supplicant/V1_0/SupplicantStatus;Ljava/util/ArrayList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setDebugParams(IZZ)Landroid/hardware/wifi/supplicant/V1_0/SupplicantStatus;
    ...
    invoke-virtual {v2, p3}, Landroid/os/HwParcel;->writeBool(Z)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, "[class or subclass of android.hardware.wifi.supplicant@1.0::ISupplicant]@Proxy"
