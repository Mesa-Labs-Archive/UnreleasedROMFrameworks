...
.method public static asInterface(Landroid/os/IHwBinder;)Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface;
    ...
    :cond_0
    const-string/jumbo v5, "android.hardware.wifi.supplicant@1.0::ISupplicantStaIface"
    ...
    instance-of v5, v3, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface;

    if-eqz v5, :cond_1

    check-cast v3, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface;

    return-object v3

    :cond_1
    new-instance v4, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface$Proxy;

    invoke-direct {v4, p0}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface$Proxy;-><init>(Landroid/os/IHwBinder;)V

    :try_start_0
    invoke-interface {v4}, Landroid/hardware/wifi/supplicant/V1_0/ISupplicantStaIface;->interfaceChain()Ljava/util/ArrayList;
