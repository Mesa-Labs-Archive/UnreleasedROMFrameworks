...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;-><init>()V

    mul-int/lit8 v1, v9, 0x38

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;

    iget v1, p0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->securityType:I

    iget v2, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->securityType:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->cipherType:I
    ...
    iget-object v2, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->pmk:[B
    ...
    iget-object v2, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->passphrase:Ljava/util/ArrayList;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->securityType:I
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->cipherType:I
    ...
    iget-object v3, v0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->pmk:[B
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ", .cipherType = "
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    iget v8, p0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->securityType:I
    ...
    iget v8, p0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->cipherType:I
    ...
    :cond_0
    iget-object v6, p0, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->passphrase:Ljava/util/ArrayList;
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanDataPathSecurityConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
