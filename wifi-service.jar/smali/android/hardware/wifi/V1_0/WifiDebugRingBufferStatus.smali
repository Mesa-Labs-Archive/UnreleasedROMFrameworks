...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;-><init>()V

    mul-int/lit8 v1, v9, 0x28

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;

    iget-object v1, p0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->ringName:Ljava/lang/String;

    iget-object v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->ringName:Ljava/lang/String;
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->flags:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->ringId:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->sizeInBytes:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->freeSizeInBytes:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->verboseLevel:I
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iget-object v0, p0, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->ringName:Ljava/lang/String;
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ".ringName = "
    ...
    const-string/jumbo v1, ", .sizeInBytes = "
    ...
    const-string/jumbo v1, ", .freeSizeInBytes = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/WifiDebugRingBufferStatus;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
