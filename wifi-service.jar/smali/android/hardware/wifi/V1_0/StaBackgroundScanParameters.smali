...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;-><init>()V

    mul-int/lit8 v1, v9, 0x20

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;

    iget v1, p0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->basePeriodInMs:I

    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->basePeriodInMs:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->maxApPerScan:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->reportThresholdPercent:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->reportThresholdNumScans:I
    ...
    iget-object v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->buckets:Ljava/util/ArrayList;
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->basePeriodInMs:I
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->maxApPerScan:I
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->reportThresholdPercent:I
    ...
    iput v3, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->reportThresholdNumScans:I
    ...
    invoke-virtual {v11, v0, v13, v4, v5}, Landroid/hardware/wifi/V1_0/StaBackgroundScanBucketParameters;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ".basePeriodInMs = "
    ...
    const-string/jumbo v1, ", .maxApPerScan = "
    ...
    const-string/jumbo v1, ", .reportThresholdPercent = "
    ...
    const-string/jumbo v1, ", .reportThresholdNumScans = "
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    check-cast v3, Landroid/hardware/wifi/V1_0/StaBackgroundScanBucketParameters;

    mul-int/lit8 v4, v0, 0x30

    int-to-long v4, v4

    invoke-virtual {v3, v2, v4, v5}, Landroid/hardware/wifi/V1_0/StaBackgroundScanBucketParameters;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanParameters;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
