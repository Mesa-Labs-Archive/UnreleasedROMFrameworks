...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;-><init>()V

    mul-int/lit8 v1, v9, 0x8

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;

    iget-byte v1, p0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->rssiClose:B

    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->rssiClose:B
    ...
    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->rssiMiddle:B
    ...
    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->rssiCloseProximity:B
    ...
    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->dwellTimeMs:B
    ...
    iget-short v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->scanPeriodSec:S
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->validDiscoveryWindowIntervalVal:Z
    ...
    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->discoveryWindowIntervalVal:B
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ".rssiClose = "
    ...
    const-string/jumbo v1, ", .rssiMiddle = "
    ...
    const-string/jumbo v1, ", .rssiCloseProximity = "
    ...
    const-string/jumbo v1, ", .dwellTimeMs = "
    ...
    const-string/jumbo v1, ", .scanPeriodSec = "
    ...
    const-string/jumbo v1, ", .validDiscoveryWindowIntervalVal = "
    ...
    const-string/jumbo v1, ", .discoveryWindowIntervalVal = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanBandSpecificConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
