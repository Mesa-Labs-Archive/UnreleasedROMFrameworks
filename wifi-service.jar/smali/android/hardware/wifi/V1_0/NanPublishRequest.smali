...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/NanPublishRequest;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/NanPublishRequest;-><init>()V

    mul-int/lit16 v1, v9, 0xc0

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/NanPublishRequest;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/NanPublishRequest;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/NanPublishRequest;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/NanPublishRequest;
    ...
    iget-object v2, v0, Landroid/hardware/wifi/V1_0/NanPublishRequest;->baseConfigs:Landroid/hardware/wifi/V1_0/NanDiscoveryCommonConfig;
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/NanPublishRequest;->publishType:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/NanPublishRequest;->txType:I
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/NanPublishRequest;->autoAcceptDataPathRequests:Z
...
.method public final readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, p2, v2, v3}, Landroid/hardware/wifi/V1_0/NanDiscoveryCommonConfig;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanPublishRequest;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ", .autoAcceptDataPathRequests = "
...
.method public final writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
    ...
    invoke-virtual {v0, p1, v2, v3}, Landroid/hardware/wifi/V1_0/NanDiscoveryCommonConfig;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/NanPublishRequest;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
