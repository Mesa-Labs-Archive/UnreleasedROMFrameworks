...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;-><init>()V

    mul-int/lit8 v1, v9, 0x10

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;

    iget v1, p0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->maxCacheSize:I

    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->maxCacheSize:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->maxBuckets:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->maxApCachePerScan:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->maxReportingThreshold:I
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ", .maxBuckets = "
    ...
    const-string/jumbo v1, ", .maxApCachePerScan = "
    ...
    const-string/jumbo v1, ", .maxReportingThreshold = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/StaBackgroundScanCapabilities;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
