...
.method public static final readVectorFromParcel(Landroid/os/HwParcel;)Ljava/util/ArrayList;
    ...
    new-instance v11, Landroid/hardware/wifi/V1_0/RttCapabilities;

    invoke-direct {v11}, Landroid/hardware/wifi/V1_0/RttCapabilities;-><init>()V

    mul-int/lit8 v1, v9, 0x14

    int-to-long v2, v1

    invoke-virtual {v11, p0, v13, v2, v3}, Landroid/hardware/wifi/V1_0/RttCapabilities;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public static final writeVectorToParcel(Landroid/os/HwParcel;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v4, v3, v6, v7}, Landroid/hardware/wifi/V1_0/RttCapabilities;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    const-class v2, Landroid/hardware/wifi/V1_0/RttCapabilities;
    ...
    check-cast v0, Landroid/hardware/wifi/V1_0/RttCapabilities;

    iget-boolean v1, p0, Landroid/hardware/wifi/V1_0/RttCapabilities;->rttOneSidedSupported:Z

    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->rttOneSidedSupported:Z
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->rttFtmSupported:Z
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->lciSupported:Z
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->lcrSupported:Z
    ...
    iget-boolean v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->responderSupported:Z
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->preambleSupport:I
    ...
    iget v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->bwSupport:I
    ...
    iget-byte v2, v0, Landroid/hardware/wifi/V1_0/RttCapabilities;->mcVersion:B
...
.method public final readFromParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/hardware/wifi/V1_0/RttCapabilities;->readEmbeddedFromParcel(Landroid/os/HwParcel;Landroid/os/HwBlob;J)V
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ".rttOneSidedSupported = "
    ...
    const-string/jumbo v1, ", .rttFtmSupported = "
    ...
    const-string/jumbo v1, ", .lciSupported = "
    ...
    const-string/jumbo v1, ", .lcrSupported = "
    ...
    const-string/jumbo v1, ", .responderSupported = "
    ...
    const-string/jumbo v1, ", .preambleSupport = "
    ...
    const-string/jumbo v1, ", .bwSupport = "
    ...
    const-string/jumbo v1, ", .mcVersion = "
...
.method public final writeToParcel(Landroid/os/HwParcel;)V
    ...
    invoke-virtual {p0, v0, v2, v3}, Landroid/hardware/wifi/V1_0/RttCapabilities;->writeEmbeddedToBlob(Landroid/os/HwBlob;J)V
