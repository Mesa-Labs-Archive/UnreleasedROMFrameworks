...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/samsung/android/server/wifi/SensorMonitor$1;,
        Lcom/samsung/android/server/wifi/SensorMonitor$2;
    }
.end annotation
...
.method static synthetic -wrap0(Lcom/samsung/android/server/wifi/SensorMonitor;Z)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiNative;)V
    ...
    const-string/jumbo v3, "wifi_sensor_monitor_enable"
    ...
    const-string/jumbo v2, "Wifi-SensorMonitor"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "create sensor monitor with "
    ...
    const-string/jumbo v1, "enabled state"
    ...
    :cond_2
    const-string/jumbo v1, "disabled state"
...
.method private checkCurrentConnectionState()Z
    ...
    iget-object v3, p0, Lcom/samsung/android/server/wifi/SensorMonitor;->mConnectionType:[Z
...
.method private enablePowerBackoff(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/wifi/WifiNative;->setTxPowerBackOff(Z)Z
...
.method private startMonitor(Z)V
    ...
    const-string/jumbo v0, "Wifi-SensorMonitor"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v2, "enable sensor monitoring : "
...
.method public enableMonitor(Z)V
    ...
    const-string/jumbo v2, "wifi_sensor_monitor_enable"
...
.method public updateConnection(IZ)V
    ...
    :cond_2
    invoke-direct {p0, v1}, Lcom/samsung/android/server/wifi/SensorMonitor;->startMonitor(Z)V
