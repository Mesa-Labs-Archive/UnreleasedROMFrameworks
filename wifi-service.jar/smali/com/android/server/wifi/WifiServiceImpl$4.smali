...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/android/server/wifi/WifiServiceImpl$4;->this$0:Lcom/android/server/wifi/WifiServiceImpl;
    ...
    const-string/jumbo v5, "chameleon_tethereddata"

    invoke-static {v4, v5}, Landroid/provider/Settings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I

    move-result v4

    invoke-static {v3, v4}, Lcom/android/server/wifi/WifiServiceImpl;->-set8(Lcom/android/server/wifi/WifiServiceImpl;I)I
    ...
    const-string/jumbo v5, "Boot_completed, mTetheredData = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-object v5, p0, Lcom/android/server/wifi/WifiServiceImpl$4;->this$0:Lcom/android/server/wifi/WifiServiceImpl;

    invoke-static {v5}, Lcom/android/server/wifi/WifiServiceImpl;->-get13(Lcom/android/server/wifi/WifiServiceImpl;)I
    ...
    const-string/jumbo v4, "Settings.SettingNotFoundException for CHAMELEON_TETHEREDDATA"
    ...
    invoke-static {v3}, Lcom/android/server/wifi/WifiServiceImpl;->-get5(Lcom/android/server/wifi/WifiServiceImpl;)Landroid/content/Context;
    ...
    const-string/jumbo v4, "chameleon_tethereddata"
    ...
    invoke-virtual {v3}, Lcom/android/server/wifi/WifiServiceImpl;->stopSoftAp()Z
