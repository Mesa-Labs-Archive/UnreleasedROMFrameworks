...
.method public getHashMapFromDB()Ljava/util/HashMap;
    ...
    :try_start_2
    const-string/jumbo v2, "WWSMPatcher/SCPM"
    ...
    :cond_4
    :try_start_3
    const-string/jumbo v2, "content://com.samsung.android.sm.policy/policy_item/wwsmpatcher"
...
.method public getHashMapFromFile()Ljava/util/HashMap;
    ...
    const-string/jumbo v0, "/data/misc/wifi/.scpm_wwsmpatch"
...
.method public updateFile()I
    ...
    iget-object v1, p0, Lcom/android/server/wifi/WWSMPatcher$SamsungCommonPolicyManager;->mLoadedStringFromDB:Ljava/lang/String;

    invoke-static {v0, v1}, Lcom/android/server/wifi/WWSMPatcher$Util;->saveDataToFile(Ljava/lang/String;Ljava/lang/String;)I

    move-result v0

    if-ne v0, v2, :cond_0

    const-string/jumbo v0, "WWSMPatcher/SCPM"

    const-string/jumbo v1, "sdtf failed"
