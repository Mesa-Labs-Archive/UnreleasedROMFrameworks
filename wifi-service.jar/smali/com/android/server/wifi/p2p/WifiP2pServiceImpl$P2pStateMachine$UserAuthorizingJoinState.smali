...
.method public enter()V
    ...
    invoke-static {v0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->-get7(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Z
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    invoke-static {v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->-get31(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/app/AlertDialog;
    ...
    invoke-static {v1}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->-get66(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/os/CountDownTimer;
    ...
    invoke-static {v1, v4}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->-set20(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Landroid/app/AlertDialog;)Landroid/app/AlertDialog;

    :cond_0
    iget-object v1, p0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$UserAuthorizingJoinState;->this$1:Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;

    invoke-static {v1, v4}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->-set7(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    invoke-static {v2}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->-get3(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$GroupCreatedState;
    ...
    const-string/jumbo v3, "Allowed device : "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$UserAuthorizingJoinState;->this$1:Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/wifi/p2p/WifiP2pNative;->startWpsPbc(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/wifi/p2p/WifiP2pNative;->startWpsPinKeypad(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/server/wifi/p2p/WifiP2pNative;->p2pInvite(Landroid/net/wifi/p2p/WifiP2pGroup;Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "Inviting device : "
    ...
    invoke-virtual {v1, v2, v6}, Landroid/net/wifi/p2p/WifiP2pDeviceList;->updateStatus(Ljava/lang/String;I)V
    ...
    const-string/jumbo v3, "Failed inviting device : "
    ...
    const-string/jumbo v2, "User rejected incoming request"
