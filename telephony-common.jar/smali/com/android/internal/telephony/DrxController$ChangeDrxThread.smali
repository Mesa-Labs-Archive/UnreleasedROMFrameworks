...
# static fields
.field private static final CHANGE_DRX_COMPLETE:I = 0x64
...
# direct methods
.method static synthetic -get0(Lcom/android/internal/telephony/DrxController$ChangeDrxThread;)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mResult:Z

    return v0
.end method

.method static synthetic -set0(Lcom/android/internal/telephony/DrxController$ChangeDrxThread;Z)Z
    .locals 0
...
.method static synthetic -set1(Lcom/android/internal/telephony/DrxController$ChangeDrxThread;Z)Z
    .locals 0
...
.method public constructor <init>(Lcom/android/internal/telephony/DrxController;)V
    ...
    iput-boolean v0, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mDone:Z

    iput-boolean v0, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mResult:Z
...
# virtual methods
.method declared-synchronized changeDRX(I)Z
    .locals 9
    ...
    :goto_0
    :try_start_0
    iget-object v5, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mHandler:Landroid/os/Handler;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {p0}, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->wait()V
    :try_end_1
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->this$0:Lcom/android/internal/telephony/DrxController;
    ...
    :goto_1
    :try_start_6
    iget-boolean v5, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mDone:Z
    :try_end_6
    ...
    const-string/jumbo v7, "Exception during changeDRX #2: "
    ...
    const-string/jumbo v7, "Exception during changeDRX #1: "
    ...
    iget-object v6, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->this$0:Lcom/android/internal/telephony/DrxController;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v8, "Exception during changeDRX #2: "
    ...
    const-string/jumbo v7, "done. changeDRX - cycle: "
    ...
    iget-boolean v7, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mResult:Z
    ...
    iget-boolean v5, p0, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->mResult:Z
    :try_end_d
...
.method public run()V
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/DrxController$ChangeDrxThread;->notifyAll()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
