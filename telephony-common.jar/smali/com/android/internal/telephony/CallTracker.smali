...
.field protected static final EVENT_EMERGENCY_SEARCH_RESULT:I = 0x66
...
.field protected static final EVENT_HYSTERESIS_DCN:I = 0x6a
...
.field protected static final EVENT_SWITCH_RESULT_LEGACYVOLTE:I = 0x69
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Lcom/android/internal/telephony/CallTracker;->mHasCsE911Call:Z
...
.method private compareGid1(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Z
    ...
    const-string/jumbo v3, "compareGid1 serviceGid is null, return true"
...
.method protected convertNumberIfNecessary(Lcom/android/internal/telephony/Phone;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v9, "dial_string_replace_string_array"

    invoke-virtual {v0, v9}, Landroid/os/PersistableBundle;->getStringArray(Ljava/lang/String;)[Ljava/lang/String;
    ...
    const-string/jumbo v9, "convertNumberIfNecessary convertMaps is null"
    ...
    const-string/jumbo v10, "convertNumberIfNecessary Roaming convertMaps.length "
    ...
    const-string/jumbo v10, " dialNumber.length() "
    ...
    const-string/jumbo v12, "convertNumberIfNecessary: "
    ...
    const-string/jumbo v9, "convertNumberIfNecessary: MDN starts with +"
    ...
    const-string/jumbo v9, "convertNumberIfNecessary: convert service number"

    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/CallTracker;->log(Ljava/lang/String;)V

    const/4 v9, 0x1

    iput-boolean v9, p0, Lcom/android/internal/telephony/CallTracker;->mNumberConverted:Z
...
.method protected getCallType(Lcom/android/internal/telephony/Call;)I
    ...
    const-string/jumbo v1, "getCallType(): callDetails is null. default to CALL_TYPE_VOICE."
...
.method public getFallbackConnFromHandoverConnections()Lcom/android/internal/telephony/Connection;
    .locals 6

    const/4 v2, 0x0

    iget-object v4, p0, Lcom/android/internal/telephony/CallTracker;->mHandoverConnections:Ljava/util/ArrayList;
    ...
    const-string/jumbo v5, "getPendingMoFromHandoverConnections - conn("
    ...
    iget-boolean v4, v0, Lcom/android/internal/telephony/Connection;->mIsFallback:Z
