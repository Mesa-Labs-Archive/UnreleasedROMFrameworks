...
.method private findAppDirectedSMSPackage(Ljava/lang/String;)Lcom/android/internal/telephony/AppDirectedSMS$MatchInfo;
    ...
    const-string/jumbo v11, "verizon.intent.action.DIRECTED_SMS_RECEIVED"
    ...
    :cond_0
    const-string/jumbo v11, "AppDirectedSMS"

    const-string/jumbo v12, "findAppDirectedSMSPackage| queryResult is null or size is zero"
    ...
    invoke-direct {v5, v11}, Lcom/android/internal/telephony/AppDirectedSMS$MatchInfo;-><init>(Lcom/android/internal/telephony/AppDirectedSMS$MatchInfo;)V
    ...
    const-string/jumbo v12, "findAppDirectedSMSPackage| ApplicationInfo NameNotFoundException"
    ...
    const-string/jumbo v12, "findAppDirectedSMSPackage| ReceiverInfo NameNotFoundException"
...
.method private findAppDirectedSMSPackageWithPrefix(Ljava/lang/String;)Landroid/content/ComponentName;
    ...
    const-string/jumbo v10, "verizon.intent.action.DIRECTED_SMS_RECEIVED"
    ...
    :cond_0
    const-string/jumbo v10, "AppDirectedSMS"

    const-string/jumbo v11, "queryResult is null or size is zero"
    ...
    invoke-direct {p0, v10}, Lcom/android/internal/telephony/AppDirectedSMS;->isVzwPermissionGranted(Ljava/lang/String;)Z
    ...
    :try_start_1
    invoke-virtual {v6, v2, v10}, Landroid/content/pm/PackageManager;->getReceiverInfo(Landroid/content/ComponentName;I)Landroid/content/pm/ActivityInfo;
    ...
    const-string/jumbo v12, "findAppDirectedSMSPackageWithPrefix| package is found from receiver!!![package]="
    ...
    const-string/jumbo v12, "findAppDirectedSMSPackageWithPrefix| package is found from application !!! [package]="
    ...
    const-string/jumbo v11, "findAppDirectedSMSPackageWithPrefix| ReceiverInfo NameNotFoundException"
    ...
    const-string/jumbo v11, "findAppDirectedSMSPackageWithPrefix| ApplicationInfo NameNotFoundException"
...
.method private isPackageVzwSmsAuthorized(Ljava/lang/String;)Z
    ...
    const-string/jumbo v2, "AppDirectedSMS"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v4, "isPackageVzwSmsAuthorized"
    ...
    :cond_2
    :goto_1
    const-string/jumbo v1, "AppDirectedSMS"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v3, "isPackageVzwSmsAuthorized result"
...
.method private isVzwPermissionGranted(Ljava/lang/String;)Z
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/AppDirectedSMS;->mcontext:Landroid/content/Context;
    ...
    const-string/jumbo v3, "AppDirectedSMS"

    const-string/jumbo v4, "isVzwPermissionGranted calling package NameNotFoundException"
    ...
    const-string/jumbo v4, "isVzwPermissionGranted returning false"
...
.method private matchesMetaData(Landroid/os/Bundle;Ljava/lang/String;)Z
    ...
    :cond_0
    const-string/jumbo v1, "com.verizon.directedAppSMS"
...
.method private setBestMatchResult(Ljava/lang/String;Lcom/android/internal/telephony/AppDirectedSMS$AppMessageInfo;)V
    ...
    const-string/jumbo v2, "setBestMatchResult| no component"
...
.method private setResult(Ljava/lang/String;Lcom/android/internal/telephony/AppDirectedSMS$AppMessageInfo;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "setResult| no component"
...
.method private startsWithMetaData(Landroid/os/Bundle;Ljava/lang/String;Landroid/content/ComponentName;Lcom/android/internal/telephony/AppDirectedSMS$MatchInfo;)V
    ...
    const-string/jumbo v2, "com.verizon.directedAppSMS"
    ...
    const-string/jumbo v4, "startsWithMetaData| match found [componentName]="
    ...
    const-string/jumbo v4, " [appPrefix]="
...
.method public checkIfAppDirSMS(Landroid/content/Context;Ljava/lang/String;)Lcom/android/internal/telephony/AppDirectedSMS$AppMessageInfo;
    ...
    const-string/jumbo v2, "checkIfAppDirSMS| BUA Message"

    invoke-static {v1, v2}, Landroid/util/secutil/Log;->secI(Ljava/lang/String;Ljava/lang/String;)I

    const-string/jumbo v1, "BUA-ADS"
    ...
    const-string/jumbo v2, "checkIfAppDirSMS| Not BUA"
