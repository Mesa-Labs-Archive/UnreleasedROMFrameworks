...
.field private static final EVENT_CARD_SWAPED:I = 0x64
...
.field private static final EVENT_SIM_GET_ATR_DONE:I = 0x65
...
.field private mSkipCardSwapDialog:Z
...
.method static synthetic -get2(Lcom/android/internal/telephony/uicc/UiccCard;)I
    .locals 1
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/internal/telephony/uicc/UiccCard;->dialog:Landroid/app/AlertDialog;
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCard;->LOG_TAG_ID:Ljava/lang/String;
    ...
    invoke-direct {v0, p0, v1}, Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;)V
    ...
    iput-boolean v2, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSkipCardSwapDialog:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/IccCardStatus;)V
    ...
    const-string/jumbo v1, "UiccCard"

    iput-object v1, p0, Lcom/android/internal/telephony/uicc/UiccCard;->LOG_TAG_ID:Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v4}, Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;)V
    ...
    const-string/jumbo v1, "com.samsung.intent.action.SIM_REMOVED"
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;Lcom/android/internal/telephony/uicc/IccCardStatus;I)V
    ...
    invoke-direct {v1, p0, v2}, Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;-><init>(Lcom/android/internal/telephony/uicc/UiccCard;Lcom/android/internal/telephony/uicc/UiccCard$UiccCardBroadcastReceiver;)V
    ...
    iput-boolean v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSkipCardSwapDialog:Z
    ...
    const-string/jumbo v2, "UiccCard"
    ...
    invoke-interface {v1, v2, v4, v3}, Lcom/android/internal/telephony/CommandsInterface;->registerForSimSwaped(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method private InitUiccCarrierPrivilegeRules()V
    ...
    const-string/jumbo v2, "Before privilege rules: "
...
.method private log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCard;->LOG_TAG_ID:Ljava/lang/String;
...
.method private onIccSwap(Z)V
    ...
    iget-boolean v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagInserted:Z

    if-eqz v4, :cond_3

    iput-boolean v8, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagInserted:Z

    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagRemoved:Z

    const-string/jumbo v4, "onIccSwap: ICC_CARD_STATE_CHANGED INSERTED"
    ...
    :cond_0
    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSkipCardSwapDialog:Z

    :cond_1
    if-eqz v2, :cond_8

    const-string/jumbo v4, "onIccSwap: isHotSwapSupported is true, don\'t prompt for rebooting"
    ...
    sput-object v10, Lcom/android/internal/telephony/uicc/UiccCard;->dialog:Landroid/app/AlertDialog;
    ...
    iget-boolean v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagRemoved:Z

    if-eqz v4, :cond_4

    iput-boolean v8, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagRemoved:Z

    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/UiccCard;->updateFlagInserted:Z

    const-string/jumbo v4, "onIccSwap: ICC_CARD_STATE_CHANGED REMOVED"
    ...
    const-string/jumbo v1, "IS_CTC"

    iget v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mPhoneId:I

    if-ne v4, v7, :cond_6

    const-string/jumbo v1, "IS_CTC2"
    ...
    :cond_7
    iget-boolean v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSkipCardSwapDialog:Z

    if-eqz v4, :cond_b

    const-string/jumbo v4, "do not display icc swap dialog here for tray pop up"

    invoke-direct {p0, v4}, Lcom/android/internal/telephony/uicc/UiccCard;->log(Ljava/lang/String;)V

    iput-boolean v8, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mSkipCardSwapDialog:Z

    return-void

    :cond_8
    const-string/jumbo v4, "onIccSwap: isHotSwapSupported is false, prompt for rebooting"
    ...
    const-string/jumbo v4, "onIccSwap: donot prompt because ctc auto rebooting by simcardmagner"
    ...
    const-string/jumbo v5, "CscFeature_RIL_BroadcastNoSIMnoti"
    ...
    iget-boolean v4, p0, Lcom/android/internal/telephony/uicc/UiccCard;->NoSimNotyFlag:Z

    if-nez v4, :cond_a

    new-instance v0, Landroid/content/Intent;

    const-string/jumbo v4, "com.samsung.intent.action.NO_SIM_NOTY"
    ...
    iput-boolean v7, p0, Lcom/android/internal/telephony/uicc/UiccCard;->NoSimNotyFlag:Z
...
.method private promptForRestart(Z)V
    ...
    iget-object v10, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mLock:Ljava/lang/Object;
    ...
    sget-object v9, Lcom/android/internal/telephony/uicc/UiccCard;->dialog:Landroid/app/AlertDialog;

    if-eqz v9, :cond_0

    const-string/jumbo v9, "promptForRestart: dialog is already displayed"
    ...
    sput-object v9, Lcom/android/internal/telephony/uicc/UiccCard;->dialog:Landroid/app/AlertDialog;
    ...
    iget v9, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mPhoneId:I
    ...
    invoke-direct {v9, v11, v12}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v5, v1, v4}, Landroid/app/AlertDialog$Builder;->setPositiveButton(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)Landroid/app/AlertDialog$Builder;
    ...
    const-string/jumbo v9, "promptForRestart: dialog.show()"
    ...
    :cond_7
    const-string/jumbo v9, "NOT_RESTART"

    invoke-static {}, Lcom/samsung/android/feature/SemCscFeature;->getInstance()Lcom/samsung/android/feature/SemCscFeature;

    move-result-object v11

    const-string/jumbo v12, "CscFeature_RIL_ConfigOPstyleSIMdetectDialog"
    ...
    const-string/jumbo v9, "ro.build.characteristics"
...
.method public dispose()V
    ...
    iget-object v3, p0, Lcom/android/internal/telephony/uicc/UiccCard;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    invoke-interface {v1, v3}, Lcom/android/internal/telephony/CommandsInterface;->unregisterForSimSwaped(Landroid/os/Handler;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
