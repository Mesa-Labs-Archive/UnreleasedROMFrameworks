...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v10, "AdnRecordCache"

    new-instance v11, Ljava/lang/StringBuilder;

    invoke-direct {v11}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v12, "mAdnLikeFiles.get(efid) null fail, reinit framework member value : "
    ...
    invoke-virtual {p0, v5}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->requestLoadAllAdnLikeAgain(I)V
    ...
    invoke-static {v8, v0, v10}, Landroid/os/AsyncResult;->forMessage(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)Landroid/os/AsyncResult;
    ...
    const-string/jumbo v11, "AsyncResult.forMessage"

    invoke-static {v10, v11, v6}, Landroid/telephony/Rlog;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I

    goto :goto_0

    :cond_3
    iget v10, v0, Lcom/android/internal/telephony/uicc/AdnRecord;->mRecordNumber:I
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->invalidateCache()V
    :try_end_1
    ...
    const-string/jumbo v12, "get from F/W PB list error, index \'"
    ...
    const-string/jumbo v11, "EVENT_ADD_ADN_DONE"
    ...
    const-string/jumbo v11, "EVENT_DELETE_ADN_DONE"
    ...
    const-string/jumbo v12, "adn-alpha is  "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, v0, Lcom/android/internal/telephony/uicc/AdnRecord;->mAlphaTag:Ljava/lang/String;
    ...
    const-string/jumbo v12, "adn-number is  "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget-object v12, v0, Lcom/android/internal/telephony/uicc/AdnRecord;->mNumber:Ljava/lang/String;
    ...
    const-string/jumbo v12, "adn-record index is  "
    ...
    const-string/jumbo v11, "EVENT_LOAD_ALL_ADN_LIKE_AGAIN_DONE"
    ...
    const-string/jumbo v11, "ar.exception == null"
    ...
    const-string/jumbo v11, "EVENT_LOAD_ALL_ADN_LIKE_DONE - end"
...
.method public requestLoadAllAdnLike(ILandroid/os/Message;)V
    ...
    const-string/jumbo v4, "requestLoadAllAdnLike - before AdnLikeWaiter put : efid is "
    ...
    const-string/jumbo v4, "requestLoadAllAdnLike - after AdnLikeWaiter put : efid is "
    ...
    invoke-virtual {p0, v3, p1, v5}, Lcom/android/internal/telephony/uicc/AdnRecordCache;->obtainMessage(III)Landroid/os/Message;
...
.method public updateAdnByIndex(ILcom/android/internal/telephony/uicc/AdnRecord;ILjava/lang/String;Landroid/os/Message;)V
    ...
    const-string/jumbo v2, "updateAdnByIndex - add"
    ...
    const-string/jumbo v2, "updateAdnByIndex - update or delete"
    ...
    const-string/jumbo v2, "requestLoadAllAdnLikeAgain because oldAdnList is null"
    ...
    const-string/jumbo v2, "ADNlike list is not init for EF:"
