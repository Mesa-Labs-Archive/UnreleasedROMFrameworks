...
.method static synthetic -get1(Lcom/android/internal/telephony/uicc/UiccCardApplication;)I
    .locals 1
...
.method static synthetic -set1(Lcom/android/internal/telephony/uicc/UiccCardApplication;I)I
    .locals 0
...
.method static synthetic -wrap1(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/os/AsyncResult;I)I
    .locals 1
...
.method static synthetic -wrap3(Lcom/android/internal/telephony/uicc/UiccCardApplication;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic -wrap7(Lcom/android/internal/telephony/uicc/UiccCardApplication;Landroid/os/AsyncResult;)V
    .locals 0
...
.method public constructor <init>(Lcom/android/internal/telephony/uicc/UiccCard;Lcom/android/internal/telephony/uicc/IccCardApplicationStatus;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iput-object v3, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->LOG_TAG_ID:Ljava/lang/String;
    ...
    const-string/jumbo v4, "UiccCardApplication"
    ...
    const-string/jumbo v4, "Creating UiccApp: "
    ...
    iput v3, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mPhoneId:I
    ...
    const-string/jumbo v2, "CscFeature_RIL_KddiSIMOta"
    ...
    const-string/jumbo v1, "mAppState is  AppState.APPSTATE_SUBSCRIPTION_PERSO"

    invoke-direct {p0, v1}, Lcom/android/internal/telephony/uicc/UiccCardApplication;->log(Ljava/lang/String;)V

    new-instance v0, Landroid/content/Intent;

    const-string/jumbo v1, "android.intent.action.BOOT_NOT_KDDI_CARD_NOTY"
    ...
    const-string/jumbo v1, "sendBroadcast   BOOT_NOT_KDDI_CARD_NOTY"
...
.method private log(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->LOG_TAG_ID:Ljava/lang/String;
...
.method private notifyNetworkLockedRegistrantsIfNeeded(Landroid/os/Registrant;)V
    ...
    :cond_1
    const-string/jumbo v0, "Notifying registrants: SP_LOCKED"
    ...
    :cond_4
    const-string/jumbo v0, "Notifying registrants: NETWORK_SUBSET_LOCKED"
    ...
    :cond_6
    const-string/jumbo v0, "Notifying 1 registrant: NETWORK_LOCKED"
...
.method private declared-synchronized notifyNetworkSubsetLockedRegistrantsIfNeeded(Landroid/os/Registrant;)V
    ...
    const-string/jumbo v0, "Notifying 1 registrant: PERSOSUBSTATE_SIM_NETWORK_SUBSET"
...
.method private declared-synchronized notifySPLockedRegistrantsIfNeeded(Landroid/os/Registrant;)V
    ...
    const-string/jumbo v0, "Notifying 1 registrant: SP_LOCED"
...
.method private onChangeFacilityLock(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v4, "gsm.facilitylock.state"
    ...
    invoke-static {v2, v4, v5}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "PASSWORD_INCORRECT"
...
.method private onQueryFacilityLock(Landroid/os/AsyncResult;)V
    ...
    const-string/jumbo v3, "gsm.facilitylock.state"
    ...
    invoke-static {v1, v3, v4}, Landroid/telephony/TelephonyManager;->setTelephonyProperty(ILjava/lang/String;Ljava/lang/String;)V
...
.method private parsePinPukErrorResult(Landroid/os/AsyncResult;I)I
    ...
    const-string/jumbo v3, "parsePinPukErrorResu lt intArray[0]="
...
.method dispose()V
    ...
    const-string/jumbo v2, "gsm.facilitylock.state"
...
.method public supplyNetworkDepersonalization(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    const-string/jumbo v1, "Network Despersonalization: "
...
.method public update(Lcom/android/internal/telephony/uicc/IccCardApplicationStatus;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;)V
    ...
    iget-boolean v3, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mSimRefreshState:Z
    ...
    const-string/jumbo v5, "CscFeature_Common_SupportMovialWFC"
    ...
    iput-boolean v3, p0, Lcom/android/internal/telephony/uicc/UiccCardApplication;->mSimRefreshState:Z
