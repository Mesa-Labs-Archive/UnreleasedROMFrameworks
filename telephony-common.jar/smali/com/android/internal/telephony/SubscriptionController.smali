...
.method static constructor <clinit>()V
    ...
    sput v3, Lcom/android/internal/telephony/SubscriptionController;->NewSlotId:I
    ...
    :goto_0
    sput-boolean v0, Lcom/android/internal/telephony/SubscriptionController;->isCNHKTW:Z
    ...
    sput v3, Lcom/android/internal/telephony/SubscriptionController;->mDefaultPhoneId:I
...
.method protected constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/SubscriptionController;->mActiveSubInfoList:Ljava/util/List;
...
.method private getDefaultSmsSlotId()I
    ...
    const-string/jumbo v2, "multi_sim_sms_slot"
...
.method private getDefaultVoiceSlotId()I
    ...
    const-string/jumbo v2, "multi_sim_voice_call_slot"
...
.method private getSubInfoRecord(Landroid/database/Cursor;)Landroid/telephony/SubscriptionInfo;
    ...
    sget-boolean v1, Lcom/android/internal/telephony/SubscriptionController;->isCNHKTW:Z

    if-nez v1, :cond_1

    const-string/jumbo v1, "INU"
    ...
    const-string/jumbo v1, "[getSubInfoRecord] id:XXX iccid:XXX simSlotIndex:XXXX displayName:XXX nameSource:XXX iconTint:XXX dataRoaming:XXX mcc:XXX mnc:XXX countIso:XXX NwMode:XXX"
    ...
    const-string/jumbo v18, "CscFeature_Contact_AutoUpdateProfileForNewSimNumber"
    ...
    const-string/jumbo v19, "com.samsung.intent.action.AUTO_UPDATE_PROFILE_MSISDN_CHANGED"
...
.method private setCarrierText(Ljava/lang/String;I)I
    ...
    invoke-virtual {p0, p2, v5}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v5, "[setCarrierText]- already updated"
...
.method private setDefaultDataSlotId(I)V
    ...
    const-string/jumbo v0, "[setDefaultDataSlotId] Invalid slotid - not updating."
    ...
    const-string/jumbo v1, "[setDefaultDataSlotId] slotId="
...
.method private setDefaultFallbackSubId(I)V
    ...
    const-string/jumbo v3, "android.telephony.action.DEFAULT_SUBSCRIPTION_CHANGED"
...
.method private setDefaultSmsSlotId(I)V
    .locals 2
    ...
    const-string/jumbo v1, "multi_sim_sms_slot"
...
.method private setDefaultVoiceSlotId(I)V
    ...
    const-string/jumbo v1, "multi_sim_voice_call_slot"
...
.method public activateSubId(I)V
    ...
    const-string/jumbo v1, "[activateSubId]- invalid slotId"
    ...
    invoke-virtual {v1, v0}, Lcom/android/internal/telephony/SubscriptionHelper;->getSubState(I)I
    ...
    const-string/jumbo v1, "CTC don\'t check substate in activateSubId "
    ...
    const-string/jumbo v2, "activateSubId: subscription already active, slotId = "
...
.method public addSubInfoRecord(Ljava/lang/String;I)I
    ...
    invoke-static {v14}, Lcom/android/internal/telephony/uicc/IccUtils;->getIccType(I)I
    :try_end_4
    ...
    :cond_b
    :try_start_7
    sget-boolean v3, Lcom/android/internal/telephony/SubscriptionController;->isCNHKTW:Z
    ...
    :cond_c
    const-string/jumbo v3, "Do not change set NETWORK_MODE with Subid"
    ...
    const-string/jumbo v4, "[addSubInfoRecord] sSlotIndexToSubId.size="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-object v4, Lcom/android/internal/telephony/SubscriptionController;->sSlotIndexToSubId:Ljava/util/Map;
    ...
    const-string/jumbo v4, " insertedCount = "
    ...
    const-string/jumbo v3, "Do not change DefaultSubID"
    ...
    const-string/jumbo v4, "New Record ="
    ...
    const-string/jumbo v4, "getdefaultdatasubid simcount 2 ="
    ...
    const-string/jumbo v4, "[addSubInfoRecord]- getSubId failed invalid subId = "
    ...
    invoke-static {v3, v4, v0, v9}, Landroid/telephony/TelephonyManager;->putIntAtIndex(Landroid/content/ContentResolver;Ljava/lang/String;II)Z
    ...
    const-string/jumbo v4, ", SubID NETWORK_MODE "
    ...
    :try_end_c
    .catch Landroid/provider/Settings$SettingNotFoundException; {:try_start_c .. :try_end_c} :catch_0
    ...
    const-string/jumbo v4, "Could not find NETWORK_MODE : "
...
.method public deactivateSubId(I)V
    ...
    const-string/jumbo v1, "[deactivateSubId]- invalid slotId"
    ...
    const-string/jumbo v1, "CTC don\'t check substate in deactivateSubId "
    ...
    const-string/jumbo v1, "deactivateSubId by CrossMapping"
    ...
    const-string/jumbo v2, "deactivateSubId: subscription already deactivated, subId = "
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v7, " sSlotIndexToSubId["
...
.method public getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v6, " subInfo= XXX"
    ...
    const-string/jumbo v6, " subList= XXX subInfo=null"
...
.method public getActiveSubscriptionInfoForIccId(Ljava/lang/String;Ljava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v5, "[getActiveSubInfoUsingIccId]+ iccId= XXX subInfo= XXX"
    ...
    const-string/jumbo v5, "[getActiveSubInfoUsingIccId]+ iccId= XXX subList= XXX subInfo=null"
...
.method public getActiveSubscriptionInfoForSimSlotIndex(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v5, "[getActiveSubscriptionInfoForSimSlotIndex]+ slotIndex= XXX subId= XXX"
    ...
    const-string/jumbo v6, "[getActiveSubscriptionInfoForSimSlotIndex]+ slotIndex="
    ...
    const-string/jumbo v5, "[getActiveSubscriptionInfoForSimSlotIndex]+ slotIndex= XXX subId=null"
...
.method public getAllSubInfoCount(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "[getAllSubInfoCount]- count: "
...
.method public getNwMode(I)I
    ...
    const-string/jumbo v3, "[getNwMode] Invalid subId = "
    ...
    invoke-virtual {v1}, Landroid/telephony/SubscriptionInfo;->getNwMode()I
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/internal/telephony/SubscriptionController;->setNwMode(II)V
    ...
    const-string/jumbo v3, "[getNwMode] subId: "
...
.method public getPhoneId(I)I
    ...
    const-string/jumbo v8, "[getPhoneId] asked for default subId="
    ...
    const-string/jumbo v8, "[getPhoneId]- dummy subId "
    ...
    :cond_2
    sget-object v7, Lcom/android/internal/telephony/SubscriptionController;->sSlotIndexToSubId:Ljava/util/Map;
    ...
    const-string/jumbo v8, "[getPhoneId]- no sims, returning default phoneId="
    ...
    const-string/jumbo v8, "[getPhoneId]- interrupted ConcurrentModificationException, returning default phoneId="
    ...
    const-string/jumbo v8, "[getPhoneId]- subId="
    ...
    const-string/jumbo v8, " not found return default phoneId="
...
.method public getSimStateForSlotIndex(I)I
    ...
    const-string/jumbo v0, "invalid slotIndex"
    ...
    const-string/jumbo v5, "getSimStateForSlotIndex: "
...
.method public getSlotIndex(I)I
    ...
    const-string/jumbo v7, "[getSlotId]- dummy subId "
    ...
    const-string/jumbo v6, "[getSlotIndex]- subId invalid"
    ...
    const-string/jumbo v6, "[getSlotIndex]- size == 0, return SIM_NOT_INSERTED instead"
    ...
    const-string/jumbo v6, "[getSlotId]- interrupted ConcurrentModificationException,return SIM_NOT_INSERTED instead"
    ...
    :cond_5
    const-string/jumbo v6, "[getSlotIndex]- return fail"
...
.method public getSubId(I)[I
    ...
    invoke-virtual {p0, v10}, Lcom/android/internal/telephony/SubscriptionController;->getSlotIndex(I)I
    ...
    const-string/jumbo v11, "[getSubId]- invalid slotIndex="
    ...
    :cond_1
    sget-object v10, Lcom/android/internal/telephony/SubscriptionController;->sSlotIndexToSubId:Ljava/util/Map;
    ...
    const-string/jumbo v10, "[getSubId]- interrupted ConcurrentModificationException,return dummy instead"
    ...
    const-string/jumbo v11, "[getSubId]- numSubIds == 0, return DummySubIds slotIndex="
...
.method public getSubInfoUsingSlotIndexWithCheck(IZLjava/lang/String;)Ljava/util/List;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZ",
    ...
    const-string/jumbo v1, "[getSubInfoUsingSlotIndexWithCheck]+ slotIndex:"
    ...
    const-string/jumbo v0, "getSubInfoUsingSlotIndexWithCheck"
    ...
    const-string/jumbo v0, "[getSubInfoUsingSlotIndexWithCheck]- invalid slotIndex"
    ...
    const-string/jumbo v0, "[getSubInfoUsingSlotIndexWithCheck]- not ready"
    ...
    :cond_7
    const-string/jumbo v0, "[getSubInfoUsingSlotIndex]- null info return"
...
.method public getSubState(I)I
    ...
    invoke-virtual {p0, p1, v3}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
...
.method public getSubscriptionProperty(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "getSubInfoUsingSlotIndexWithCheck"
...
.method protected insertLog(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    const-string/jumbo v2, "insertLog : Context is null."
    ...
    const-string/jumbo v3, "insertLog - feature : "
    ...
    const-string/jumbo v2, "insertLog : send intent REPORT_APP_STATUS_SURVEY"
    ...
    :cond_4
    const-string/jumbo v2, "insertLog : no permission of survey"
...
.method protected insertLogforDataSubId(I)V
    ...
    const-string/jumbo v1, "Survey mode, but DataSubid not change !! : "
    ...
    const-string/jumbo v1, "insertLogforDataSubId subId : "
...
.method public refreshSubInfo()V
    ...
    const-string/jumbo v2, "[refreshSubInfo]+ defaultSubId system:"
    ...
    const-string/jumbo v2, " / defaultSlotId voice:"
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/SubscriptionController;->getDefaultSmsSlotId()I
    ...
    invoke-direct {p0, v3, v3}, Lcom/android/internal/telephony/SubscriptionController;->getSubInfo(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    sput-object v1, Lcom/android/internal/telephony/SubscriptionController;->mAllSubInfoList:Ljava/util/List;

    const-string/jumbo v1, "sim_id>=0"

    invoke-direct {p0, v1, v3}, Lcom/android/internal/telephony/SubscriptionController;->getSubInfo(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    iput-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mActiveSubInfoList:Ljava/util/List;

    iget-object v1, p0, Lcom/android/internal/telephony/SubscriptionController;->mActiveSubInfoList:Ljava/util/List;
...
.method public setDefaultDataSubId(I)V
    ...
    const-string/jumbo v19, "setDefaultDataSubId"
    ...
    const-string/jumbo v20, "setDefaultDataSubId called with DEFAULT_SUB_ID"
    ...
    const-string/jumbo v20, "[setDefaultDataSubId] subId="
    ...
    const-string/jumbo v19, "ril.datacross.slotid"
    ...
    const-string/jumbo v19, "com.samsung.intent.action.ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_FAIL"
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/internal/telephony/SubscriptionController;->getPhoneId(I)I
    ...
    const-string/jumbo v20, "[setDefaultDataSubId, MMS sending / receiving. data cross ="
    ...
    const-string/jumbo v20, "ACTION_DEFAULT_DATA_SUBSCRIPTION_CHANGE_FAIL : "
    ...
    sget-object v19, Lcom/android/internal/telephony/SubscriptionController;->sPhones:[Lcom/android/internal/telephony/Phone;
    ...
    const-string/jumbo v20, "[setDefaultDataSubId] num phones="
    ...
    new-array v15, v9, [Landroid/telephony/RadioAccessFamily;
    ...
    const-string/jumbo v20, "[setDefaultDataSubId] phoneId="
    ...
    new-instance v19, Landroid/telephony/RadioAccessFamily;
    ...
    const-string/jumbo v20, "multi_sim_data_call"
    ...
    invoke-virtual/range {p0 .. p1}, Lcom/android/internal/telephony/SubscriptionController;->getSlotIndex(I)I
    ...
    invoke-static/range {v20 .. v23}, Ljava/lang/Double;->compare(DD)I
    ...
    const-string/jumbo v20, "valid prevSubId "
    ...
    invoke-virtual {v0, v12}, Lcom/android/internal/telephony/SubscriptionController;->getSlotIndex(I)I
    ...
    const-string/jumbo v20, "valid slotIdx "
    ...
    :cond_6
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/uicc/UiccController;->getDataSlotChanged()Z
    ...
    invoke-virtual/range {v18 .. v19}, Lcom/android/internal/telephony/uicc/UiccController;->setDataSlotChanged(Z)V
    ...
    const-string/jumbo v20, "valid subId "
    ...
    const-string/jumbo v20, "default data subid changed from "
    ...
    invoke-virtual {v4, v0}, Lcom/android/internal/telephony/uicc/AutoPreconfigLog;->log(Ljava/lang/String;)V

    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/uicc/UiccController;->startAutocfg()V

    :cond_8
    sget-boolean v19, Lcom/android/internal/telephony/SubscriptionController;->ENABLE_SURVEY_MODE:Z
    ...
    :cond_a
    const-string/jumbo v19, "[setDefaultDataSubId] no valid subId\'s found - not updating."
    ...
    :cond_b
    invoke-virtual/range {v18 .. v18}, Lcom/android/internal/telephony/uicc/UiccController;->unbindAutopreconfig()V
...
.method public setDefaultSmsSubId(I)V
    ...
    invoke-direct {p0, v0}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultSmsSlotId(I)V
...
.method public setMccMnc(Ljava/lang/String;I)I
    ...
    const-string/jumbo v7, "[setMccMnc]+ mcc/mnc:"
    ...
    invoke-virtual {p0, p2, v6}, Lcom/android/internal/telephony/SubscriptionController;->getActiveSubscriptionInfo(ILjava/lang/String;)Landroid/telephony/SubscriptionInfo;
    ...
    const-string/jumbo v6, "[setMccMnc]- already updated"
    ...
    const-string/jumbo v7, "[setMccMnc] - couldn\'t parse mcc/mnc: "
    ...
    invoke-virtual {v6, v7, v5, v8, v12}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public setNwMode(II)V
    ...
    const-string/jumbo v3, "[setNwMode] subId: "
    ...
    const-string/jumbo v3, "[setNwMode] Invalid subId = "
    ...
    invoke-virtual {v0}, Landroid/telephony/SubscriptionInfo;->getNwMode()I
    ...
    const-string/jumbo v2, "network_mode"
...
.method public setPlmnSpn(IZLjava/lang/String;ZLjava/lang/String;)Z
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/SubscriptionController;->mLock:Ljava/lang/Object;
    ...
    :cond_0
    const-string/jumbo v3, "[setPlmnSpn] No valid subscription to store info"
    ...
    :cond_4
    :goto_0
    invoke-direct {p0, v0, v2}, Lcom/android/internal/telephony/SubscriptionController;->setCarrierText(Ljava/lang/String;I)I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public updateUserPreferences()V
    .locals 11
    ...
    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/SubscriptionController;->getSubState(I)I
    ...
    invoke-virtual {p0, v9}, Lcom/android/internal/telephony/SubscriptionController;->getSubIdUsingPhoneId(I)I
    ...
    :cond_7
    sget-boolean v9, Lcom/android/internal/telephony/SubscriptionController;->isCNHKTW:Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/internal/telephony/SubscriptionController;->isActiveSubId(I)Z
    ...
    const-string/jumbo v10, "updateUserPreferences: ForChina, prefDataSubId:"
    ...
    invoke-direct {p0, v9}, Lcom/android/internal/telephony/SubscriptionController;->setDefaultFallbackSubId(I)V
