...
.method public dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Lcom/android/internal/telephony/CallDetails;Landroid/os/Message;)V
    ...
    invoke-virtual {p0, p1, p2, p3, p5}, Lcom/android/internal/telephony/test/SimulatedCommands;->dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Landroid/os/Message;)V
...
.method public getDataRegistrationState(Landroid/os/Message;)V
    ...
    new-instance v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecDataRegStateResult;

    invoke-direct {v0}, Lcom/android/internal/telephony/hardware/radio/V1_0/SecDataRegStateResult;-><init>()V

    iget-object v1, v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecDataRegStateResult;->base:Landroid/hardware/radio/V1_0/DataRegStateResult;

    iget v2, p0, Lcom/android/internal/telephony/test/SimulatedCommands;->mDataRegState:I

    iput v2, v1, Landroid/hardware/radio/V1_0/DataRegStateResult;->regState:I

    iget-object v1, v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecDataRegStateResult;->base:Landroid/hardware/radio/V1_0/DataRegStateResult;

    iget v2, p0, Lcom/android/internal/telephony/test/SimulatedCommands;->mDataRadioTech:I

    iput v2, v1, Landroid/hardware/radio/V1_0/DataRegStateResult;->rat:I
...
.method public getVoiceRegistrationState(Landroid/os/Message;)V
    ...
    new-instance v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecVoiceRegStateResult;

    invoke-direct {v0}, Lcom/android/internal/telephony/hardware/radio/V1_0/SecVoiceRegStateResult;-><init>()V

    iget-object v1, v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecVoiceRegStateResult;->base:Landroid/hardware/radio/V1_0/VoiceRegStateResult;

    iget v2, p0, Lcom/android/internal/telephony/test/SimulatedCommands;->mVoiceRegState:I

    iput v2, v1, Landroid/hardware/radio/V1_0/VoiceRegStateResult;->regState:I

    iget-object v1, v0, Lcom/android/internal/telephony/hardware/radio/V1_0/SecVoiceRegStateResult;->base:Landroid/hardware/radio/V1_0/VoiceRegStateResult;

    iget v2, p0, Lcom/android/internal/telephony/test/SimulatedCommands;->mVoiceRadioTech:I

    iput v2, v1, Landroid/hardware/radio/V1_0/VoiceRegStateResult;->rat:I
...
.method public iccOpenLogicalChannel(Ljava/lang/String;ILandroid/os/Message;)V
    ...
    invoke-virtual {v1, p1, p2, p3}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->iccOpenLogicalChannel(Ljava/lang/String;ILandroid/os/Message;)V
...
.method public secSendCdmaSms([BLandroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->secSendCdmaSms([BLandroid/os/Message;)V
...
.method public secSendImsCdmaSms([BIILandroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->secSendImsCdmaSms([BIILandroid/os/Message;)V

    new-instance v0, Lcom/android/internal/telephony/SmsResponse;

    const/4 v1, 0x0

    invoke-direct {v0, v2, v1, v2, v2}, Lcom/android/internal/telephony/SmsResponse;-><init>(ILjava/lang/String;II)V
...
.method public secSendImsGsmSms(Ljava/lang/String;Ljava/lang/String;IILandroid/os/Message;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->secSendImsGsmSms(Ljava/lang/String;Ljava/lang/String;IILandroid/os/Message;)V

    new-instance v0, Lcom/android/internal/telephony/SmsResponse;

    const/4 v1, 0x0

    invoke-direct {v0, v6, v1, v6, v6}, Lcom/android/internal/telephony/SmsResponse;-><init>(ILjava/lang/String;II)V
...
.method public secSendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->secSendSMS(Ljava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
...
.method public setCallForward(IIILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Landroid/os/Message;)V
    ...
    invoke-direct {p0, p8, v0}, Lcom/android/internal/telephony/test/SimulatedCommands;->resultSuccess(Landroid/os/Message;Ljava/lang/Object;)V
...
.method public setupDataCall(ILcom/android/internal/telephony/dataconnection/DataProfile;ZZLandroid/os/Message;)V
    ...
    invoke-virtual/range {v1 .. v6}, Lcom/android/internal/telephony/test/SimulatedCommandsVerifier;->setupDataCall(ILcom/android/internal/telephony/dataconnection/DataProfile;ZZLandroid/os/Message;)V
    ...
    const-string/jumbo v7, "rmnet_data7"

    const-string/jumbo v8, "12.34.56.78"

    const-string/jumbo v9, "98.76.54.32"

    const-string/jumbo v10, "11.22.33.44"
    ...
    invoke-direct/range {v1 .. v12}, Lcom/android/internal/telephony/dataconnection/DataCallResponse;-><init>(IIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
