...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher$1;
    }
.end annotation
...
# direct methods
.method static synthetic -get0(Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;)Z
    .locals 1
...
.method static synthetic -get1(Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;)Lcom/android/internal/telephony/Phone;
    .locals 1
...
.method public constructor <init>(Lcom/android/internal/telephony/Phone;Lcom/android/internal/telephony/SmsUsageMonitor;Lcom/android/internal/telephony/ImsSMSDispatcher;)V
    ...
    const-string/jumbo v3, "android.intent.action.WAITING_AUTO_LOGIN"
...
.method private handleCdmaStatusReport(Lcom/android/internal/telephony/cdma/SmsMessage;)V
    ...
    const-string/jumbo v7, "CdmaSMSDispatcher"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "handleCdmaStatusReport deliveryPendingList.size(): "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->deliveryPendingList:Ljava/util/ArrayList;
    ...
    const-string/jumbo v9, "handleCdmaStatusReport tracker.mMessageRef: "
    ...
    const-string/jumbo v9, " sms.mMessageRef: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, p1, Lcom/android/internal/telephony/cdma/SmsMessage;->mMessageRef:I
    ...
    iget v7, v6, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mMessageRef:I
    ...
    invoke-virtual {v6, v7, v8}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->updateSentMessageStatus(Landroid/content/Context;I)V

    iget-object v4, v6, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->mDeliveryIntent:Landroid/app/PendingIntent;
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-virtual {v4, v7, v8, v2}, Landroid/app/PendingIntent;->send(Landroid/content/Context;ILandroid/content/Intent;)V
    :try_end_0
    ...
    const-string/jumbo v8, "handleCdmaStatusReport send intent for network switching"
...
.method private sendAutoLoginSmsResponse()V
    ...
    const-string/jumbo v4, "sendAutoLoginSmsResponse() invokeRilRequestRaw"
    ...
    const-string/jumbo v5, "SendAutoLoginSms() error:"
...
.method protected checkEcmPolicy(ZLjava/lang/String;)Z
    ...
    const-string/jumbo v6, "CscFeature_RIL_SupportVolte"
    ...
    invoke-virtual {v4}, Lcom/android/internal/telephony/Phone;->getCallTracker()Lcom/android/internal/telephony/CallTracker;
    ...
    iget-object v5, v5, Lcom/android/internal/telephony/CallTracker;->mLastCallRat:Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo v4, "ril.cdma.ine911"
    ...
    const-string/jumbo v6, "checkEcmPolicy ltecall : "
    ...
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mDcnAddress:Ljava/lang/String;
    ...
    const-string/jumbo v5, "This is DCN number"
    ...
    const-string/jumbo v5, "exit ECBM mode"

    invoke-static {v4, v5}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v4}, Lcom/android/internal/telephony/Phone;->exitEmergencyCallbackMode()V
    ...
    const-string/jumbo v6, "CscFeature_RIL_SprEcmIncomingSms"
...
.method public clearDuplicatedCbMessages()V
    ...
    const-string/jumbo v1, "Error! clearDuplicatedCbMessages is not implemented for CDMA."
...
.method protected dispatchSmsServiceCenter(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->Sim_Smsc:Ljava/lang/String;
    ...
    const-string/jumbo v2, "dispatchSmsServiceCenter function is not applicable for CDMA smsc: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->Sim_Smsc:Ljava/lang/String;
...
.method protected getNewSubmitPduTracker(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/android/internal/telephony/SmsHeader;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;ZLjava/util/concurrent/atomic/AtomicInteger;Ljava/util/concurrent/atomic/AtomicBoolean;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;
    ...
    iget-object v7, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v7}, Lcom/android/internal/telephony/Phone;->getPhoneId()I

    move-result v7

    const-string/jumbo v8, "CscFeature_RIL_SegmentedSms"
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-static {v5, v7}, Lcom/android/internal/telephony/TelephonyFeatures;->isCountrySpecific(I[Ljava/lang/String;)Z
    ...
    const-string/jumbo v8, "CscFeature_RIL_SmsKsc5601Send"
...
.method protected isAscii7bitSupportedForLongMessage()Z
    .locals 4
...
.method public sendData(Ljava/lang/String;Ljava/lang/String;I[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mSmsHQMAgent:Lcom/android/internal/telephony/SmsHQMAgent;

    const-string/jumbo v5, "0"

    const-string/jumbo v6, "CSD_sendData_getSubmitPduNull"
...
.method public sendDomainChangeSms(B)V
    ...
    const-string/jumbo v2, "uicc is absent"
    ...
    const-string/jumbo v3, "mImsSMSDispatcher is null"
...
.method protected sendMultipartText(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/String;I)V
    ...
    const-string/jumbo v8, "sendMultipartText "
    ...
    iget-object v4, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-static {v4, v8}, Lcom/android/internal/telephony/TelephonyFeatures;->isMainOperatorSpecific(I[Ljava/lang/String;)Z
    ...
    iget-object v8, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    const-string/jumbo v11, "CscFeature_RIL_SegmentedSms"

    invoke-virtual {v4, v8, v11}, Lcom/samsung/android/feature/SemCscFeature;->getBoolean(ILjava/lang/String;)Z
    ...
    const-string/jumbo v11, "CHN"

    const/4 v13, 0x0

    aput-object v11, v8, v13

    const-string/jumbo v11, "HKG"

    const/4 v13, 0x1

    aput-object v11, v8, v13

    const-string/jumbo v11, "TPE"

    const/4 v13, 0x2

    aput-object v11, v8, v13

    invoke-static {v4, v8}, Lcom/android/internal/telephony/TelephonyFeatures;->isCountrySpecific(I[Ljava/lang/String;)Z
    ...
    const-string/jumbo v8, "CdmaSMSDispatcher.sendText(): getSubmitPdu() returned null"
    ...
    const-string/jumbo v11, "CSD_sendMultipartText_getSubmitPduNull"

    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v13}, Lcom/android/internal/telephony/Phone;->getPhoneId()I

    move-result v13

    invoke-virtual {v4, v8, v11, v13}, Lcom/android/internal/telephony/SmsHQMAgent;->sendSMOTInfoToHQM(Ljava/lang/String;Ljava/lang/String;I)V
...
.method protected sendMultipartTextwithOptions(Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Landroid/net/Uri;Ljava/lang/String;ZIII)V
    ...
    const-string/jumbo v8, "sendMultipartTextwithOptions "
    ...
    const-string/jumbo v9, "CHN"

    const/4 v10, 0x0

    aput-object v9, v8, v10

    const-string/jumbo v9, "HKG"

    const/4 v10, 0x1

    aput-object v9, v8, v10

    const-string/jumbo v9, "TPE"
    ...
    const-string/jumbo v9, "Found Package : "
...
.method protected sendOTADomestic(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Error! sendOTADomestic is not implemented for CDMA."
...
.method protected sendSmsByPstn(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    invoke-static {v6}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->getNotInServiceError(I)I

    move-result v8

    invoke-virtual {p1, v7, v8, v9}, Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;->onFailed(Landroid/content/Context;II)V

    iget-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mSmsHQMAgent:Lcom/android/internal/telephony/SmsHQMAgent;

    const-string/jumbo v8, "0"

    const-string/jumbo v9, "CSD_sendSmsByPstn_NotInService"
    ...
    invoke-virtual {v7, v8, v9, v10}, Lcom/android/internal/telephony/SmsHQMAgent;->sendSMOTInfoToHQM(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v8, "destAddr"
    ...
    const-string/jumbo v7, "sendSms: - CDMA "

    invoke-virtual {v3, v7}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    move-result-object v7

    const-string/jumbo v8, " isIms()="
    ...
    :cond_2
    iget-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mSmsLogger:Lcom/android/internal/telephony/SmsLogger;

    const-string/jumbo v8, "CdmaSMSDispatcher"
    ...
    invoke-virtual {v7, v8, v9, v10}, Lcom/android/internal/telephony/SmsLogger;->add(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    iget-object v7, v7, Lcom/android/internal/telephony/GsmCdmaPhone;->mCT:Lcom/android/internal/telephony/GsmCdmaCallTracker;

    iget-object v7, v7, Lcom/android/internal/telephony/GsmCdmaCallTracker;->mState:Lcom/android/internal/telephony/PhoneConstants$State;
    ...
    const-string/jumbo v9, "CscFeature_RIL_SelectSmsSendingRouteInTelephony"
    ...
    invoke-interface {v7, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->oemSendCdmaSmsMore([BLandroid/os/Message;)V
    ...
    invoke-interface {v7, v4, v5}, Lcom/android/internal/telephony/CommandsInterface;->secSendCdmaSms([BLandroid/os/Message;)V
    ...
    invoke-interface {v7, v4, v8, v9, v5}, Lcom/android/internal/telephony/CommandsInterface;->sendImsCdmaSms([BIILandroid/os/Message;)V
...
.method protected sendSubmitPdu(Lcom/android/internal/telephony/SMSDispatcher$SmsTracker;)V
    ...
    invoke-virtual {p0, v2, v1}, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->checkEcmPolicy(ZLjava/lang/String;)Z
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mSmsHQMAgent:Lcom/android/internal/telephony/SmsHQMAgent;

    const-string/jumbo v2, "0"

    const-string/jumbo v3, "CSD_sendSubmitPdu_ECM"
    ...
    invoke-virtual {v1, v2, v3, v4}, Lcom/android/internal/telephony/SmsHQMAgent;->sendSMOTInfoToHQM(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public sendText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/net/Uri;Ljava/lang/String;Z)V
    ...
    iget-object v6, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mPhone:Lcom/android/internal/telephony/Phone;

    invoke-virtual {v6}, Lcom/android/internal/telephony/Phone;->getPhoneId()I

    move-result v6

    const-string/jumbo v7, "CscFeature_RIL_SmsAddressSeparator"
    ...
    const-string/jumbo v6, "CdmaSMSDispatcher.sendText(): getSubmitPdu() returned null"
    ...
    iget-object v5, v0, Lcom/android/internal/telephony/cdma/CdmaSMSDispatcher;->mSmsHQMAgent:Lcom/android/internal/telephony/SmsHQMAgent;

    const-string/jumbo v6, "0"

    const-string/jumbo v7, "CSD_sendText_getSubmitPduNull"
    ...
    invoke-virtual {v5, v6, v7, v8}, Lcom/android/internal/telephony/SmsHQMAgent;->sendSMOTInfoToHQM(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v6, "Intent has been canceled!"
...
.method protected sendText(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;I)V
    ...
    const-string/jumbo v7, "sendText "
...
.method protected sendTextNSRI(Ljava/lang/String;Ljava/lang/String;[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;II)V
    ...
    const-string/jumbo v1, "Error! sendTextNSRI is not implemented for CDMA."
...
.method protected sendTextwithOptions(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/net/Uri;Ljava/lang/String;ZIIII)V
    ...
    const-string/jumbo v6, "sendTextwithOptions: confirmId is a special GSM function, should never be called in CDMA!"
    ...
    const-string/jumbo v7, "CSD_sendTextwithOptions_confirmId"
    ...
    const-string/jumbo v7, "CSD_sendTextwithOptions_getSubmitPduNull"
