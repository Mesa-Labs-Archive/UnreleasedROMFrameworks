...
.method public createBondOutOfBand(ILandroid/bluetooth/OobData;)Z
    ...
    const-string/jumbo v2, "BT not enabled, createBondOutOfBand failed"
...
.method public fetchUuidsWithSdp()Z
    ...
    const-string/jumbo v6, "BT not enabled. Cannot fetchUuidsWithSdp"
    ...
    const-string/jumbo v7, "fetchUuidsWithSdp() for device "
    ...
    const-string/jumbo v7, " called by pid: "
    ...
    const-string/jumbo v6, "BluetoothDevice -- fetchUuidsWithSdp() for dev "
    ...
    const-string/jumbo v6, " called by PID : "
    ...
    invoke-interface {v4, p0, v5}, Landroid/bluetooth/IBluetooth;->fetchRemoteUuidsFiltered(Landroid/bluetooth/BluetoothDevice;Z)Z
...
.method public isBondingInitiatedLocally()Z
    ...
    const-string/jumbo v2, "BT not enabled. isBondingInitiatedLocally failed"
