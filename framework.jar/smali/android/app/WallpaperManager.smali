...
.method private addMotionWallpaperURI(ILjava/util/ArrayList;)V
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    invoke-direct {p0, p1, v11}, Landroid/app/WallpaperManager;->getName(II)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v10}, Landroid/app/WallpaperManager;->getName(II)Ljava/lang/String;
    ...
    const-string/jumbo v8, "android.resource://com.android.systemui/drawable/"
    ...
    invoke-direct {p0, v7, v5}, Landroid/app/WallpaperManager;->getResourceID(ILjava/lang/String;)I
    ...
    const-string/jumbo v8, "?locType=preload&type=cinematic&colorInfo="
    ...
    const-string/jumbo v9, "addMotionWallpaperURI: wallpaperURI : "
...
.method private addVideoWallpaperURI(ILjava/util/ArrayList;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    const-string/jumbo v14, "addVideoWallpaperURI : "
    ...
    const-string/jumbo v13, "?locType=preloadDefault&packageName=com.android.systemui&type=video&colorInfo="
    ...
    const-string/jumbo v14, "videoDefault wallpaper :"
    ...
    const-string/jumbo v13, "?locType=preload&packageName=com.android.systemui&type=video&colorInfo="
    ...
    const-string/jumbo v14, "Video wallpaper :"
    ...
    const-string/jumbo v14, "Video wallpaper dummy :"
...
.method private getDefaultWallpaperInformation(I)Landroid/os/Bundle;
    ...
    const-string/jumbo v11, "getDefaultWallpaperInformation : "
    ...
    const-string/jumbo v11, "omc wallpaper : "
    ...
    sget-object v10, Landroid/app/WallpaperManager;->WPAPER_VALUE_DEFAULT_WALLPAPER:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v4}, Landroid/app/WallpaperManager;->addInfinityWallpaperURI(ILjava/util/ArrayList;)V
    ...
    const-string/jumbo v2, "android.resource://com.android.systemui/drawable/dummy_res?locType=preload&isDummyToAdjustListOrder=true;android.resource://com.android.systemui/drawable/keyguard_default_wallpaper_thumbnail.jpg"
    ...
    const-string/jumbo v11, "wallpaper dummy :"
    ...
    invoke-direct {p0, p1, v9}, Landroid/app/WallpaperManager;->getCSCWallpaperURI(ILjava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v11, "csc wallpaper : "
    ...
    sget-boolean v9, Landroid/app/WallpaperManager;->SUPPORT_CSC_CMF:Z

    if-eqz v9, :cond_0

    invoke-direct {p0, p1, v4}, Landroid/app/WallpaperManager;->addPreloadCSCWallpaperURI(ILjava/util/ArrayList;)V
    ...
    invoke-direct {p0, p1, v4}, Landroid/app/WallpaperManager;->addVideoWallpaperURI(ILjava/util/ArrayList;)V
    ...
    const-string/jumbo v11, "preloadDefault wallpaper :"
    ...
    :cond_7
    sget-boolean v9, Landroid/app/WallpaperManager;->WPAPER_SUPPORT_MOTION_WALLPAPER:Z
    ...
    invoke-direct {p0, p1, v4}, Landroid/app/WallpaperManager;->addMotionWallpaperURI(ILjava/util/ArrayList;)V

    :cond_8
    const-string/jumbo v9, "paramKeyUriList"

    invoke-virtual {v0, v9, v4}, Landroid/os/Bundle;->putStringArrayList(Ljava/lang/String;Ljava/util/ArrayList;)V
    ...
    const-string/jumbo v11, "preload motion wallpaper :"
...
.method private getVideoFDFromPackage(Ljava/lang/String;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    const-string/jumbo v7, "getVideoFDFromPackage() pkgName = "
    ...
    const-string/jumbo v6, "getVideoFDFromPackage() otherContext is null"
    ...
    const-string/jumbo v6, "getVideoFDFromPackage() assetManager is null"
...
.method private isNeedToKWPBackup()Z
    .locals 7
    ...
    const-string/jumbo v4, "need_backup_wallpaper"
    ...
    const-string/jumbo v3, "com.samsung.systemui.lockstar"
    ...
    const-string/jumbo v5, "isNeedToKWPBackup(), needBackup = "
...
.method public static openDefaultWallpaper(Landroid/content/Context;IZ)Ljava/io/InputStream;
    ...
    :try_start_1
    invoke-virtual {p0, v5, v8}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;

    move-result-object v6

    invoke-static {v6, p1}, Landroid/app/WallpaperManager;->getDefaultWallpaperID(Landroid/content/Context;I)I
    :try_end_1
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string/jumbo v10, "openDefaultWallpaper(), NameNotFoundException : "
    ...
    const-string/jumbo v10, "openDefaultWallpaper: by ["
...
.method private requestBackupWallpaper()V
    .locals 3

    sget-object v1, Landroid/app/WallpaperManager;->TAG:Ljava/lang/String;

    const-string/jumbo v2, "requestBackupWallpaper()"
    ...
    invoke-interface {v1}, Landroid/app/IWallpaperManager;->backupLockWallpaper()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZIII)I
    ...
    invoke-direct/range {p0 .. p0}, Landroid/app/WallpaperManager;->isNeedToKWPBackup()Z

    move-result v2

    if-eqz v2, :cond_4

    invoke-direct/range {p0 .. p0}, Landroid/app/WallpaperManager;->requestBackupWallpaper()V
    :try_end_3
...
.method private setOpenThemeWallpaper(Landroid/graphics/Bitmap;Landroid/graphics/Rect;ZLjava/lang/String;ZZ)V
    ...
    invoke-static {v1, v2, v3, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string/jumbo v3, "setOpenThemeWallpaper isAnimated="
    ...
    const-string/jumbo v3, " needBackup="
    ...
    const-string/jumbo v3, " hasLockscreenWallpaper="
    ...
    :try_start_0
    invoke-direct {p0}, Landroid/app/WallpaperManager;->requestBackupWallpaper()V
    ...
    invoke-interface {v1, p4, v2}, Landroid/app/IWallpaperManager;->setAnimatedWallpaper(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v3}, Landroid/app/WallpaperManager;->getCSCWallpaperFile(ILandroid/app/WallpaperManager$SubUserWallpaperChecker;Ljava/lang/String;)Ljava/io/File;
    ...
    const-string/jumbo v1, "com.samsung.systemui.lockstar"
    ...
    invoke-interface {v1}, Landroid/app/IWallpaperManager;->getDefaultInfinityWallpaper()Landroid/content/ComponentName;

    move-result-object v1

    invoke-virtual {p0, v1}, Landroid/app/WallpaperManager;->setWallpaperComponent(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v2, "setVideo com.android.systemui"
    ...
    invoke-virtual {p0, v3, v1, v2}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setResource(Landroid/content/Context;IIIZZ)I
    ...
    invoke-interface/range {v2 .. v11}, Landroid/app/IWallpaperManager;->setPreloadedWallpaper(Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Rect;ZLandroid/os/Bundle;ILandroid/app/IWallpaperManagerCallback;II)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {v2}, Landroid/app/IWallpaperManager;->copyPreloadedFileToWallpaperFile()V
...
.method public static startBackupWallpaper(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v1, Landroid/app/wallpaperbackup/WallpaperBackupRestoreManager;

    invoke-direct {v1}, Landroid/app/wallpaperbackup/WallpaperBackupRestoreManager;-><init>()V
    ...
    const-string/jumbo v4, "startBackupWallpaper action="
    ...
    const-string/jumbo v4, " sessionTime="
    ...
    invoke-virtual/range {v1 .. v9}, Landroid/app/wallpaperbackup/WallpaperBackupRestoreManager;->startBackupWallpaper(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V
...
.method public clear(I)V
    ...
    invoke-virtual {p0, p1, v1}, Landroid/app/WallpaperManager;->clearWallpaper(II)V
...
.method public getVideoColor()Ljava/lang/String;
    ...
    invoke-interface {v1}, Landroid/app/IWallpaperManager;->getVideoColor()Ljava/lang/String;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getVideoThumbnailForPreFile(I)Landroid/os/ParcelFileDescriptor;
    .locals 4
    ...
    invoke-interface {v2, p1, v3}, Landroid/app/IWallpaperManager;->getVideoThumbnailFileDescriptor(II)Landroid/os/ParcelFileDescriptor;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public notifyCompletePurchase()V
    ...
    const-string/jumbo v2, "need_backup_wallpaper"
...
.method public restoreLockWallpaper()V
    ...
    const-string/jumbo v2, "restoreLockWallpaper()"
...
.method public setAnimatedLockscreenWallpaper(Ljava/lang/String;)V
    ...
    invoke-direct {p0}, Landroid/app/WallpaperManager;->isNeedToKWPBackup()Z
...
.method public setOpenThemeWallpaper(Z)V
    ...
    const-string/jumbo v1, "need_backup_wallpaper"
...
.method public setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    return-void
.end method

.method public setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroid/app/WallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
...
.method public setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-direct {p0, p2, v0}, Landroid/app/WallpaperManager;->getVideoFDFromPackage(Ljava/lang/String;Ljava/lang/String;)Landroid/content/res/AssetFileDescriptor;
    ...
    invoke-interface/range {v1 .. v6}, Landroid/app/IWallpaperManager;->setVideoLockscreenWallpaper(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V

    invoke-direct {p0, v7, p1}, Landroid/app/WallpaperManager;->getVideoWallpaperFirstFrame(Landroid/content/res/AssetFileDescriptor;Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v1, v0, v2}, Landroid/app/IWallpaperManager;->getVideoThumbnailFileDescriptor(II)Landroid/os/ParcelFileDescriptor;

    move-result-object v12

    invoke-direct {p0, v10, v12}, Landroid/app/WallpaperManager;->saveVideoFirstFrameToBitmap(Landroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;)V

    invoke-static {v12}, Llibcore/io/IoUtils;->closeQuietly(Ljava/lang/AutoCloseable;)V

    sget-boolean v1, Landroid/app/WallpaperManager;->WPAPER_SUPPORT_INFINITY_WALLPAPER:Z
    ...
    invoke-interface {v1}, Landroid/app/IWallpaperManager;->getLastWallpaper()Landroid/content/ComponentName;
    ...
    invoke-virtual {p0, v11}, Landroid/app/WallpaperManager;->parseInfinityColorInfo(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, v8, v0}, Landroid/app/WallpaperManager;->setOppositeSideOfWallpaper(ILjava/lang/String;I)V
...
.method public setWallpaperUri(Ljava/lang/String;ZI)V
    ...
    const-string/jumbo v8, "Set wallpaper based on START"
    ...
    const-string/jumbo v8, "Resource id not found"
    ...
    :cond_4
    invoke-direct {p0, v2, v4, p3, p2}, Landroid/app/WallpaperManager;->setPreloadedResource(Landroid/content/Context;IIZ)I
    :try_end_0
    ...
    const-string/jumbo v8, "Set wallpaper based on END"
