...
.field private hasRestrictList:Z
...
.field restrictList:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, Landroid/content/pm/aasa/AASATokenParser;->hasRestrictList:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Landroid/content/pm/aasa/AASATokenParser;->restrictList:Ljava/util/HashMap;
...
.method public AASA_VerifyToken(Ljava/lang/String;Ljava/lang/String;Z)I
    ...
    :try_start_0
    new-instance v24, Ljava/util/jar/JarFile;
    ...
    invoke-virtual/range {v22 .. v22}, Ljava/util/jar/JarEntry;->getSize()J
    ...
    invoke-virtual/range {v24 .. v24}, Ljava/util/jar/JarFile;->close()V
    ...
    const-string/jumbo v40, " ERROR: plz check certification in the device - Fail to check integrity"
    ...
    :goto_3
    mul-int/lit8 v39, v6, 0xa

    add-int/lit8 v39, v39, 0x70
    ...
    const-string/jumbo v40, " ERROR: plz check certification in the device - Fail to read Token"
    ...
    invoke-static/range {v25 .. v25}, Landroid/content/pm/aasa/AASATokenParser;->isInteger(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, v8}, Landroid/content/pm/aasa/AASATokenParser;->setTrustTimeByToken(Ljava/lang/String;)V
    ...
    iput-boolean v0, v1, Landroid/content/pm/aasa/AASATokenParser;->hasRestrictList:Z
    ...
    iget-object v0, v0, Landroid/content/pm/aasa/AASATokenParser;->restrictList:Ljava/util/HashMap;

    move-object/from16 v39, v0

    const-string/jumbo v40, "PKG"
    ...
    iget-boolean v0, v0, Landroid/content/pm/aasa/AASATokenParser;->hasRestrictList:Z
...
.method public AASA_hasPermission(Ljava/lang/String;)Z
    ...
    const-string/jumbo v27, " AASA_hasPermission START"
    ...
    invoke-direct {v15, v0}, Ljava/util/jar/JarFile;-><init>(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    ...
    invoke-virtual {v15, v0}, Ljava/util/jar/JarFile;->getJarEntry(Ljava/lang/String;)Ljava/util/jar/JarEntry;
    ...
    invoke-direct {v0, v15, v13, v1}, Landroid/content/pm/aasa/AASATokenParser;->loadCertificates(Ljava/util/jar/JarFile;Ljava/util/jar/JarEntry;[B)[Ljava/security/cert/Certificate;
    ...
    const-string/jumbo v27, " AASA_hasPermission ERROR: plz check certification in the device"
    ...
    const-string/jumbo v28, "ERROR: AASA_hasPermission "
    ...
    invoke-virtual/range {v20 .. v20}, Lorg/xmlpull/v1/XmlPullParserFactory;->newPullParser()Lorg/xmlpull/v1/XmlPullParser;
    ...
    invoke-direct/range {v26 .. v27}, Ljava/io/ByteArrayInputStream;-><init>([B)V
    ...
    :try_start_7
    const-string/jumbo v26, "DEFAULTRP"
    ...
    const-string/jumbo v27, " DEFAULTRP true"
    ...
    const-string/jumbo v27, " DEFAULTRP false ?"
    ...
    const-string/jumbo v28, " AASA_hasPermission"
...
.method public AddParsedRestrictedInfoToXML()V
    .locals 2

    iget-object v0, p0, Landroid/content/pm/aasa/AASATokenParser;->restrictList:Ljava/util/HashMap;
    ...
    invoke-direct {p0, v0}, Landroid/content/pm/aasa/AASATokenParser;->AddRestrictedInfoToXML(Ljava/util/HashMap;)V
...
.method public getHasRestrict()Z
    ...
    iget-boolean v0, p0, Landroid/content/pm/aasa/AASATokenParser;->hasRestrictList:Z
