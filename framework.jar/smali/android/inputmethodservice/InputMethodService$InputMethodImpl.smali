...
.method public changeInputMethodTheme(I)V
    ...
    iput p1, v0, Landroid/inputmethodservice/InputMethodService;->sWindowTheme:I

    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    iget-boolean v0, v0, Landroid/inputmethodservice/InputMethodService;->mIsFullscreen:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    iget v0, v0, Landroid/inputmethodservice/InputMethodService;->sWindowTheme:I

    if-nez v0, :cond_0

    const-string/jumbo v0, "InputMethodService"

    const-string/jumbo v1, "changeInputMethodTheme : resetStateForNewConfiguration"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    invoke-static {v0}, Landroid/inputmethodservice/InputMethodService;->-wrap7(Landroid/inputmethodservice/InputMethodService;)V

    :cond_0
    iget-object v0, p0, Landroid/inputmethodservice/InputMethodService$InputMethodImpl;->this$0:Landroid/inputmethodservice/InputMethodService;

    invoke-virtual {v0, p1}, Landroid/inputmethodservice/InputMethodService;->changeSamsungKeyboardTheme(I)V
