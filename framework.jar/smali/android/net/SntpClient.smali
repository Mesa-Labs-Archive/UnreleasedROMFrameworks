...
.method public requestTime(Ljava/lang/String;IZ)I
    ...
    invoke-virtual {v6, v7, v8}, Landroid/net/SntpClient$DnsResolveTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    const-wide/16 v8, 0x14

    sget-object v7, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v6, v8, v9, v7}, Landroid/net/SntpClient$DnsResolveTask;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method public requestTime(Ljava/lang/String;I)Z
    ...
    :try_start_0
    new-instance v5, Landroid/net/SntpClient$DnsResolveTask;

    const/4 v6, 0x0

    invoke-direct {v5, p0, v6}, Landroid/net/SntpClient$DnsResolveTask;-><init>(Landroid/net/SntpClient;Landroid/net/SntpClient$DnsResolveTask;)V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/net/SntpClient$DnsResolveTask;->executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    const-wide/16 v6, 0x14

    sget-object v8, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v5, v6, v7, v8}, Landroid/net/SntpClient$DnsResolveTask;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
