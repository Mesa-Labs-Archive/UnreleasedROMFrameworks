...
.method public startSoftAp(Landroid/net/wifi/WifiConfiguration;)Z
    ...
    const-string/jumbo v9, "WifiManager"

    const-string/jumbo v10, "MHS is disabled due to Knox MDM Restrcition Policy"
    ...
    const-string/jumbo v10, "MHS is disabled due to DataSaverModeEnabled"
    ...
    const-string/jumbo v11, "startSoftAp() setwifiap packageName : "
    ...
    invoke-direct {p0, v12, v9}, Landroid/net/wifi/WifiManager;->insertBigdataForHotSpotEnabled(ZI)V

    invoke-direct {p0, v12}, Landroid/net/wifi/WifiManager;->insertGsimForHotSpotEnabled(Z)V

    sget-boolean v9, Landroid/net/wifi/WifiManager;->DBGMHS:Z
    ...
    const-string/jumbo v9, "extra_log"

    new-instance v10, Ljava/lang/StringBuilder;

    invoke-direct {v10}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "startSoftAp() setwifiap "
    ...
    invoke-virtual {p0, v7}, Landroid/net/wifi/WifiManager;->callSECApi(Landroid/os/Message;)I

    iget-object v9, p0, Landroid/net/wifi/WifiManager;->mService:Landroid/net/wifi/IWifiManager;

    invoke-interface {v9, p1}, Landroid/net/wifi/IWifiManager;->startSoftAp(Landroid/net/wifi/WifiConfiguration;)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    const-string/jumbo v9, "CMCC"

    sget-object v10, Landroid/net/wifi/WifiManager;->CONFIGOPBRANDINGFORMOBILEAP:Ljava/lang/String;
    ...
    const-string/jumbo v11, "CMCC isMobileDataEnabled : "
    ...
    const-string/jumbo v11, " wifisharing:"
...
.method public stopSoftAp()Z
    ...
    const-string/jumbo v8, "stopSoftAp() setwifiap "
