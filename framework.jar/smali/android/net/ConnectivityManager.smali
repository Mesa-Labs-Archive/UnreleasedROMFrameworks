...
.method public startTethering(IZLandroid/net/ConnectivityManager$OnStartTetheringCallback;Landroid/os/Handler;)V
    ...
    const-string/jumbo v7, "OnStartTetheringCallback cannot be null."

    invoke-static {p3, v7}, Lcom/android/internal/util/Preconditions;->checkNotNull(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    new-instance v6, Landroid/net/ConnectivityManager$2;

    invoke-direct {v6, p0, p4, p3}, Landroid/net/ConnectivityManager$2;-><init>(Landroid/net/ConnectivityManager;Landroid/os/Handler;Landroid/net/ConnectivityManager$OnStartTetheringCallback;)V

    if-nez p1, :cond_1

    iget-object v7, p0, Landroid/net/ConnectivityManager;->mContext:Landroid/content/Context;

    invoke-virtual {v7}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v5

    const-string/jumbo v7, "ConnectivityManager"

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v9, "startTethering packageName : "
    ...
    invoke-direct {p0, v10, v7}, Landroid/net/ConnectivityManager;->insertBigdataForHotSpotEnabled(ZI)V

    invoke-direct {p0, v10}, Landroid/net/ConnectivityManager;->insertGsimForHotSpotEnabled(Z)V
    ...
    const-string/jumbo v7, "extra_log"
    ...
    invoke-interface {v7, p1, v6, p2}, Landroid/net/IConnectivityManager;->startTethering(ILandroid/os/ResultReceiver;Z)V
    :try_end_1
    ...
    const-string/jumbo v8, "Exception trying to log in tethering."
    ...
    const-string/jumbo v8, "Exception trying to start tethering."
...
.method public stopTethering(I)V
    ...
    const-string/jumbo v8, "stopTethering"
...
.method public tagSocket(Landroid/os/ParcelFileDescriptor;II)V
    ...
    const-string/jumbo v2, "Exception while Tag Socket"
