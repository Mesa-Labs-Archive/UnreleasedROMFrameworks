...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iput-object v6, p0, Landroid/media/MediaScanner;->mClosed:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-static {}, Ldalvik/system/CloseGuard;->get()Ldalvik/system/CloseGuard;

    move-result-object v6

    iput-object v6, p0, Landroid/media/MediaScanner;->mCloseGuard:Ldalvik/system/CloseGuard;

    iput-boolean v12, p0, Landroid/media/MediaScanner;->useHashMap:Z
    ...
    iput-object v6, p0, Landroid/media/MediaScanner;->mBitmapOptions:Landroid/graphics/BitmapFactory$Options;

    iput v10, p0, Landroid/media/MediaScanner;->mSimSlotCount:I

    iput-boolean v10, p0, Landroid/media/MediaScanner;->mIsInternal:Z

    const-wide/16 v6, -0x1

    iput-wide v6, p0, Landroid/media/MediaScanner;->mSecMediaId:J

    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    iput-object v6, p0, Landroid/media/MediaScanner;->mPlaylistEntries:Ljava/util/ArrayList;
    ...
    iput-boolean v10, p0, Landroid/media/MediaScanner;->mIsFileCacheFull:Z

    iput-object v11, p0, Landroid/media/MediaScanner;->mDrmManagerClient:Landroid/drm/DrmManagerClient;
    ...
    iput v10, p0, Landroid/media/MediaScanner;->mDeleteImageNum:I

    iput v10, p0, Landroid/media/MediaScanner;->mDeleteAudioNum:I

    iput v10, p0, Landroid/media/MediaScanner;->mDeleteVideoNum:I

    iput v10, p0, Landroid/media/MediaScanner;->mDeleteEtcNum:I

    new-instance v6, Landroid/media/MediaScanner$MyMediaScannerClient;

    invoke-direct {v6, p0}, Landroid/media/MediaScanner$MyMediaScannerClient;-><init>(Landroid/media/MediaScanner;)V

    iput-object v6, p0, Landroid/media/MediaScanner;->mClient:Landroid/media/MediaScanner$MyMediaScannerClient;
    ...
    iput-object v6, p0, Landroid/media/MediaScanner;->mPackageName:Ljava/lang/String;

    iput-object p2, p0, Landroid/media/MediaScanner;->mVolumeName:Ljava/lang/String;

    iget-object v6, p0, Landroid/media/MediaScanner;->mBitmapOptions:Landroid/graphics/BitmapFactory$Options;
    ...
    const-string/jumbo v7, "nonotify"
    ...
    iput-object v6, p0, Landroid/media/MediaScanner;->mFilesUriNoNotify:Landroid/net/Uri;
    ...
    iput-object v11, p0, Landroid/media/MediaScanner;->mOmcPath:Ljava/lang/String;

    iput-object v11, p0, Landroid/media/MediaScanner;->mOmcDefaultPath:Ljava/lang/String;

    iput-boolean v12, p0, Landroid/media/MediaScanner;->mProcessPlaylists:Z

    iput-boolean v12, p0, Landroid/media/MediaScanner;->mProcessGenres:Z

    iput-boolean v12, p0, Landroid/media/MediaScanner;->mCaseInsensitivePaths:Z
    ...
    invoke-direct {p0, v6}, Landroid/media/MediaScanner;->setLocale(Ljava/lang/String;)V

    :cond_0
    :goto_1
    iget-object v6, p0, Landroid/media/MediaScanner;->mCloseGuard:Ldalvik/system/CloseGuard;
    ...
    iput-object v6, p0, Landroid/media/MediaScanner;->mOmcPath:Ljava/lang/String;
    ...
    iput-object v11, p0, Landroid/media/MediaScanner;->mPlaylistsUri:Landroid/net/Uri;

    iput-boolean v12, p0, Landroid/media/MediaScanner;->mIsInternal:Z
    ...
    const-string/jumbo v7, "SEC_FLOATING_FEATURE_COMMON_CONFIG_OMC_VERSION"
    ...
    const-string/jumbo v6, "/odm/omc"

    iput-object v6, p0, Landroid/media/MediaScanner;->mOmcDefaultPath:Ljava/lang/String;
    :try_end_0
    ...
    :cond_2
    :try_start_1
    const-string/jumbo v6, "/system/omc"
...
.method private processCachedPlaylist(Landroid/database/Cursor;Landroid/content/ContentValues;Landroid/net/Uri;)V
    ...
    invoke-direct {p0, v8, v9, v0}, Landroid/media/MediaScanner;->matchEntries(JLjava/lang/String;)Z
    ...
    iget v7, v3, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchlevel:I
    ...
    invoke-virtual {p2, v7, v10}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V

    const-string/jumbo v7, "audio_id"

    iget-wide v10, v3, Landroid/media/MediaScanner$PlaylistEntry;->bestmatchid:J

    invoke-static {v10, v11}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v10

    invoke-virtual {p2, v7, v10}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V

    iget-object v7, p0, Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/ContentProviderClient;

    invoke-virtual {v7, p3, p2}, Landroid/content/ContentProviderClient;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    :try_end_0
    ...
    const-string/jumbo v10, "SQLiteFullException in MediaScanner.processCachedPlaylist()"
    ...
    const-string/jumbo v10, "RemoteException in MediaScanner.processCachedPlaylist()"
...
.method private processPlayList(Landroid/media/MediaScanner$FileEntry;Landroid/database/Cursor;)V
    ...
    const-string/jumbo v17, "bad path "
    ...
    invoke-virtual {v2, v0, v6, v7, v1}, Landroid/content/ContentProviderClient;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string/jumbo v7, "SQLiteFullException in MediaScanner.processPlayList()"
...
.method public scanMtpFile(Ljava/lang/String;II)V
    ...
    invoke-static/range {v18 .. v18}, Landroid/media/MediaFile;->isDrmFileType(I)Z
    ...
    const-string/jumbo v3, "SQLiteFullException in scanMtpFile"
