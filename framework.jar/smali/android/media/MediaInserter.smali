...
.method private flush(Landroid/net/Uri;Ljava/util/List;)V
    ...
    iget-boolean v4, p0, Landroid/media/MediaInserter;->mIsInternal:Z
    ...
    const-string/jumbo v5, "Bulk Insert Thread"

    invoke-direct {v4, v5}, Landroid/os/HandlerThread;-><init>(Ljava/lang/String;)V

    iput-object v4, p0, Landroid/media/MediaInserter;->mHt:Landroid/os/HandlerThread;

    iget-object v4, p0, Landroid/media/MediaInserter;->mHt:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->start()V

    new-instance v4, Landroid/media/MediaInserter$BulkInsertHandler;

    iget-object v5, p0, Landroid/media/MediaInserter;->mHt:Landroid/os/HandlerThread;

    invoke-virtual {v5}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v5

    invoke-direct {v4, p0, v5}, Landroid/media/MediaInserter$BulkInsertHandler;-><init>(Landroid/media/MediaInserter;Landroid/os/Looper;)V

    iput-object v4, p0, Landroid/media/MediaInserter;->mBulkInsertHandler:Landroid/media/MediaInserter$BulkInsertHandler;
    ...
    iget-object v4, p0, Landroid/media/MediaInserter;->mBulkInsertHandler:Landroid/media/MediaInserter$BulkInsertHandler;
    ...
    invoke-virtual {v4, v2}, Landroid/media/MediaInserter$BulkInsertHandler;->sendMessage(Landroid/os/Message;)Z
    ...
    :cond_2
    :try_start_0
    iget-object v4, p0, Landroid/media/MediaInserter;->mProvider:Landroid/content/ContentProviderClient;

    invoke-virtual {v4, p1, v3}, Landroid/content/ContentProviderClient;->bulkInsert(Landroid/net/Uri;[Landroid/content/ContentValues;)I
    :try_end_0
