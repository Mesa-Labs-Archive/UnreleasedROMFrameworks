...
.field public fingerprintMatchState:I
...
.field public isInfinityWallpaper:Z
...
.method public constructor <init>()V
    ...
    iput v3, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I

    iput v2, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->batteryLevel:I
...
.method public constructor <init>(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;)V
    ...
    iput v0, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I
...
.method public copyFrom(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;)V
    ...
    iget v0, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I
    ...
    iget-boolean v0, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->isInfinityWallpaper:Z

    iput-boolean v0, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->isInfinityWallpaper:Z
...
.method public equals(Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;)Z
    ...
    iget v2, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->batteryLevel:I

    if-ne v1, v2, :cond_0

    iget v1, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I

    iget v2, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->fingerprintMatchState:I

    if-ne v1, v2, :cond_0

    iget-boolean v1, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->isInfinityWallpaper:Z

    iget-boolean v2, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->isInfinityWallpaper:Z

    if-ne v1, v2, :cond_0

    iget-boolean v1, p0, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->forceSlowChange:Z

    iget-boolean v2, p1, Landroid/hardware/display/DisplayManagerInternal$DisplayPowerRequest;->forceSlowChange:Z
...
.method public toString()Ljava/lang/String;
    ...
    const-string/jumbo v1, ", fingerprintMatchState= "
    ...
    const-string/jumbo v1, ", isInfinityWallpaper="
    ...
    const-string/jumbo v1, ", forceSlowChange ="
