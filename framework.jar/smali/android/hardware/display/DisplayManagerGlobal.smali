...
.method public getActiveSinkDisplay()Landroid/hardware/display/SemWifiDisplay;
    ...
    invoke-interface {v1}, Landroid/hardware/display/IDisplayManager;->getActiveSinkDisplay()Landroid/hardware/display/SemWifiDisplay;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "Failed to get wifidisplay sink device"
...
.method public getDisplayInfo(IZ)Landroid/view/DisplayInfo;
    ...
    :try_start_0
    iget-object v5, p0, Landroid/hardware/display/DisplayManagerGlobal;->mLock:Ljava/lang/Object;
    ...
    invoke-interface {v4, p1, v1}, Landroid/hardware/display/IDisplayManager;->getDisplayInfoEx(ILandroid/os/IBinder;)Landroid/view/DisplayInfo;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-interface {v4, p1}, Landroid/hardware/display/IDisplayManager;->getDisplayInfo(I)Landroid/view/DisplayInfo;
...
.method public isWifiDisplaySinkConnected()Z
    ...
    invoke-interface {v1}, Landroid/hardware/display/IDisplayManager;->isWifiDisplaySinkConnected()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "Failed to get wifidisplay sink state"
