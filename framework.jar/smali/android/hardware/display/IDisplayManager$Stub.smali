...
.field static final TRANSACTION_connectDevice:I = 0x13

.field static final TRANSACTION_connectWifiDisplay:I = 0x6

.field static final TRANSACTION_createVirtualDisplay:I = 0xe

.field static final TRANSACTION_disconnectDevice:I = 0x14

.field static final TRANSACTION_disconnectWifiDisplay:I = 0x7

.field static final TRANSACTION_enableOverlayMagnifier:I = 0x2c

.field static final TRANSACTION_fitToActiveDisplay:I = 0x25

.field static final TRANSACTION_forgetWifiDisplay:I = 0x9

.field static final TRANSACTION_getActiveDevice:I = 0x18

.field static final TRANSACTION_getActiveSinkDisplay:I = 0x2a

.field static final TRANSACTION_getDeviceMaxVolume:I = 0x21

.field static final TRANSACTION_getDeviceMinVolume:I = 0x1f

.field static final TRANSACTION_getDisplayIds:I = 0x2

.field static final TRANSACTION_getDisplayInfo:I = 0x1

.field static final TRANSACTION_getDisplayInfoEx:I = 0x32

.field static final TRANSACTION_getDisplaySizeOverride:I = 0x31

.field static final TRANSACTION_getDisplayToken:I = 0x30

.field static final TRANSACTION_getLastConnectedDevice:I = 0x15

.field static final TRANSACTION_getPresentationOwner:I = 0x27

.field static final TRANSACTION_getWifiDisplayStatus:I = 0xc

.field static final TRANSACTION_isConnWithPinSupported:I = 0x24

.field static final TRANSACTION_isDeviceVolumeMuted:I = 0x20

.field static final TRANSACTION_isDongleRenameSupported:I = 0x22

.field static final TRANSACTION_isFitToActiveDisplay:I = 0x26

.field static final TRANSACTION_isWifiDisplaySinkConnected:I = 0x29
...
.field static final TRANSACTION_removeLastConnectedDevice:I = 0x19
...
.field static final TRANSACTION_restartWifiDisplay:I = 0x28

.field static final TRANSACTION_resumeWifiDisplay:I = 0xb

.field static final TRANSACTION_setAppListSupportingDirectStream:I = 0x1b

.field static final TRANSACTION_setCurrentDisplayIdMagnifier:I = 0x2f

.field static final TRANSACTION_setDeviceVolume:I = 0x1c

.field static final TRANSACTION_setDeviceVolumeMuted:I = 0x1d

.field static final TRANSACTION_setMagnificationSettings:I = 0x2e

.field static final TRANSACTION_setMagnificationSpec:I = 0x2d

.field static final TRANSACTION_setScanningChannel:I = 0x2b
...
.field static final TRANSACTION_setVolumeKeyEvent:I = 0x1e

.field static final TRANSACTION_setWifiDisplayRealSize:I = 0x1a

.field static final TRANSACTION_startWifiDisplayChannelScan:I = 0x16

.field static final TRANSACTION_startWifiDisplayScan:I = 0x4

.field static final TRANSACTION_stopWifiDisplayScan:I = 0x5

.field static final TRANSACTION_updateDeviceState:I = 0x17
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    sget-object v4, Landroid/hardware/display/SemDeviceInfo;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast v17, Landroid/hardware/display/SemDeviceInfo;
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->connectDevice(Landroid/hardware/display/SemDeviceInfo;)V
    ...
    invoke-virtual {v0, v1, v4}, Landroid/hardware/display/SemDeviceInfo;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->startWifiDisplayChannelScan(I)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/hardware/display/IDisplayManager$Stub;->updateDeviceState(Landroid/hardware/display/SemDeviceInfo;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->setWifiDisplayRealSize(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->setAppListSupportingDirectStream(Ljava/util/List;)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->setDeviceVolume(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->setDeviceVolumeMuted(Z)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->setVolumeKeyEvent(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->renameDongle(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->isConnWithPinSupported(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1}, Landroid/hardware/display/IDisplayManager$Stub;->fitToActiveDisplay(Z)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->getPresentationOwner(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1, v4}, Landroid/hardware/display/SemWifiDisplay;->writeToParcel(Landroid/os/Parcel;I)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->setScanningChannel(I)V
    ...
    check-cast v19, Landroid/view/MagnificationSpec;
    ...
    invoke-virtual {v0, v15, v1, v2}, Landroid/hardware/display/IDisplayManager$Stub;->setMagnificationSettings(IIF)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->setCurrentDisplayIdMagnifier(I)V
    ...
    invoke-virtual {v0, v15}, Landroid/hardware/display/IDisplayManager$Stub;->getDisplayToken(I)Landroid/os/IBinder;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/hardware/display/IDisplayManager$Stub;->getDisplaySizeOverride(Landroid/os/IBinder;[I)V
    ...
    invoke-virtual {v0, v15, v1}, Landroid/hardware/display/IDisplayManager$Stub;->getDisplayInfoEx(ILandroid/os/IBinder;)Landroid/view/DisplayInfo;
