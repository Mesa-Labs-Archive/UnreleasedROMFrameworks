...
.method private constructor <init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;IZ)V
    ...
    invoke-direct {v0, p1, v1}, Landroid/database/sqlite/SQLiteConnection$OperationLog;-><init>(Landroid/database/sqlite/SQLiteConnectionPool;Landroid/database/sqlite/SQLiteDatabaseConfiguration;)V
...
.method private setBusyTimeoutFromConfiguration()V
    ...
    iget-wide v2, v1, Landroid/database/sqlite/SQLiteDatabaseConfiguration;->busyTimeout:J

    const-wide/16 v4, 0x9c4

    :try_start_0
    const-string/jumbo v1, "PRAGMA busy_timeout"

    const/4 v6, 0x0

    const/4 v7, 0x0

    invoke-virtual {p0, v1, v6, v7}, Landroid/database/sqlite/SQLiteConnection;->executeForLong(Ljava/lang/String;[Ljava/lang/Object;Landroid/os/CancellationSignal;)J
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v6, "PRAGMA busy_timeout="
    ...
    const-string/jumbo v6, "Error getting busy_timeout"
    ...
    const-string/jumbo v6, "Error setting busy_timeout"
...
.method private setCaseSensitiveLikeFromConfiguration()V
    ...
    :try_start_0
    const-string/jumbo v1, "PRAGMA case_sensitive_like"
    ...
    const-string/jumbo v6, "PRAGMA case_sensitive_like="
    ...
    invoke-virtual {p0, v1, v8, v8}, Landroid/database/sqlite/SQLiteConnection;->execute(Ljava/lang/String;[Ljava/lang/Object;Landroid/os/CancellationSignal;)V
    ...
    const-string/jumbo v6, "Error getting case_sensitive_like"
