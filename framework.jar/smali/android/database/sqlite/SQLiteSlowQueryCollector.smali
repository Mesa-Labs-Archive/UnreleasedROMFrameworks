...
.method public static sendSlowQueryLog(Landroid/database/sqlite/SQLiteConnectionPool;Ljava/lang/String;Landroid/database/sqlite/SQLiteConnection$Operation;)V
    ...
    :cond_2
    invoke-virtual {v2}, Landroid/database/sqlite/SQLiteDatabase;->getContext()Landroid/content/Context;
    ...
    const-string/jumbo v4, "SQLiteSlowQueryCollector"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v6, "Could not send a squery without the context. "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-wide v6, p2, Landroid/database/sqlite/SQLiteConnection$Operation;->mExecutionTime:J
    ...
    iget-object v6, p2, Landroid/database/sqlite/SQLiteConnection$Operation;->mSql:Ljava/lang/String;
    ...
    iget-wide v4, p2, Landroid/database/sqlite/SQLiteConnection$Operation;->mEndTime:J
    ...
    const-string/jumbo v6, "Could send a squery during 3 hours. "
    ...
    :cond_6
    sget v4, Landroid/database/sqlite/SQLiteSlowQueryCollector;->sStartPoint:I
    ...
    sput v4, Landroid/database/sqlite/SQLiteSlowQueryCollector;->sStartPoint:I
    ...
    invoke-direct {v0, v1, p0, p1, p2}, Landroid/database/sqlite/SQLiteSlowQueryCollector;-><init>(Landroid/content/Context;Landroid/database/sqlite/SQLiteConnectionPool;Ljava/lang/String;Landroid/database/sqlite/SQLiteConnection$Operation;)V
    ...
    const-string/jumbo v6, "Failed to start a thread for a squery. "
