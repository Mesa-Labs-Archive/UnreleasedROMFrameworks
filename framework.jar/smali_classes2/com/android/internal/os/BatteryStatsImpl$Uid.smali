...
.method public createBluetoothDutyScanTimerLocked()Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
    ...
    invoke-direct {v0, v1, p0, v3, v2}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;-><init>(Lcom/android/internal/os/BatteryStatsImpl$Clocks;Lcom/android/internal/os/BatteryStatsImpl$Uid;ILcom/android/internal/os/BatteryStatsImpl$TimeBase;)V
...
.method public noteActivityResumedLocked(J)V
    ...
    invoke-static {v0}, Lcom/android/internal/os/BatteryStatsImpl;->-wrap3(Lcom/android/internal/os/BatteryStatsImpl;)V
...
.method public noteBluetoothScanStoppedLocked(J)V
    ...
    invoke-virtual {v0}, Lcom/android/internal/os/BatteryStatsImpl$DualTimer;->isRunningLocked()Z
...
.method public noteBluetoothScanStoppedLocked(JI)V
    .locals 3
    ...
    invoke-virtual {v1}, Lcom/android/internal/os/BatteryStatsImpl$DualTimer;->isRunningLocked()Z
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;

    invoke-virtual {v1}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;->isRunningLocked()Z
    ...
    invoke-virtual {v1, p1, p2}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;->stopRunningLocked(J)V

    :cond_1
    invoke-virtual {p0, p1, p2}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->noteBluetoothScanStoppedLocked(J)V

    if-lez p3, :cond_2

    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->noteBluetoothScanStartedLocked(JZI)V
...
.method public noteGpuUpdateLocked(Z)V
    ...
    invoke-static {v4}, Lcom/android/internal/os/BatteryStatsImpl;->-wrap3(Lcom/android/internal/os/BatteryStatsImpl;)V
...
.method readFromParcelLocked(Lcom/android/internal/os/BatteryStatsImpl$TimeBase;Lcom/android/internal/os/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)V
    ...
    new-instance v36, Lcom/android/internal/os/BatteryStatsImpl$Uid$Wakelock;
    ...
    new-instance v32, Lcom/android/internal/os/BatteryStatsImpl$Uid$Sensor;
    ...
    new-instance v30, Lcom/android/internal/os/BatteryStatsImpl$Uid$Proc;
    ...
    new-instance v29, Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg;
    ...
    new-instance v4, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
    ...
    invoke-direct/range {v4 .. v9}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;-><init>(Lcom/android/internal/os/BatteryStatsImpl$Clocks;Lcom/android/internal/os/BatteryStatsImpl$Uid;ILcom/android/internal/os/BatteryStatsImpl$TimeBase;Landroid/os/Parcel;)V

    move-object/from16 v0, p0

    iput-object v4, v0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
    ...
    invoke-static {v4}, Lcom/android/internal/os/BatteryStatsImpl;->-get4(Lcom/android/internal/os/BatteryStatsImpl;)Lcom/android/internal/os/PowerProfile;
    ...
    invoke-virtual {v4, v13}, Lcom/android/internal/os/PowerProfile;->getNumSpeedStepsInCpuCluster(I)I
    ...
    new-array v14, v0, [Lcom/android/internal/os/BatteryStatsImpl$LongSamplingCounter;
...
.method public reset()Z
    ...
    iget-object v0, v0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
    ...
    invoke-static/range {v30 .. v31}, Lcom/android/internal/os/BatteryStatsImpl;->-wrap4(Lcom/android/internal/os/BatteryStatsImpl$LongSamplingCounter;Z)V
    ...
    invoke-interface/range {v31 .. v31}, Lcom/android/internal/os/BatteryStatsImpl$Clocks;->elapsedRealtime()J
    ...
    invoke-interface/range {v31 .. v31}, Lcom/android/internal/os/BatteryStatsImpl$Clocks;->uptimeMillis()J
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Lcom/android/internal/os/BatteryStatsImpl$TimeBase;->reset(JJ)V
    ...
    invoke-virtual/range {v30 .. v30}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;->detach()V
    ...
    iput-object v0, v1, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
...
.method public updateUidProcessStateLocked(I)V
    ...
    invoke-virtual {p0, v2, v8}, Lcom/android/internal/os/BatteryStatsImpl$Uid;->makeProcessState(ILandroid/os/Parcel;)V
...
.method writeToParcelLocked(Landroid/os/Parcel;JJ)V
    ...
    iget-object v4, v0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mBluetoothDutyScanTimer:Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;
    ...
    invoke-virtual {v4, v0, v1, v2}, Lcom/android/internal/os/BatteryStatsImpl$DutyTimer;->writeToParcel(Landroid/os/Parcel;J)V
    ...
    iget-object v6, v0, Lcom/android/internal/os/BatteryStatsImpl$Uid;->mCpuClusterSpeed:[[Lcom/android/internal/os/BatteryStatsImpl$LongSamplingCounter;
