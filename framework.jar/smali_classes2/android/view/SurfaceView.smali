...
.field private mReportVideoPlayingSurface:Z
...
.method static synthetic -set2(Landroid/view/SurfaceView;I)I
    .locals 0
...
.method static synthetic -wrap1(Landroid/view/SurfaceView;Z)V
    .locals 0

    invoke-direct {p0, p1}, Landroid/view/SurfaceView;->reportVideoPlayingSurface(Z)V

    return-void
.end method

.method static synthetic -wrap2(Landroid/view/SurfaceView;Ljava/lang/Runnable;)V
    .locals 0
...
.method static synthetic -wrap3(Landroid/view/SurfaceView;Z)V
    .locals 0
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-boolean v2, p0, Landroid/view/SurfaceView;->mReportVideoPlayingSurface:Z
    ...
    iput-object v0, p0, Landroid/view/SurfaceView;->mMultiWindowManager:Lcom/samsung/android/multiwindow/MultiWindowManager;

    iget-object v0, p0, Landroid/view/SurfaceView;->mMultiWindowManager:Lcom/samsung/android/multiwindow/MultiWindowManager;

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/samsung/android/multiwindow/MultiWindowManager;->shouldReportVideoPlayingSurface(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iput-boolean v4, p0, Landroid/view/SurfaceView;->mReportVideoPlayingSurface:Z

    invoke-direct {p0}, Landroid/view/SurfaceView;->registerCOVCallback()V
...
.method private registerCOVCallback()V
    .locals 2
...
.method private reportVideoPlayingSurface(Z)V
    .locals 3
    ...
    iget-boolean v0, p0, Landroid/view/SurfaceView;->mReportVideoPlayingSurface:Z
    ...
    const-string/jumbo v2, "calling reportVideoPlayingSurface ,mViewVisibility= "
    ...
    const-string/jumbo v2, ", mSurfaceControl "
    ...
    invoke-virtual {v0, v1, p1}, Lcom/samsung/android/multiwindow/MultiWindowManager;->reportVideoPlayingSurface(Landroid/os/IBinder;Z)V
...
.method private setUsesOwnResolution(Z)V
    ...
    iget-object v3, v5, Landroid/view/ViewRootImpl;->mBasePackageName:Ljava/lang/String;
    ...
    const-string/jumbo v7, "setPackageUsesOwnResolution() (Java SurfaceView) for "
    ...
    iget v7, p0, Landroid/view/SurfaceView;->mRequestedWidth:I
    ...
    iget v7, p0, Landroid/view/SurfaceView;->mRequestedHeight:I
    ...
    :cond_2
    :try_start_1
    const-string/jumbo v5, "unknown app"
    ...
    const-string/jumbo v7, "Couldn\'t get ActivityManager to do setPackageUsesOwnResolution() (Java SurfaceView) for "
    ...
    :cond_4
    :try_start_3
    const-string/jumbo v3, "unknown app"
    :try_end_3
...
.method forceDestroySurfaceControl()V
    ...
    iget-boolean v4, p0, Landroid/view/SurfaceView;->mSurfaceCreated:Z
    ...
    iget-object v4, v3, Landroid/view/ViewRootImpl;->mSurface:Landroid/view/Surface;
    ...
    iput-boolean v5, p0, Landroid/view/SurfaceView;->mSurfaceCreated:Z
    ...
    iget-object v7, p0, Landroid/view/SurfaceView;->mSurfaceHolder:Landroid/view/SurfaceHolder;

    invoke-interface {v0, v7}, Landroid/view/SurfaceHolder$Callback;->surfaceDestroyed(Landroid/view/SurfaceHolder;)V
    ...
    invoke-direct {p0, v5}, Landroid/view/SurfaceView;->reportVideoPlayingSurface(Z)V
    ...
    const-string/jumbo v6, "Exception configuring surface in Secondary surfaceDestroyed."
...
.method synthetic lambda$-android_view_SurfaceView_38419()V
    .locals 0
...
.method protected onDetachedFromWindow()V
    ...
    invoke-direct {p0, v3}, Landroid/view/SurfaceView;->setUsesOwnResolution(Z)V
    ...
    invoke-direct {p0, v3}, Landroid/view/SurfaceView;->reportVideoPlayingSurface(Z)V
...
.method protected updateSurface()V
    ...
    iget v4, v0, Landroid/view/SurfaceView;->mUpdateSurfaceCalledBy:I
    ...
    invoke-direct {v0, v2}, Landroid/view/SurfaceView;->reportVideoPlayingSurface(Z)V
    ...
    invoke-direct {v0, v3}, Landroid/view/SurfaceView;->reportVideoPlayingSurface(Z)V
