...
.field private mIsAlphaChangedForCOV:Z
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v3, p0, Landroid/widget/ImageView;->mOriginalAlpha:I

    iput-boolean v1, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput v4, p0, Landroid/widget/ImageView;->mMaxWidth:I

    const v4, 0x7fffffff

    iput v4, p0, Landroid/widget/ImageView;->mMaxHeight:I
    ...
    iput v9, p0, Landroid/widget/ImageView;->mOriginalAlpha:I

    iput-boolean v6, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
...
.method protected applyAlphaForCOV()V
    .locals 2
    ...
    invoke-virtual {p0}, Landroid/widget/ImageView;->isViewTransparencyEnabled()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
    ...
    iput v0, p0, Landroid/widget/ImageView;->mOriginalAlpha:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
    ...
    invoke-virtual {p0}, Landroid/widget/ImageView;->calculateTransparencyForCOV()I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v3, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
    ...
    iput-boolean v3, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z
    ...
    iput-boolean v4, p0, Landroid/widget/ImageView;->mIsAlphaChangedForCOV:Z

    iget-object v3, p0, Landroid/widget/ImageView;->mDrawable:Landroid/graphics/drawable/Drawable;

    iget v4, p0, Landroid/widget/ImageView;->mOriginalAlpha:I
...
.method protected restoreAlphaForCOV()V
    .locals 2
    ...
    iget v1, p0, Landroid/widget/ImageView;->mOriginalAlpha:I
