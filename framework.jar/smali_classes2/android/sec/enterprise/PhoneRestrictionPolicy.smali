...
.method public isIncomingSmsAllowedFromSimSlot(I)Z
    ...
    invoke-interface {v1, p1}, Landroid/sec/enterprise/IEDMProxy;->isIncomingSmsAllowedFromSimSlot(I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "PXY-isIncomingSmsAllowedFromSimSlot returning default value "
...
.method public isMmsAllowedFromSimSlot(I)Z
    ...
    invoke-interface {v1, p1}, Landroid/sec/enterprise/IEDMProxy;->isMmsAllowedFromSimSlot(I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "PXY-isMmsAllowedFromSimSlot returning default value "
...
.method public isOutgoingSmsAllowedFromSimSlot(I)Z
    ...
    invoke-interface {v1, p1}, Landroid/sec/enterprise/IEDMProxy;->isOutgoingSmsAllowedFromSimSlot(I)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v3, "PXY-isOutgoingSmsAllowedFromSimSlot returning default value "
