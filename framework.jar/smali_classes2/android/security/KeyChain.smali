...
.method public static bindAsKnoxUser(Landroid/content/Context;Landroid/os/UserHandle;)Landroid/security/KeyChain$KnoxKeyChainConnection;
    ...
    invoke-direct {v2, v3}, Landroid/security/KeyChain$2;-><init>(Ljava/util/concurrent/BlockingQueue;)V

    new-instance v1, Landroid/content/Intent;

    const-class v4, Landroid/security/IKnoxKeyChainService;
    ...
    const-string/jumbo v5, "could not bind to KnoxKeyChainService"
    ...
    :cond_2
    new-instance v5, Landroid/security/KeyChain$KnoxKeyChainConnection;

    invoke-interface {v3}, Ljava/util/concurrent/BlockingQueue;->take()Ljava/lang/Object;

    move-result-object v4

    check-cast v4, Landroid/security/IKnoxKeyChainService;

    invoke-direct {v5, p0, v2, v4}, Landroid/security/KeyChain$KnoxKeyChainConnection;-><init>(Landroid/content/Context;Landroid/content/ServiceConnection;Landroid/security/IKnoxKeyChainService;)V
