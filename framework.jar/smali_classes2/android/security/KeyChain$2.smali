.class final Landroid/security/KeyChain$2;
...
.method public onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iget-boolean v1, p0, Landroid/security/KeyChain$2;->mConnectedAtLeastOnce:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, Landroid/security/KeyChain$2;->mConnectedAtLeastOnce:Z

    :try_start_0
    iget-object v1, p0, Landroid/security/KeyChain$2;->val$q:Ljava/util/concurrent/BlockingQueue;

    invoke-static {p2}, Landroid/os/Binder;->allowBlocking(Landroid/os/IBinder;)Landroid/os/IBinder;

    move-result-object v2

    invoke-static {v2}, Landroid/security/IKnoxKeyChainService$Stub;->asInterface(Landroid/os/IBinder;)Landroid/security/IKnoxKeyChainService;
