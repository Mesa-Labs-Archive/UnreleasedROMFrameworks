...
.field private static sHubSensor:Landroid/hardware/Sensor;

.field private static sInitializedSensorManager:Z

.field private static sPool:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubEventPool;

.field private static sSensorHubEnabled:Z

.field private static sSensorListener:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubListener;
...
# direct methods
.method static synthetic -get0(Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;)Ljava/util/ArrayList;
    .locals 1
...
.method static synthetic -get1(Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;)Landroid/os/Looper;
    .locals 1
...
.method static synthetic -get2()Landroid/hardware/Sensor;
    .locals 1

    sget-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;

    return-object v0
.end method

.method static synthetic -get3()Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubEventPool;
    .locals 1

    sget-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sPool:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubEventPool;

    return-object v0
.end method

.method static synthetic -get4()Landroid/hardware/SensorManager;
    .locals 1

    sget-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorManager:Landroid/hardware/SensorManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorManager:Landroid/hardware/SensorManager;

    sput-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;

    sput-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorListener:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubListener;

    sput-object v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHandler:Landroid/os/Handler;

    sput-boolean v1, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sInitializedSensorManager:Z

    sput-boolean v1, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorHubEnabled:Z
...
.method private disableSensorHubLocked()Z
    ...
    sget-object v1, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorListener:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubListener;
...
.method private enableSensorHubLocked()Z
    ...
    const-string/jumbo v1, "enableSensorHubLocked: no sensor or service "
    ...
    sget-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;

    sget-object v3, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHandler:Landroid/os/Handler;
    ...
    sput-boolean v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorHubEnabled:Z

    sget-boolean v0, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorHubEnabled:Z

    if-nez v0, :cond_2

    const-string/jumbo v0, "SensorHubManager"

    const-string/jumbo v1, "hub register failed  "
...
.method private initSensorManager()Z
    ...
    sget-boolean v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sInitializedSensorManager:Z

    if-nez v2, :cond_6

    sget-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorManager:Landroid/hardware/SensorManager;
    ...
    sput-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorManager:Landroid/hardware/SensorManager;
    ...
    sput-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorListener:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubListener;
    ...
    sput-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sPool:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubEventPool;
    ...
    sput-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;
    ...
    :cond_3
    sget-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHandler:Landroid/os/Handler;
    ...
    sput-object v2, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHandler:Landroid/os/Handler;

    :cond_5
    sput-boolean v5, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sInitializedSensorManager:Z
...
.method public SendSensorHubData(I[B)I
    ...
    :cond_1
    sget-object v3, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;
    ...
    :cond_2
    sget-boolean v3, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorHubEnabled:Z

    if-nez v3, :cond_3

    sget-object v3, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorManager:Landroid/hardware/SensorManager;

    sget-object v4, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorListener:Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager$SensorHubListener;

    sget-object v5, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHubSensor:Landroid/hardware/Sensor;

    sget-object v6, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sHandler:Landroid/os/Handler;

    const/4 v7, 0x3

    invoke-virtual {v3, v4, v5, v7, v6}, Landroid/hardware/SensorManager;->registerListener(Landroid/hardware/SensorEventListener;Landroid/hardware/Sensor;ILandroid/os/Handler;)Z

    move-result v3

    sput-boolean v3, Lcom/samsung/android/contextaware/sensorhubmanager/SensorHubManager;->sSensorHubEnabled:Z
