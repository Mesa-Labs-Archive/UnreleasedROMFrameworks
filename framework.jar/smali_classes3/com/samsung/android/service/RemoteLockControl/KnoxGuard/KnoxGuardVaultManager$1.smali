...
.method public checkRemoteLockPassword(Ljava/lang/String;)I
    ...
    :try_start_0
    iget-object v2, p0, Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/KnoxGuardVaultManager$1;->this$0:Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/KnoxGuardVaultManager;

    invoke-virtual {v2, p1}, Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/KnoxGuardVaultManager;->completeUnlocking(Ljava/lang/String;)I

    move-result v1

    if-nez v1, :cond_0

    invoke-static {}, Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/KnoxGuardVaultManager;->-get1()Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/IKnoxGuardVaultListener;
    ...
    invoke-interface {v2}, Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/IKnoxGuardVaultListener;->onUnlockedByPasscode()V
    ...
    const-string/jumbo v3, "KnoxGuardVaultListener is null, can\'t call onUnlockedByPasscode()"
    ...
    invoke-static {}, Lcom/samsung/android/service/RemoteLockControl/KnoxGuard/KnoxGuardVaultManager;->-get0()Z
    ...
    const-string/jumbo v3, "Error in KGV Manager internally"
