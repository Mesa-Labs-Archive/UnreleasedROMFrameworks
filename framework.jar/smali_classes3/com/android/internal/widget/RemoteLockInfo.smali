...
.method synthetic constructor <init>(IZLjava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ZLjava/lang/CharSequence;IJIZLandroid/os/Bundle;Lcom/android/internal/widget/RemoteLockInfo;)V
    .locals 1
...
.method public constructor <init>(Lcom/android/internal/widget/RemoteLockInfo$Builder;)V
    ...
    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get5(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Z
    ...
    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get10(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->phoneNumber:Ljava/lang/CharSequence;

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get3(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->emailAddress:Ljava/lang/CharSequence;

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get4(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->enableEmergencyCall:Z

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get2(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get6(Lcom/android/internal/widget/RemoteLockInfo$Builder;)J

    move-result-wide v0

    iput-wide v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->lockTimeOut:J

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get9(Lcom/android/internal/widget/RemoteLockInfo$Builder;)I

    move-result v0

    iput v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->permanentBlockCount:I

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get11(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Z

    move-result v0

    iput-boolean v0, p0, Lcom/android/internal/widget/RemoteLockInfo;->skipPinContainer:Z

    invoke-static {p1}, Lcom/android/internal/widget/RemoteLockInfo$Builder;->-get1(Lcom/android/internal/widget/RemoteLockInfo$Builder;)Landroid/os/Bundle;
